...
public partial class BillPlzConfirm : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string redirectURL = pWebsiteName + "/BillPlzReturn.aspx";

        string BillPlzURL = "http://gt.evenchise.com/BillPlzBillTest.aspx?denomination=" + userCurrency.ToString() + "&pDesc=" + tmpTitle.ToString();
        //string BillPlzURL = "http://183.81.165.110/webapps/Tg_TestW/BillPlzBillTest.aspx?denomination=" + userCurrency.ToString() + "&pDesc=" + tmpTitle.ToString();
