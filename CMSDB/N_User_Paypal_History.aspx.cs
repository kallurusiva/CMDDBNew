...
public partial class N_User_Paypal_History : System.Web.UI.Page
{
    ...
    protected void OnCommand_ImageSendEmailNew(object sender, CommandEventArgs e)
    {
        ...
        CommonFunctions.AlertMessageAndRedirect("EBOOKS ReSend by Email Successfully....", "N_User_Paypal_History.aspx");
    }
