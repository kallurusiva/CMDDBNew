...
public partial class Admin_FaqListing : BasePage
{
    ...
    protected void PopulateGrid(string vSortExpr, string vSortDir)
    {
        ...
        ds = objBAL_Faq.Retrieve_AllFaqByUserID(Convert.ToInt32(Session["UserID"]), ViewState["RtType"].ToString(), qLgType);
            ...
            //{
                ...
                if (ViewState["RtType"] != null)
                {
                    ...
                    {  
                        ...
                        TextBox tbFaqQuestion = (TextBox)e.Row.FindControl("txtFaqQuestion");
                        TextBox tbFaqAnswer = (TextBox)e.Row.FindControl("txtFaqAnswer");

                        if (tbFaqQuestion != null)
                        {
                           
                             tbFaqQuestion.ReadOnly = true;
                             tbFaqQuestion.CssClass = "stdTextField1_disabled";
                        }
                        

                        if (tbFaqAnswer != null)
                        {
                            tbFaqAnswer.ReadOnly = true;
                            tbFaqAnswer.CssClass = "stdTextArea2_disabled";
                        }
    ...
    protected void btnPrt_UP_Click(object sender, EventArgs e)
    {
        ...
        if (PrevRowIndex >= 0)
        {
            ...
            if (objLtr_CurrPriority != null)
            {
                ...
                int upStatus = objBAL_CommonFunc.ChangePriorityOrder("tblfaq", "faqid", "IX_Users_Priority", CurrPriority, CurrFaqID, PrevPriority, PrevFaqID, Session["UserID"].ToString());
                ...
                //   update data base tables. 
                 ...
                 //String strSQL = "ALTER INDEX IX_Users_Priority ON tblFAQ DISABLE; Update tblFaq set Priority =" + PrevPriority + " where faqid=" + CurrFaqID + " and UserID = " + Convert.ToInt32(Session["UserID"]);
                 //SqlCommand dbCmd = new SqlCommand(strSQL, dbConn);
                 //dbCmd.ExecuteNonQuery();


                 //strSQL = "Update tblFaq set Priority =" + CurrPriority + " where faqid=" + PrevFaqID + " and UserID = " + Convert.ToInt32(Session["UserID"]) + "; ALTER INDEX IX_Users_Priority ON tblFAQ REBUILD";
    ...
    protected void btnPrt_DOWN_Click(object sender, EventArgs e)
    {
        ...
        if (NextRowIndex < MaxRows)
        {
            ...
            if (objLtr_CurrPriority != null)
            {
                ...
                int upStatus = objBAL_CommonFunc.ChangePriorityOrder("tblfaq", "faqid", "IX_Users_Priority", CurrPriority, CurrFaqID, NextPriority, NextFaqID, Session["UserID"].ToString());
    ...
    protected void btnDeleteAll_Click(object sender, EventArgs e)
    {
        ...
        if (strFaqIDs != string.Empty)
        {
            ...
            bool DelMulstatus = objBAL_Faq.DeleteFaqData_Multiple(Convert.ToInt32(Session["UserID"]), strFaqIDs);
