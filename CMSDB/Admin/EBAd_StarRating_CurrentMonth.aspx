<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EBAd_StarRating_CurrentMonth.aspx.cs" Inherits="Admin_EBAd_StarRating_CurrentMonth" %>
                 ...
                 <table cellpadding="0" cellspacing="0" width="100%" class="tblSubHeader">
                  <tr>
                        ...
                        <td width="60%" align="left" class="subHeaderFontGrad">
                            &nbsp; Star Rating Admin Books - Current Month (<asp:Label ID="lblcMonth" runat="server" Text=""></asp:Label>)</td>
