...
public partial class Admin_EBAd_eStoreAdminCatsFranchise : System.Web.UI.Page
{
    ...
    protected void RenderMainCategories(string SelCatID)
    {
        ...
        DataSet ds = objDBS.EBook_Get_MainCategories_NewALL(vUserID, "", "1","104");
    }
    ...
    protected void Load_MainCategories()
    {
        vUserID = Convert.ToInt32(Session["UserID"].ToString());
        newDBS objDBS = new newDBS();
        DataSet dsMainCats = objDBS.EBook_Get_MainCategories_NewALL(vUserID, "", "1","104");
