...
public partial class Admin_EBAd_eStoreMySubCats : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                DataRow drow = dtMainCats.Rows[0];
                ViewState["MainCatId"] = drow["catMainID"].ToString();
            }
    ...
    protected void RenderMainCategories(string SelCatID)
    {
        ...
        vUserID = Convert.ToInt32(Session["UserID"].ToString());
        DataSet ds = objEbook.EBook_Get_MainCategories(vUserID, "00");
