<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EBAd_BookListingIntroducer.aspx.cs" Inherits="Admin_EBAd_BookListingIntroducer" %>
                 ...
                 <table cellpadding="0" cellspacing="0" width="100%" class="tblSubHeader">
                  <tr>
                        ...
                        <td width="60%" align="left" class="subHeaderFontGrad">
                            &nbsp; Your Author Introducer Books</td>
                ...
                <table cellpadding="0" cellspacing="3" class="stdtableBorder_Main" width="100%">
                    ...
                    <tr>
                        ...
                        <%--    <asp:TemplateField HeaderText="Sl No">
                            ...
                            <%--<asp:HyperLink ID="hypBuyNow" runat="server" NavigateUrl='<%# Bind("buyURL")%>'>Buy Now</asp:HyperLink>--%>
                              </ItemTemplate>
                              <ItemStyle Width="100px" HorizontalAlign="Left"  />
                             </asp:TemplateField>
