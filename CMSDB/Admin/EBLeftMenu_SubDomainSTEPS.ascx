<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EBLeftMenu_SubDomainSTEPS.ascx.cs" Inherits="Admin_EBLeftMenu_SubDomainSTEPS" %>
...
<li id="liStep1" runat="server"> 
    <asp:HyperLink ID="HypSTEP1" CssClass="LiCon add" runat="server" Text="" NavigateUrl="~/Admin/Ad_ModifySubDomain.aspx">
        <asp:Label ID="Label4" CssClass="fontStepA" runat="server" Text="STEP 1"></asp:Label>
        <br /><asp:Label ID="Label3" CssClass="fontStepB" runat="server" Text="Register SubDomain"></asp:Label>
...
<li id="liStep2" runat="server"> 
       <asp:HyperLink ID="HypSTEP2" CssClass="LiCon add" runat="server" Text="" NavigateUrl="~/Admin/EBad_CreateStoreIDFree.aspx">
