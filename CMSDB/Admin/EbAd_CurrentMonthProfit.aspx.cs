...
public partial class Admin_EbAd_CurrentMonthProfit : System.Web.UI.Page
{
    int tmpRowCount;
    ...
    protected void PopulateGrid(string vSortExpr, string vSortDir)
    {
        ...
        ds = objMalaysia.Retrieve_EbookRequestListings(Session["MERID"].ToString(), strPageNo, gridEbooks.PageSize.ToString(), "2");
