<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="PrepaidCardSendSMSList.aspx.cs" Inherits="Admin_PrepaidCardSendSMSList" %>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <asp:Label ID="LabelSenderIDMsg" runat="server" CssClass="" Text="Note: will always take latest sender id on the schedule date."/>
                     ...
                     <tr>
                        <td class="tblFormLabel1" >
                            &nbsp;</td>
                        <td class="tblFormLabel1" >
                            Report Name : <span class="font_12Msg_Error">*</span></td>
                        <td class="tblFormText1" align="left">                              
                              <asp:TextBox ID="txtReportName" runat="server" CssClass="stdTextField1"  MaxLength="25"></asp:TextBox>
                              ...
                              <asp:RegularExpressionValidator ID="revReportName" ValidationExpression="[a-zA-Z0-9_ ]{1,25}" runat="server" ErrorMessage="Only alphabet or numeric and space,underscore is allowed"  SetFocusOnError="true" Display="Dynamic" ControlToValidate="txtReportName" ValidationGroup="VgCheck"/><br />                              
                              <asp:Label ID="LabelReportName" runat="server" CssClass="FontNote" Text="Report Name is a reference name that you can create for each SMS transaction that has been sent out.<br/>Therefore you can use Report Name as key while searching SMS Report"/> 
                     ...
                     <tr>
                        ...
                        <td class="tblFormLabel1" >
                            Send Mobile To </td>
                        <td class="tblFormText1" align="left">
                            <asp:Label ID="LabelMobileTo" runat="server" Text="" 
                                CssClass="SearchLabelBold" />
                         </td>
                        <td class="tblFormText1" align="left">
                            &nbsp;</td>
                    </tr>
    ...
    <asp:HiddenField ID="hdnMsgHistID" Value="" runat="server" />
</form>
</asp:Content>
