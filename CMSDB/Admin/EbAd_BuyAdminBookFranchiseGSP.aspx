<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EbAd_BuyAdminBookFranchiseGSP.aspx.cs" Inherits="Admin_EbAd_BuyAdminBookFranchiseGSP" %>
<%@ Register src="EBLeftMenu_Books.ascx" tagname="EBLeftMenu_Books" tagprefix="uc1" %>

<%@ Register src="EBLeftMenu_Franchise.ascx" tagname="EBLeftMenu_Franchise" tagprefix="uc2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentLeftMenu" Runat="Server">
        ...
        <uc2:EBLeftMenu_Franchise ID="EBLeftMenu_Franchise1" runat="server" />
