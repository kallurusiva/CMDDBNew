...
public partial class Admin_EbAd_BuyAdminBookStar : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            if (Request.QueryString.Count > 0)
            {
                ...
                ViewState["redirect"] = Request.QueryString["r"].ToString();
            }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            ...
            CommonFunctions.AlertMessageAndRedirect(returnMessage.ToString(), "EBAd_BookListingAdminNew.aspx");
        }
    }
    ...
    protected void btnCancel_Click(object sender, EventArgs e)
    {
        ...
        {
            Server.Transfer("EBAd_StarRating_CurrentMonth.aspx");
        }
        if (ViewState["redirect"].ToString() == "2")
        {
            Server.Transfer("EBAd_StarRating_PreviousMonth.aspx");
        }
        if (ViewState["redirect"].ToString() == "3")
        {
            Server.Transfer("EBAd_StarRating_Accumulated.aspx");
        }
        if (ViewState["redirect"].ToString() == "4")
        {
            Server.Transfer("EBAd_StarRating_YourAdminBooks.aspx");
        }
    }
