<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EbAd_SetDesign14.aspx.cs" Inherits="Admin_EbAd_SetDesign14" %>
           ...
           <table cellpadding="0" cellspacing="3" id="tblPlan" class="stdtableBorder_Main" width="100%" runat="server">
            ...
            <td>
                <table cellpadding="0" cellspacing="0" class="stdtable_BdrBlue_BkgGrey" width="100%">
                    ...
                    <td>&nbsp;</td>
                        <td align="left">
                               <asp:RadioButton ID="rdoEbD2template_Black" Text="WebDesign3 Black" 
                                   runat="server" ValidationGroup="VgCheck" GroupName="GrpTemplate" />
                            <br />
                            <img alt="webtmp2" src="../Images/ebImages/Design14_Black.jpg" 
                                style="width: 200px; height: 120px" />
                                </td>
                        <td>
                             <asp:RadioButton ID="rdoEbD2template_Blue" Text="WebDesign3 Blue" 
                                 runat="server" ValidationGroup="VgCheck" GroupName="GrpTemplate" />
                            <br />
                            <img alt="webtmp2" src="../Images/ebImages/Design14_Blue.jpg" 
                                style="width: 200px; height: 120px" />
                                </td>
                        <td>
                            <asp:RadioButton ID="rdoEbD2template_Green" Text="WebDesign3 Green" 
                                runat="server" ValidationGroup="VgCheck" GroupName="GrpTemplate" />
                            <br />
                            <img alt="webtmp2" src="../Images/ebImages/Design14_Green.jpg" 
                                style="width: 200px; height: 120px" />
                                
                                </td>
                        <td>
                              <asp:RadioButton ID="rdoEbD2template_Orange" ValidationGroup="VgCheck" Text="WebDesign3  Orange" 
                                  runat="server" GroupName="GrpTemplate" />
                            <br />
                            <img alt="webtmp2" src="../Images/ebImages/Design14_Orange.jpg" 
                                style="width: 200px; height: 120px" />
                            
                            </td>
                        <td>
                                             <asp:RadioButton ID="rdoEbD2template_Red" ValidationGroup="VgCheck" Text="WebDesign3 Red" 
                                                 runat="server" GroupName="GrpTemplate" />
                            <br />
                            <img alt="webtmp2" src="../Images/ebImages/Design14_Red.jpg" 
                                style="width: 200px; height: 120px" />
                                </td>
                        <td>
                            &nbsp;</td>
