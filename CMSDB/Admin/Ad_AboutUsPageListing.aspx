<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="Ad_AboutUsPageListing.aspx.cs" Inherits="Admin_AboutUsPageListing" %>
...
<script language="javascript" type="text/javascript">
    ...
    function SelectRow(cb_ID) {
       ...
       var ObjgridViewCtlId = '<%=gridAboutUsPage.ClientID%>';
                 ...
                 <table cellpadding="0" cellspacing="0" width="98%" class="tblSubHeader">
                  <tr>
                        ...
                        <td width="60%" align="left" class="subHeaderFontGrad">
                            &nbsp;<asp:Literal ID="ltrAboutUsListing" Text="AboutUs Listing" runat="server"></asp:Literal>                            
                             </td>
                        <td width="30%"> 
                ...
                <table cellpadding="0" cellspacing="3" class="stdtableBorder_Main" width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:GridView ID="gridAboutUsPage" runat="server" AutoGenerateColumns="False" DataKeyNames="Abid"
                             CssClass ="mGrid" HeaderStyle-CssClass="rowheader" AlternatingRowStyle-CssClass="rowalt" 
                              AllowPaging="true" PageSize="20" onpageindexchanging="gridAboutUsPage_PageIndexChanging"
                               AllowSorting="true" OnSorting="gridAboutUsPage_Sorting" 
                                onrowcancelingedit="gridAboutUsPage_RowCancelingEdit" 
                                onrowediting="gridAboutUsPage_RowEditing" onrowupdating="gridAboutUsPage_RowUpdating" 
                                onrowdeleting="gridAboutUsPage_RowDeleting" ondatabound="gridAboutUsPage_DataBound" 
                                onrowdatabound="gridAboutUsPage_RowDataBound"
                             >
                            <Columns>
                            ...
                            <asp:TemplateField HeaderText="Sl No">
                              <ItemTemplate>
                               <asp:Label ID="lblSlNo" runat="server" Text='<%# Container.DataItemIndex + 1  %>'/>
                                  <asp:Literal ID="hdWelcomeID" Visible="false" Text='<%#Bind("Abid")%>' runat="server"></asp:Literal>
