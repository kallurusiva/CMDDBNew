<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EBAd_Catalog.aspx.cs" Inherits="EBAd_Catalog" %>
                    ...
                    <tr>
                        ...
                        <%--    <asp:TemplateField HeaderText="Sl No">
                            ...
                            <asp:TemplateField HeaderText="Sl No">
                              ...
                              <asp:TemplateField HeaderText="Book ID<br>BookName" SortExpression="BookID" >
                              <ItemTemplate>
                                  <asp:Literal ID="LtrBookID" runat="server" Text='<%# Bind("BookID")  %>'></asp:Literal>
                                  <br />
                                  <asp:Literal ID="LtrBookName" runat="server" Text='<%# Bind("BookName")  %>'></asp:Literal>
                              </ItemTemplate>
                             ...
                             <asp:TemplateField HeaderText="Category" SortExpression="CategoryName" >
                              ...
                              <asp:TemplateField HeaderText="Book Attached">
                              <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Description" SortExpression="Description">
                              ...
                              <ItemTemplate>
                                  ...
                                  <asp:Label ID="lblPrice" CssClass="blue" runat="server" Text='<%# Bind("Price", "{0:0.00}")  %>'></asp:Label>
                                  <br />
                                  <asp:Label ID="lblDiscount" CssClass="red" runat="server" Text='<%# Bind("Discount")  %>'></asp:Label>
                                  <br />
                                  <asp:Label ID="lblDiscountedPrice" CssClass="green" runat="server" Text='<%# Bind("DiscountedPrice", "{0:0.00}")  %>'></asp:Label>
