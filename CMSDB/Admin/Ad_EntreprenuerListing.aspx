<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="Ad_EntreprenuerListing.aspx.cs" Inherits="Admin_EntreprenuerListing" %>
                 ...
                 <table cellpadding="0" cellspacing="0" width="98%" class="tblSubHeader">
                  <tr>
                        ...
                        <td width="60%" align="left" class="subHeaderFontGrad">
                            &nbsp; 
                            <asp:Literal ID="ltrProductListing" runat="server"></asp:Literal></td>
                         <td width="30%">  
                            ...
                            <asp:GridView ID="gridProducts" runat="server" AutoGenerateColumns="False" DataKeyNames="ProductID"
                             CssClass ="mGrid" HeaderStyle-CssClass="rowheader" AlternatingRowStyle-CssClass="rowalt" 
                              AllowPaging="true" PageSize="20" onpageindexchanging="gridProducts_PageIndexChanging"
                               ...
                               ondatabound="gridProducts_DataBound" onrowdatabound="gridProducts_RowDataBound"
                             >
                            <Columns>
                            ...
                            <asp:TemplateField HeaderText="Sl No">
                              <ItemTemplate>
                               <asp:Label ID="lblSlNo" runat="server" Text='<%# Container.DataItemIndex + 1  %>'/>
                                  ...
                                  <asp:HiddenField ID="HidCreatedBy" Value='<%#Eval("LoginID")%>' runat="server" />
                              </ItemTemplate>
                 ...
                 <%--             <EditItemTemplate>
                   ...
                   <%--           <EditItemTemplate>
                             ...
                             <asp:TemplateField HeaderText="Price" >
                              <ItemTemplate>
                                  <asp:Literal ID="LtrProductPrice" runat="server" Text='<%# Eval("Price","{0:n}")  %>'></asp:Literal>
                              </ItemTemplate>
                   <%--           <EditItemTemplate>
                                  <asp:TextBox ID="txtByName" CssClass="stdTextField1" Text='<%# Bind("tstByName")  %>' runat="server"></asp:TextBox>
                              </EditItemTemplate>--%>
              ...
              <%--              <asp:TemplateField HeaderText="Created By" >
                   ...
                   <%--          <asp:TemplateField HeaderText="Priority">
                            ...
                            <%--      <asp:HyperLink ID="HyLinkEdit" runat="server" Visible="false">
                                  ...
                                  <asp:ImageButton ID="ImgEdit" CommandName="EDIT" ToolTip="Edit Product" runat="server" ImageUrl="~/Images/imgEdit2.gif" />
