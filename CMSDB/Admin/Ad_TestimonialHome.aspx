<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="Ad_TestimonialHome.aspx.cs" Inherits="Admin_Ad_TestimonialHome" %>

<%@ Register src="../SuperAdmin/SelectLanguage.ascx" tagname="SelectLanguage" tagprefix="uc2" %>



<%@ Register src="LeftMenu_Testimonial.ascx" tagname="LeftMenu_Testimonial" tagprefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentLeftMenu" Runat="Server">
    <uc1:LeftMenu_Testimonial ID="LeftMenu_Testimonial1" runat="server" />
    </asp:Content>
                    ...
                    <tr>
                        ...
                        <td>
                         <table cellpadding="0" cellspacing="0" class="tblForm" width="100%">
                                ...
                                <tr>
                                    <td class="tblFormLabel">&nbsp; TESTIMONIALS </td>
