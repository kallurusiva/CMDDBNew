...
public partial class Admin_EBAd_BookUpdateHistory : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ViewState["SortExpr"] = "dateupdated";
    ...
    protected void PopulateGrid(string vSortExpr, string vSortDir)
    {
        ...
        ds = objPS.ebook_bookupdateHistory(ViewState["mobileValPS"].ToString());
