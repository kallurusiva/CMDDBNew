<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="PremiumSMSReport_SummaryNew.aspx.cs" Inherits="Admin_PremiumSMSReport_SummaryNew" %>
                            ...
                            <table cellpadding="0" cellspacing="3" class="stdtableBorder_Main" width="100%">
                                <tr>
                                 ...
                                 <tr>
                                    ...
                                    <td class="auto-style5" >
                                       <%-- Select your Email Address&nbsp; : --%>PremiumSMS Incentive</td>
                                 ...
                                 <tr>
                                    <td>
                                        &nbsp;</td>
                                    <td class="auto-style5" >
                                        Direct Partner PremiumSMS Incentive</td>
                                    <td class="tblFormText1" align="left">
                                ...
                                <tr>
                                    <td>
                                        &nbsp;</td>
                                    <td class="auto-style5" >
                                        Author PremiumSMS Incentive</td>
                                    <td class="tblFormText1" align="left">
                                ...
                                <tr>
                                    <td>
                                        &nbsp;</td>
                                    <td class="auto-style5" >
                                        Introducer PremiumSMS Incentive</td>
                                    <td class="tblFormText1" align="left">
                                ...
                                <tr>
                                    <td>
                                        &nbsp;</td>
                                    <td class="auto-style5" >
                                        Credit Card BookStore Incentive</td>
                                    <td class="tblFormText1" align="left">
                                        <asp:Label runat="server" ID="lblIncentiveC"> </asp:Label></td>
                                    <td>
                                        &nbsp;</td>
                                </tr>
                                <tr>
                                    <td>
                                        &nbsp;</td>
                                    <td class="auto-style5" >
                                        Credit Card Direct Partner Incentive</td>
                                    <td class="tblFormText1" align="left">
                                        <asp:Label runat="server" ID="lblIncentiveSC"> </asp:Label></td>
                                    <td>
                                        &nbsp;</td>
                                </tr>
                                <tr>
                                    <td>
                                        &nbsp;</td>
                                    <td class="auto-style5" >
                                        Credit Card Author Incentive</td>
                                    <td class="tblFormText1" align="left">
                                        <asp:Label runat="server" ID="lblIncentiveAC"> </asp:Label></td>
                                    <td>
                                        &nbsp;</td>
                                </tr>
                                <tr>
                                    <td>
                                        &nbsp;</td>
                                    <td class="auto-style5" >
                                        Credit Card A.Introducer Incentive</td>
                                    <td class="tblFormText1" align="left">
                                        <asp:Label runat="server" ID="lblIncentiveIC"> </asp:Label></td>
                                    <td>
                                        &nbsp;</td>
                                </tr>
                                <tr>
