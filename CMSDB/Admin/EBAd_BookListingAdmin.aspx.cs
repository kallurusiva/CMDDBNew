...
public partial class Admin_EBAd_BookListingAdmin : System.Web.UI.Page
{
    ...
    protected void PopulateGrid(string vSortExpr, string vSortDir, string vSearchQuery)
    {
        ...
        ds = objDBS.Ebook_Listing_New(Convert.ToInt32(Session["UserID"]), tmpUserType, Convert.ToInt32(strPageNo), vSearchQuery,"0");
    ...
    protected void LoadCategories()
    {
        ...
        newDBS objDBS = new newDBS();
        ds = objDBS.Category_Load_ByUserID_New(Convert.ToInt32(Session["UserID"]), tmpUserType,"0");
