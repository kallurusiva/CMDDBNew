<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EBAd_FeatureBuyADD1.aspx.cs" Inherits="EBAd_FeatureBuyADD" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentLeftMenu" Runat="Server">
    <form id="form1" runat="server">
        <uc2:EBLeftMenu_FeatureBuy ID="EBLeftMenu_FeatureBuy1" runat="server" />
</form>
</asp:Content>
