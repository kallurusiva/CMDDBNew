<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EBAd_StarRating_PreviousMonth.aspx.cs" Inherits="Admin_EBAd_StarRating_PreviousMonth" %>
                 ...
                 <table cellpadding="0" cellspacing="0" width="100%" class="tblSubHeader">
                  <tr>
                        ...
                        <td width="60%" align="left" class="subHeaderFontGrad">
                            &nbsp; Star Rating Admin Books - Previous Month (<asp:Label ID="lblcMonth" runat="server" Text=""></asp:Label>)</td>
      ...
      <asp:TemplateField HeaderText="Sno">
       ...
       <asp:TemplateField HeaderText="Book Title">        
        ...
        <asp:TemplateField HeaderText="$$$ Incentive">        
            <ItemTemplate>
                <asp:Label ID="lblBookIncentive" runat="server" Text='<% # Bind("Incentive")%>'></asp:Label>
            </ItemTemplate>            
            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
        </asp:TemplateField>
