...
public partial class Ad_WP_SideImage : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                CommonFunctions.AlertMessage("Side Banner successfully uploaded and saved");
            }
            else if (Request.QueryString["qBannerUp"] == "CHANGED")
            {
                CommonFunctions.AlertMessage("Side Banner  successfully updated");
            }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        objBAL_AccountSettings.WP_Save_Images(objImageUser, Convert.ToInt32(Session["UserID"]), 0, "WP_SIDE");
        ...
        Response.Redirect("Ad_WP_SideImage.aspx?qBannerUp=CHANGED");
    ...
    protected void btn_Banner_Logo0_Click(object sender, EventArgs e)
    {
        ...
        if (FU_Banner.HasFile)
        {
            ...
            Response.Redirect("Ad_WP_SideImage.aspx?qBannerUp=TRUE");
