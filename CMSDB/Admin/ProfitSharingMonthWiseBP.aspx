<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="ProfitSharingMonthWiseBP.aspx.cs" Inherits="Admin_ProfitSharingMonthWiseBP" %>
      ...
      <asp:TemplateField HeaderText="Premium Amount">        
        ...
        <asp:TemplateField HeaderText="Your Profit">        
            <ItemTemplate>
                ...
                <asp:Label ID="lblSponsorShare" runat="server" Text='<% # Bind("SponsorRevenueNet")%>'></asp:Label>
            </ItemTemplate>
            <ItemStyle  HorizontalAlign="Right" VerticalAlign="Top" />
        </asp:TemplateField>    
