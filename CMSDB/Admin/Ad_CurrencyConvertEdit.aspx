<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="Ad_CurrencyConvertEdit.aspx.cs" Inherits="Admin_Ad_CurrencyConvertEdit" %>
                    ...
                    <%--<tr>
                     ...
                     <tr>
                        ...
                        <td class="tblFormText1" align="left" colspan="2">
                         ...
                         <asp:TextBox ID="txtPoints" CssClass="stdTextField2" runat="server" ValidationGroup="vCheck"></asp:TextBox>
                        &nbsp;

                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="txtPoints" runat="server" CssClass="ValAlert_Error" ErrorMessage="Currency Convertor cannot be Empty." ValidationGroup="vCheck" Display="Dynamic"></asp:RequiredFieldValidator>          
                         </td>
                        <td class="tblFormText1" align="left">
                            &nbsp;</td>
                        <td>
                     ...
                     <tr>
                        <td class="tblFormLabel1" >
                            &nbsp;</td>
                        <td class="tblFormText1" align="left">
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ControlToValidate="txtPoints" ValidationExpression="^[0-9]+(\.[0-9]{1,2})?$" runat="server" CssClass="ValAlert_Error" ValidationGroup="vCheck" Display="Dynamic" ErrorMessage="Only Numerics Allowed in Currency Convertor"></asp:RegularExpressionValidator>
                         </td>
                        <td class="tblFormText1" align="left">
                            &nbsp;</td>
                        <td>
                     ...
                     <tr>
                        <td class="tblFormLabel1" >
                            &nbsp;</td>
                        <td class="tblFormText1" align="left">
                            <asp:Button ID="BtnSave" runat="server" ValidationGroup="vCheck" CssClass="stdbuttonCRUD" Text="Save my Conversion" OnClick="BtnSave_Click" />
                         </td>
                        <td class="tblFormText1" align="left">
                            &nbsp;</td>
                        <td>
