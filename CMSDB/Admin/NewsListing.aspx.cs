...
public partial class Admin_NewsListing : BasePage
{
    DataSet ds;
    DataView dv;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ltrNewsListing.Text = Resources.LangResources.News + " " + Resources.LangResources.Listing;
        //LtrNewsListing.Text = "News Listing";
    ...
    protected void PopulateGrid(string vSortExpr, string vSortDir)
    {
        ...
        ds = objBAl_News.Retrieve_AllNewsByUserID(Convert.ToInt32(Session["UserID"]), ViewState["RtType"].ToString(), qLgType);
    ...
    protected void gridNews_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        tmpNewsContent = CommonFunctions.HandleNewLines(tmpNewsContent, Request.UserAgent);
         ...
         if (Convert.ToInt16(objHidUserType.Value) == 2)
         {
             ...
             upStatus = objBAL_CommonFunc.InsertUpdate_ShowAdminItems("tblNews", ltrNewsID.Text, Convert.ToInt32(Session["UserID"]));

         }
         else
         {

             upStatus = objBAl_News.UpdateNewsData(tbNewsTitle.Text, tmpNewsContent.ToString(), Convert.ToInt32(Session["UserId"]), Convert.ToInt32(ltrNewsID.Text), chkActive.Checked,1);
         }
    ...
    protected void gridNews_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        bool delStatus = objBAl_News.DeleteNewsData(Convert.ToInt32(Session["UserID"]), NewsIdToDelte);
    ...
    protected void gridNews_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        else if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (ViewState["RtType"] != null)
            {
                ...
                //        gridNews.Columns[6].Visible = false;
                //}
                if ((ViewState["RtType"].ToString() == "ADMIN") || (ViewState["RtType"].ToString() == "ALL"))
                {
                    ...
                    TextBox txtNewsTitle = (TextBox)e.Row.FindControl("txtNewsTitle");
                    TextBox txtNewsContent = (TextBox)e.Row.FindControl("txtNewsContent");


                    if (txtNewsTitle != null)
                    {

                        txtNewsTitle.ReadOnly = true;
                        txtNewsTitle.CssClass = "stdTextField1_disabled";
                    }


                    if (txtNewsContent != null)
                    {
                        txtNewsContent.ReadOnly = true;
                        txtNewsContent.CssClass = "stdTextArea2_disabled";
                    }
    ...
    protected void btnPrt_UP_Click(object sender, EventArgs e)
    {
        ...
        if (PrevRowIndex >= 0)
        {
            ...
            if (objLtr_CurrPriority != null)
            {
                ...
                int upStatus = objBAL_CommonFunc.ChangePriorityOrder("tblNews", "NewsID", "IX_News_Priority", CurrPriority, CurrFaqID, PrevPriority, PrevFaqID, Session["UserID"].ToString());
    ...
    protected void btnPrt_DOWN_Click(object sender, EventArgs e)
    {
        ...
        if (NextRowIndex < MaxRows)
        {
            ...
            if (objLtr_CurrPriority != null)
            {
                ...
                int upStatus = objBAL_CommonFunc.ChangePriorityOrder("tblNews", "NewsID", "IX_News_Priority", CurrPriority, CurrFaqID, NextPriority, NextFaqID, Session["UserID"].ToString());
    ...
    protected void btnDeleteAll_Click(object sender, EventArgs e)
    {
        ...
        if (strNewsIDs != string.Empty)
        {
            bool delMulStatus = objBAl_News.DeleteNewsData_Multiple(Convert.ToInt32(Session["UserID"]), strNewsIDs);
