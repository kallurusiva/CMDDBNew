<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EBAd_UserCategoryMain.aspx.cs" Inherits="EBAd_UserCategoryMain" %>
                    ...
                    <%-- <tr>
                     ...
                     <tr>
                        <td class="tblFormLabel1" >
                            &nbsp;</td>
                        <td class="tblFormText1" align="left">
                            <asp:Button ID="BtnSave" runat="server" ValidationGroup="vCheck" CssClass="stdbuttonCRUD" Text="Save Main Category" OnClick="BtnSave_Click" />
                         </td>
                        <td class="tblFormText1" align="left">
                            &nbsp;</td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td colspan="3" align="center" >
                            <asp:GridView ID="GridCategory" runat="server" AllowPaging="false" ShowFooter="true"  
                                ...
                                CssClass="mGrid" DataKeyNames="CatMainID" HeaderStyle-CssClass="rowheader" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Sl No">
                                        <ItemTemplate>
                                            ...
                                            <asp:Literal ID="hdCatID" runat="server" Text='<%#Bind("CatMainID")%>' Visible="false"></asp:Literal>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Main Category Name">
                                      ...
                                      <asp:TemplateField HeaderText="Created By">
                                        <ItemTemplate>
                                            <asp:Literal ID="LtrCreatedBy" runat="server" Text='<%# Bind("CatCreatedBy") %>'></asp:Literal>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" Width="50px" />
                                    </asp:TemplateField>
