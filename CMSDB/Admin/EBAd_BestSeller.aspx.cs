...
public partial class EBAd_BestSeller : System.Web.UI.Page 
{
    ...
    protected void PopulateGrid(string vSortExpr, string vSortDir)
    {
        ...
        //ds = objEbook.Ebook_Listing(Convert.ToInt32(Session["UserID"]), " AND isBestSeller = 1"); 

        ds = objEbook.Ebook_BestSeller_LIST(Convert.ToInt32(Session["UserID"]), ""); 
    ...
    protected void gridEbooks_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        HiddenField ObjhdBestSellerUID = (HiddenField)gvRow.FindControl("hdBestSellerUID");

        int tmpBSuid = Convert.ToInt32(ObjhdBestSellerUID.Value); 

       // int delStatus = objEbook.EBook_Delete(ObjhdBookId.Value, Convert.ToInt32(ObjhdUID.Value));

        int delStatus = objEbook.EBook_BestSeller_Delete(tmpBSuid); 
           ...
           //}
            ...
            else
            {
              ...
              //  HyperLink objHypEditByUser = (HyperLink)e.Row.FindControl("HyLinkEditByUser");
                ...
                //objHypEditByUser.NavigateUrl = "EBAd_BestSEllerEdit.aspx?qBID=" + objBookUID.Value; 
                ...
                //HyLinkEdit.NavigateUrl = "EBAd_BestSEllerEdit.aspx?qBID=" + Server.UrlEncode(CommonFunctions.Encrypt(objBookID.Value)); 
                //HyLinkEdit.Visible = true;
    ...
    protected void gridEbooks_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        int vBookType = Convert.ToInt16(GlobalVar.EbookTypes.BestSeller);

        //Response.Write(vBookID.ToString() + "<br>");
        //Response.Write(vBookUID.ToString() + "<br>");
        //Response.Write(vBookType.ToString() + "<br>");
        //Response.Write(chkActive.Checked.ToString() + "<br>");
    ...
    protected void Button_View(object sender, CommandEventArgs e)
    {
       ...
       // Response.Redirect(@"EBAd_BestSellerEdit.aspx"); 

       Server.Transfer(@"EBAd_BestSellerEdit.aspx");
    }
