<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EbAd_PhyEBookRequest_Status.aspx.cs" Inherits="EbAd_PhyEBookRequest_Status" %>
                 ...
                 <table cellpadding="0" cellspacing="0" width="96%" class="tblSubHeader">
                  <tr>
                        ...
                        <td width="90%" align="left" class="subHeaderFontGrad">
                            &nbsp; Physical EBook Request&nbsp; - Status</td>
                ...
                <table cellpadding="0" cellspacing="2" class="stdtableBorder_MainBold" width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                             ...
                             <table id="tblValidate" runat="server" visible="false" border="0" cellpadding="0" cellspacing="2" width="100%">
                                ...
                                <tr>
                                <td colspan="3">
                                    <asp:Label ID="lblBookStatus" CssClass="PhyBookReqStatusAlert" runat="server"></asp:Label>
                                      </td>
                                </tr>
                            ...
                            <table id="tblPhyBookReqDetails" runat="server" visible="false" border="0" cellpadding="0" cellspacing="2" width="100%">
                                <tr>
                                 <td width="23%">&nbsp;</td>
                                 <td width="2%">&nbsp;</td>
                                 <td width="75%">&nbsp;</td>
