<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="ProfitSharingShortCodeWiseBP.aspx.cs" Inherits="Admin_ProfitSharingShortCodeWiseBP" %>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                 ...
                 <table cellpadding="0" cellspacing="0" width="98%" class="tblSubHeader">
                  <tr>
                        ...
                        <td width="60%" align="left" class="subHeaderFontGrad">
                            &nbsp; 
                        <asp:Label ID="lblUpgrade" runat="server" Text="ShortCode : " CssClass="txtBlackBMedium"></asp:Label>
      ...
      <asp:TemplateField HeaderText="Month/Year">        
            <ItemTemplate>
                ...
                <asp:HiddenField ID="hiddenMonth" runat="server" Value='<% # Bind("rptMonth")%>'/>
                <asp:HiddenField ID="hiddenYear" runat="server" Value='<% # Bind("rptYear")%>'/>
            </ItemTemplate>            
            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
      </asp:TemplateField>
       ...
       <asp:TemplateField HeaderText="ShortCode">        
            <ItemTemplate>
                ...
                <asp:HiddenField ID="hiddenShortcode" runat="server" Value='<% # Bind("shortcode")%>'/>
            </ItemTemplate>            
            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
      </asp:TemplateField>
      ...
      <asp:TemplateField HeaderText="Premium Amount">        
        ...
        <asp:TemplateField HeaderText="your Share">        
            <ItemTemplate>
                <asp:Label ID="lblYShare" runat="server" Text="10%"></asp:Label>
        ...
        <asp:TemplateField HeaderText="Your Profit">        
            <ItemTemplate>
                ...
                <asp:Label ID="lblSponsorShare" runat="server" Text='<% # Bind("sponsorNet")%>'></asp:Label>
            </ItemTemplate>
            <ItemStyle  HorizontalAlign="Right" VerticalAlign="Top" />
        </asp:TemplateField>
        ...
        <asp:TemplateField HeaderText="View">        
            <ItemTemplate>
                <asp:ImageButton ID="ImageButtonR" runat="server"  ImageUrl="~/Images/icon_view.png" CommandArgument='<%# Eval("uid")%>' OnCommand="Button_View"/> 
            </ItemTemplate>
