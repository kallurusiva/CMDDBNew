<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SideMenu_Testimonial.ascx.cs" Inherits="Admin_AdminSideMenu" %>
                  ...
                  <tr>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <asp:Image ID="Image2" ImageUrl="~/Images/tb_menuitem.jpg" runat="server" />
                                <asp:HyperLink ID="HyperLink3" CssClass="Links_TopBarMenu" runat="server" NavigateUrl="TestimonialCreate.aspx">
                            ...
                            <td  width="150px">
                             ...
                             <asp:HyperLink ID="HyperLink1" CssClass="Links_TopBarMenu" runat="server" NavigateUrl="TestimonialListing.aspx?RtType=USER">
