<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="MyHomePageSettings.aspx.cs" Inherits="Admin_MyHomePageSettings" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <style type="text/css">
        ...
        {
            height: 30px;
            filter: progid:DXImageTransform.Microsoft.Gradient(GradientType=0,StartColorStr=#EEFDF2 ,EndColorStr=#CDF2D6);
            font-weight: bold;
            border-bottom: 1px solid #CDF2D6;
            margin: 0;
                        ...
                        <td>
                            <table border="0" cellpadding="0" cellspacing="2" width="100%">
                                <tr>
                                 ...
                                 <tr>
                                 <td align="left" style="font-weight: 700" class="tblFormLabel"> 
                           ...
                           <asp:Panel ID="PanelLogoHead" runat="server">
                              ...
                              <%--  <tr class="BlankWhiteHorizontalLine">
                                ...
                                <tr id="tr_bannerHead" runat="server">
                                 <td colspan="3">
                                ...
                                <tr id="tr_bannerBody" runat="server">
                                <td colspan="3">
