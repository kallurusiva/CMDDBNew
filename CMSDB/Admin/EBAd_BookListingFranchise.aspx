<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EBAd_BookListingFranchise.aspx.cs" Inherits="Admin_EBAd_BookListingFranchise" %>
                        ...
                        <td align="center">
                            <table cellpadding="0" cellspacing="0" class="MessagerBarCss" id="tblMessageBar" visible="false" runat="server">
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:Label ID="lblErrMessage" CssClass="font_12Msg_Error" runat="server" Text="Label"></asp:Label></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                                    ...
                                    <td align="center">
                                        <table cellpadding="0" cellspacing="0" width="100%" class="tblSubHeader">
                                            <tr>
                                                ...
                                                <td width="60%" align="left" class="subHeaderFontGrad">&nbsp; Products Listing</td>
                              ...
                              <ItemStyle Width="30px" />
                                                            ...
                                                            <asp:TemplateField HeaderText="Attachment">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <br />
                                                                    <br />
                                                                    <asp:LinkButton ID="linkBtnDownloadFile" OnClientClick="return confirm('5 SMS credits would be deduted for ebook Download \n\n Please click OK if you want to continue download \nelse click CANCEL.\n\nPlease Refresh page after download.');"
