<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EBAd_FeatureBuyADD2.aspx.cs" Inherits="EBAd_FeatureBuyADD2" %>
...
<%@ Register src="EBLeftMenu_ebButtons.ascx" tagname="EBLeftMenu_ebButtons" tagprefix="uc4" %> 
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentLeftMenu" Runat="Server">
        ...
        <uc4:EBLeftMenu_ebButtons ID="EBLeftMenu_ebButtons1" runat="server" />
                 ...
                 <table cellpadding="0" cellspacing="0" width="100%" class="tblSubHeader">
                  <tr>
                        ...
                        <td width="90%" align="left" class="subHeaderFontGrad">
                            &nbsp; Add new Feature Buy&nbsp; Product&nbsp; </td>
                    ...
                    <%--<tr>
                     ...
                     <tr>
                        ...
                        <td class="tblFormText1" align="left">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtBookID" ErrorMessage=" Please enter Product ID" ValidationGroup="VgCheck"></asp:RequiredFieldValidator>
