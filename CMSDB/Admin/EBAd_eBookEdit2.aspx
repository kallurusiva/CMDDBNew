<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EBAd_eBookEdit2.aspx.cs" Inherits="EBAd_eBookEdit2" %>
                ...
                <table cellpadding="0" cellspacing="3" class="stdtableBorder_Main" width="100%">
                    ...
                    <%--<tr>
                     ...
                     <tr>
                        ...
                        <td class="FontNote" align="left" style="font-size: medium; font-weight: bold">
                            Note:<br /><br />
                            ...
                            5.  Do not upload illegal EBooks or Private label EBooks</td>
                     ...
                     <%--<tr>
                        ...
                        <td class="auto-style7" >
                            eBook Title :</td>
                        <td class="tblFormText1" align="left">--%>
                            <asp:TextBox ID="txtBookTitle" runat="server" CssClass="stdTextField2" TabIndex="4" MaxLength="250" Visible="false"></asp:TextBox>
                            <%--</td>
                        <td class="tblFormText1" align="left">
                            &nbsp;</td>
                        <td>
...
&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="ddlMainCategory" Display="Dynamic" ErrorMessage="Please select Main-Category" InitialValue="0" ValidationGroup="VgCheck"></asp:RequiredFieldValidator>
                    ...
                    <%--<tr>
                     ...
                     <tr>
                        ...
                        <td class="tblFormText1" align="left">
                            ...
                            USD <asp:DropDownList ID="txtPrice" runat="server" AutoPostBack="True" CssClass="stdDropDown2" OnSelectedIndexChanged="txtPrice_SelectedIndexChanged" TabIndex="6" ValidationGroup="VgCheck">
                            ...
                            <a href="http://14.102.146.116/Admin/EbAd_CurrencyTableNew.aspx" target="_blank">View Currency Table</a></td>
                        <td class="auto-style6" align="left">
                            &nbsp;</td>
                        <td class="auto-style4">
                            </td>
                     ...
                     <tr>
                        ...
                        <td class="auto-style7" >
                            Net Price :</td>
                        <td class="tblFormText1" align="left">
                            USD <asp:TextBox ID="txtDiscountedPrice"  runat="server" CssClass="stdTextField1" TabIndex="14"></asp:TextBox>
                            </td>
                        <td class="auto-style6" align="left">
                            &nbsp;</td>
                        <td class="auto-style4">
                    ...
                    <tr>
                        ...
                        <td class="tblFormText1" align="left">
                            <asp:Label runat="server" ID="urCurrency" Text=""></asp:Label>&nbsp;
                            <asp:Label runat="server" ID="urPrice" Text=""></asp:Label>
                        </td>
                        <td class="auto-style6" align="left">
                            &nbsp;</td>
                        <td class="auto-style4">
                    ...
                    <%--<tr>
                     ...
                     <tr>
                        ...
                        <td class="tblFormText1" align="left">
                            ...
                            <asp:RequiredFieldValidator runat="server" Display="dynamic" ID="RequiredFieldValidator4" SetFocusOnError="true" ControlToValidate="txtPosition" ErrorMessage="Invalid Position value"></asp:RequiredFieldValidator>
...
&nbsp;&nbsp;&nbsp;&nbsp; eg: Position 1 - means appear at the top.</td>
                     ...
                     <tr>
                        <td class="auto-style5" >
                            &nbsp;</td>
                        <td class="auto-style5" >
                            Upload eBook Image: <span class="font_12Msg_Error">*</span><br /><span class="auto-style9">(.JPEG only)
                        </span></td>
                        <td class="auto-style6" align="left">
                     ...
                     <tr>
                        ...
                        <td class="auto-style6" align="left">
                            ...
                            <asp:Label ID="lblCurrentEbookFile" CssClass="font_12Msg_Success" runat="server" Text=""></asp:Label>
                         </td>
                        <td class="auto-style6" align="left">
                            &nbsp;</td>
                        <td class="auto-style4">
...
&nbsp;
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="UploadEbookFile" Display="Dynamic" runat="server" ErrorMessage="Please Choose a File for EBook."></asp:RequiredFieldValidator>
                             ...
                             <%--<asp:RegularExpressionValidator ID="FileUploadValidator0"  runat="server" Display="Dynamic"  ValidationGroup="VgCheck"
                                ControlToValidate="UploadEbookFile" ErrorMessage="Only Pdf files are allowed.  Please select another File." 
                   ...
                   <asp:TextBox ID="txtSMSmessage"  runat="server" Visible="false"></asp:TextBox>
                     <%--<tr>
                        ...
                        <td class="tblFormText1" align="left">
                            <asp:TextBox ID="txtSMSmessage"  runat="server" CssClass="stdTextArea2" onKeyUp="CheckTextLength(this,130)" onChange="CheckTextLength(this,150)" MaxLength="130" TextMode="MultiLine" Width="600px" Height="100px" TabIndex="22"></asp:TextBox>
                            </td>
                        <td class="tblFormText1" align="left">
                            &nbsp;</td>
                        <td>
