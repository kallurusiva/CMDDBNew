<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="Ad_OwnButtonCreate2.aspx.cs" Inherits="Admin_Ad_OwnButtonCreate2" %>
                ...
                <table cellpadding="0" cellspacing="3" id="tblPlan" width="98%" runat="server">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            ...
                            &nbsp; &nbsp;&nbsp; &nbsp;
                            <asp:Button ID="BtnUpdate" CssClass="stdbuttonCRUD" CommandName="Edit" 
