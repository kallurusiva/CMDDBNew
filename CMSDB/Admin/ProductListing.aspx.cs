...
public partial class Admin_ProductListing : BasePage
{
    ...
    protected void PopulateGrid(string vSortExpr, string vSortDir)
    {
        ...
        ds = objBAL_Products.RetrieveAllProducts_ByUserID(Convert.ToInt32(Session["UserID"]), ViewState["RtType"].ToString(), qLgType,Convert.ToInt16(GlobalVar.ProductTypes.Product));
