<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SideMenu_Events.ascx.cs" Inherits="Admin_AdminSideMenu" %>
                  ...
                  <tr>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <td  width="150px">
                             ...
                             <asp:HyperLink ID="HyperLink1" CssClass="Links_TopBarMenu" runat="server" NavigateUrl="EventsListing.aspx?RtType=USER">
