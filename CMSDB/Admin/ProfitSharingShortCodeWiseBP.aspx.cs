...
public partial class Admin_ProfitSharingShortCodeWiseBP : System.Web.UI.Page
{
    DataView dv;
    DataSet ds;
    DataView DL;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                ViewState["BPID"] = Session["Login_Id"].ToString();
            }
    ...
    protected void Button_View(object sender, CommandEventArgs e)
    {
        ...
        Server.Transfer(@"ProfitSharingMonthWiseBP.aspx?UID=" + hdnSno.Value.ToString());
    }
