<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EBAd_ValueBuyADD.aspx.cs" Inherits="EBAd_ValueBuyADD" %>
        ...
        <tr>
            ...
            <table cellpadding="0" cellspacing="3" class="stdtableBorder_Main" width="100%">
                    ...
                    <%--<tr>
                     ...
                     <tr>
                         <asp:TextBox ID="txtSubject"  ValidationGroup="VgCheck" runat="server" CssClass="stdTextField2" Visible="false" Text="-"></asp:TextBox>
                        <%--<td>
                            &nbsp;</td>
                        <td class="tblFormLabel1" >
                            Subject :</td>
                     ...
                     <tr>
                        ...
                        <td class="tblFormText1" align="left">
                            <asp:TextBox ID="txtSMSmessage"  ValidationGroup="VgCheck" runat="server" onKeyUp="CheckTextLength(this,150)" onChange="CheckTextLength(this,150)" MaxLength="150" CssClass="stdTextArea2" TextMode="MultiLine" Width="600px" Height="100px"></asp:TextBox>
                            </td>
                        <td class="tblFormText1" align="left">
                            &nbsp;</td>
                        <td>
