...
public partial class EBAd_UserCategoryMain : System.Web.UI.Page
{
    ...
    protected void PopulateGrid(string vSortExpr, string vSortDir, String vSearchStr)
    {
        ...
        ds =  objBALebook.CatMain_Listing(vUserID, "00"); 
    ...
    protected void GridCategory_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        int upStatus = objBALebook.CatMain_Update(vUserID, mCatId, txtCategoryName.Text, chkActive);
    ...
    protected void GridCategory_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        int delStatus = objBALebook.CatMain_Delete(CatIdToDelete, vUserID); 
    ...
    protected void GridCategory_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        else if (e.Row.RowType == DataControlRowType.DataRow) 
        {
            ...
            Literal objLtrBooksCount = (Literal)e.Row.FindControl("LtrSubCatcount");
            ...
            Literal objLtrCreatedBy = (Literal)e.Row.FindControl("LtrCreatedBy");

            
            if(objLtrCreatedBy.Text.ToUpper() == "ADMIN")
            {
                ImageButton objImgDelete = (ImageButton)e.Row.FindControl("ImgDelete");
                ...
                if (objImgEdit != null)
                {
                    objImgEdit.Visible = false;
                    objImgEdit.Visible = false;
                    //objImgEdit.ImageUrl = "~/Images/imgDelete_disabled.gif";
                }
   ...
   //     int vResult = CheckCategoryName_Availability(txtCategoryName.Text.Trim());
    ...
    protected int CheckCategoryName_Availability(String vCategoryName)
    {
        ...
        int chkStatus = objBALebook.CatMain_Validate(vUserID,vCategoryName);
    ...
    protected void BtnSave_Click(object sender, EventArgs e)
    {
        ...
        if (vResult == 1)
        {
            ...
            int inStatus = objBALebook.CatMain_Add(mCategoryName, mDisplayAtWebSite, vUserID, vMerchantID); 
