<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EBAd_CurrencyTable.aspx.cs" Inherits="Admin_EBAd_CurrencyTable" %>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <asp:TemplateField HeaderText="Exchange Rate USD -> Local (buying)" HeaderStyle-HorizontalAlign="Left"  HeaderStyle-Wrap="true" SortExpression="">    
    <ItemTemplate>
    ...
    <asp:TemplateField HeaderText="Exchange Rate USD -> Local (cashout)" HeaderStyle-HorizontalAlign="Left"  HeaderStyle-Wrap="true" SortExpression="">    
    <ItemTemplate>
