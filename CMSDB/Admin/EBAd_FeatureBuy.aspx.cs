...
public partial class EBAd_FeatureBuy : System.Web.UI.Page 
{
    ...
    protected void PopulateGrid(string vSortExpr, string vSortDir)
    {
        ...
        ds = objEbook.Ebook_FeatureBuy_LIST(Convert.ToInt32(Session["UserID"]), ""); 
    ...
    protected void gridEbooks_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        int delStatus = objEbook.EBook_FeatureBuy_Delete(Convert.ToInt32(ObjhdUID.Value));
