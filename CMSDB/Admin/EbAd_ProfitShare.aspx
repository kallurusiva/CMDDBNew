<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EbAd_ProfitShare.aspx.cs" Inherits="Admin_EbAd_ProfitShare" %>
                ...
                <table cellpadding="0" cellspacing="3" class="stdtableBorder_Main" width="100%">
                    <tr style="height:30px;">
                        ...
                        <td width="98%" align="left" class="FontNote">
                            &nbsp;<strong>NOTE</strong>: Only record that is confirmed by bactch run will be shown here. Payment is 90 working days and is by request. Minimum RM 200 for payment request.&nbsp; 
