<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Mobile/AdminMasterDIYMB.master" AutoEventWireup="true" CodeFile="Ad_AnchorSampleMobis.aspx.cs" Inherits="Ad_AnchorSampleMobis" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentBody" Runat="Server">
    ...
    function fnCheckDomain() {
        ...
        window.open(tmpURL, "winDomainCheck", "width=600px,height=650px,resizable=yes, scrollbars=yes,dependent=yes,left=50,top=50");
    ...
    function fnOpenMobileWeb(vURL) {
       ...
       // alert("Opening Mb url : " + vURL);
        window.open(vURL, "mbWeb", "width=420px,height=700px,resizable=no,scrollbars=yes,location=no,dependent=yes,left=30,top=30");
