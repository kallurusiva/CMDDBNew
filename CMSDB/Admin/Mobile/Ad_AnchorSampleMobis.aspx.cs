...
public partial class Ad_AnchorSampleMobis : BasePage 
{
    ...
    protected void rpChild_Anchordomains_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        if ((e.Item.ItemType == ListItemType.Item) || (e.Item.ItemType == ListItemType.AlternatingItem))
        {
         ...
         //   objLtrltrSubDomainURLlink.Text = "<a class='links_AnchorDomains2' target='_blank' href='" + tempLink + "'>" + tempLink + "</a>";
            ...
            HiddenField objHD_SampleWebsite = (HiddenField)e.Item.FindControl("hdAnchorDomain");
            String MobileWebStr = objHD_SampleWebsite.Value;
           ...
           // String MbURLString = "localhost:52541/CMSv3" + "/mb/mb_inframe.aspx";
            ...
            if (tmpSampleWebStr.Contains("http://"))
                objMobileWebURL.Text = @"<a class='links_AnchorDomains2' target='_blank' href='" + MbURLString + @"' onclick=""fnOpenMobileWeb('" + MbURLString + @"'); return false;"">" + MobileWebStr + "</a>";
            else
