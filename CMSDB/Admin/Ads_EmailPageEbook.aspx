<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="Ads_EmailPageEbook.aspx.cs" Inherits="Admin_Ads_EmailPageEbook" %>
                        ...
                        <table class="style1" id="tblButtonInfo" width="100%">
                                ...
                                <tr>
                                    <td class="tblFormLabel1">
                                        &nbsp;</td>
                                    <td class="tblFormText1">
                                        <font class="FontBRowHelp">Use this account&nbsp; to manage your email system. To Add/Edit/Delete email Accounts.</font>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="tblFormLabel1">
                                ...
                                <tr>
                                    <td class="tblFormLabel1">
                                        &nbsp;</td>
                                    <td class="tblFormText1">
                                       <font class="FontBRowHelp"> This is created by default by the administrator. </font></td>
                                </tr>
                                <tr>
                                    <td class="tblFormLabel1">
                                        Enquiry Email ID:</td>
                                ...
                                <tr>
                                    <td class="tblFormLabel1">
                                        &nbsp;</td>
                                    <td class="tblFormText1">
                                         <font class="FontBRowHelp"> Click here to Login into your Email Server. </font></td></td>
                                </tr>
                                <tr>
                                    <td class="tblFormLabel1">
                                        Http Link to 
                                ...
                                <tr>
                                    ...
                                    <td class="font_11Msg_Error" style="border: dashed 1px #D80000;" >
                                        <ol>
                                            <li>Email System will be created only for users who have registered Own Domain.</li>
                                            <li>&nbsp; We have created 2 basic emails. </li>
