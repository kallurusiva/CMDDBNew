...
public partial class Admin_EBAd_BookListingAdminFranchiseGSP : System.Web.UI.Page
{
    ...
    protected void PopulateGrid(string vSortExpr, string vSortDir, string vSearchQuery)
    {
        ...
        ds = objDBS.Ebook_Listing_FranchiseNewALL(Convert.ToInt32(Session["UserID"]), tmpUserType, Convert.ToInt32(strPageNo), vSearchQuery, "1","106");
    ...
    protected void LoadCategories()
    {
        ...
        newDBS objDBS = new newDBS();
        ds = objDBS.Category_Load_ByUserID_NewALL(Convert.ToInt32(Session["UserID"]), tmpUserType, "1","106");
