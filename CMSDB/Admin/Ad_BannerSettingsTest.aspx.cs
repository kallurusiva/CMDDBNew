...
public partial class Admin_Ad_BannerSettingsTest : BasePage
{
    ...
    protected void gridBanner_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            Literal objLTLvDisp = (Literal)e.Row.FindControl("ltlVDisp");
            objLTLvDisp.Text = objVDisp.Value.ToString();
