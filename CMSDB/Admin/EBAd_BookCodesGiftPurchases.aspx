<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EBAd_BookCodesGiftPurchases.aspx.cs" Inherits="Admin_EBAd_BookCodesGiftPurchases" %>
...
<ContentTemplate>--%>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="98%">
                 ...
                 <table cellpadding="0" cellspacing="0" width="100%" class="tblSubHeader">
                  <tr>
                        ...
                        <td width="60%" align="left" class="subHeaderFontGrad">
                            &nbsp; EBooks: - Birthday Purchase History</td>
      ...
      <%--<asp:TemplateField HeaderText="Country" SortExpression="TDate">        
        ...
        <asp:TemplateField HeaderText="Author Details" >        
            <ItemTemplate>
                 <asp:Label ID="lalAName" runat="server" Text='<% # Bind("AuthorName")%>'></asp:Label><br /><br />
            </ItemTemplate>            
            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
        </asp:TemplateField>
        <asp:TemplateField HeaderText="Buyer Details" >        
            <ItemTemplate>
                <asp:Label ID="lblFullName" runat="server" Text='<% # Bind("FullName")%>'></asp:Label><br /><br />
                <asp:Label ID="lblEmail" runat="server" Text='<% # Bind("Email")%>'></asp:Label><br /><br />
        ...
        <asp:TemplateField HeaderText="Download" >        
            <ItemTemplate>
                ...
                <asp:HyperLink ID="hypDownload" runat="server" NavigateUrl='<%# Eval("URL")%>' Target="_blank" > Download </asp:HyperLink><br /><br />
                ...
                <asp:HyperLink  runat="server" ID="hypDAPP" NavigateUrl='<% # Bind("dLink")%>' Target="_blank"><asp:Label ID="lblDLink" runat="server" Text="send Whatsapp"/></asp:HyperLink></ItemTemplate><ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
        </asp:TemplateField>
