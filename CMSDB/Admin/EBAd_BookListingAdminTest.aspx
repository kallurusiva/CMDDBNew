<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EBAd_BookListingAdminTest.aspx.cs" Inherits="Admin_EBAd_BookListingAdminTest" %>
                ...
                <table cellpadding="0" cellspacing="3" class="stdtableBorder_Main" width="100%">
                    ...
                    <tr>
                        ...
                        <%--    <asp:TemplateField HeaderText="Sl No">
                              ...
                              <ItemTemplate>
                                  <asp:Literal ID="LtreBookFileName" runat="server" Text='<%# Bind("eBookFileName")  %>'></asp:Literal>
                                   ...
                                   <asp:LinkButton ID="linkBtnDownloadFile" 
                                       OnClientClick='<%# Eval("smscredits", "return confirm(\"{0} SMS credits would be deduted for ebook Download. Click OK to continue else click CANCEL. Please Refresh page after download?\");") %>'
                            ...
                            <asp:TemplateField HeaderText="Your Share" SortExpression="Description">
                              <ItemTemplate>
                               <asp:Label ID="lblYourPercent" runat="server" Text='<%# Eval("OwnerPercent").ToString() %>'/>%
                              </ItemTemplate>
