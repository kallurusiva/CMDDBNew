...
public partial class EBAd_FeatureBuyADD : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (Page.IsValid)
        {
            ...
            else if (aStatus == 1)
            {
                ...
                Response.Redirect("EBAd_FeatureBuy.aspx?qStatus=1");
            }
