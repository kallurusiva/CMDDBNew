<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EBAd_StarRating_YourAdminBooks.aspx.cs" Inherits="Admin_EBAd_StarRating_YourAdminBooks" %>
                 ...
                 <table cellpadding="0" cellspacing="0" width="100%" class="tblSubHeader">
                  <tr>
                        ...
                        <td width="60%" align="left" class="subHeaderFontGrad">
                            &nbsp; Star Rating Admin Books - Your Admin Books</td>
      ...
      <asp:TemplateField HeaderText="Sno">
       ...
       <asp:TemplateField HeaderText="Book Title">        
        ...
        <asp:TemplateField HeaderText="Date Created">        
            <ItemTemplate>
                <asp:Label ID="lblDate" runat="server" Text='<% # Bind("DateCreated")%>'></asp:Label>
            </ItemTemplate>            
            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
        </asp:TemplateField>
