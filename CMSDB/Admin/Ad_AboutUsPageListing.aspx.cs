...
public partial class Admin_AboutUsPageListing : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ltrAboutUsListing.Text = Resources.LangResources.AboutUs + " " + Resources.LangResources.Listing;
        boolHasRows = GetBool();
    ...
    protected void Page_PreRender(object sender, EventArgs e)
    {
        ...
        //        int ColIdx = CommonFunctions.GetGridViewColIndex_HeaderText("Priority", gridAboutUsPage);
        //        gridAboutUsPage.Columns[ColIdx].Visible = false;
        //    }
        //}
    }
            ...
            if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    gridAboutUsPage.DataSource = dv;
                    gridAboutUsPage.DataBind();
                    boolHasRows = true;
                }
                else
                {
                    ...
                    gridAboutUsPage.DataSource = ds;
                    gridAboutUsPage.DataBind();

                    int ColCount = gridAboutUsPage.Rows[0].Cells.Count;
                    gridAboutUsPage.Rows[0].Cells.Clear();
                    gridAboutUsPage.Rows[0].Cells.Add(new TableCell());
                    gridAboutUsPage.Rows[0].Cells[0].ColumnSpan = ColCount;
                    gridAboutUsPage.Rows[0].Cells[0].Text = "No records Found";
                    gridAboutUsPage.Rows[0].Cells[0].HorizontalAlign = HorizontalAlign.Left;
    ...
    protected void gridAboutUsPage_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        gridAboutUsPage.PageIndex = e.NewPageIndex;
        PopulateGrid(ViewState["SortExpr"].ToString(), ViewState["sortOrder"].ToString());
    }
    ...
    protected void PageNumberDropDownList_OnSelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            if (gridAboutUsPage.Rows.Count > 0)
            {
                if (pageNumberDropDownList.SelectedIndex < gridAboutUsPage.PageCount ||
                  pageNumberDropDownList.SelectedIndex >= 0)
                {
                    gridAboutUsPage.PageIndex = pageNumberDropDownList.SelectedIndex;
                    PopulateGrid(ViewState["SortExpr"].ToString(), ViewState["sortOrder"].ToString());
                }
            }
        }
    ...
    protected void gridAboutUsPage_RowCancelingEdit(object sender, GridViewCancelEditEventArgs e)
    {
        gridAboutUsPage.EditIndex = -1;
        PopulateGrid(ViewState["SortExpr"].ToString(), ViewState["sortOrder"].ToString());
    }

    protected void gridAboutUsPage_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        //Get the reference to the gridview row
        GridViewRow gvRow = (GridViewRow)gridAboutUsPage.Rows[e.RowIndex];
    ...
    protected void gridAboutUsPage_RowEditing(object sender, GridViewEditEventArgs e)
    {
        gridAboutUsPage.EditIndex = e.NewEditIndex;
        PopulateGrid(ViewState["SortExpr"].ToString(), ViewState["sortOrder"].ToString());
    }


    protected void gridAboutUsPage_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {

        //Get the reference to the gridview row
        GridViewRow gRow = (GridViewRow)gridAboutUsPage.Rows[e.RowIndex];
    ...
    protected void gridAboutUsPage_Sorting(object sender, GridViewSortEventArgs e)
    {
    ...
    protected void gridAboutUsPage_DataBound(object sender, EventArgs e)
    {
        CommonFunctions.InitialiseGridViewPagerRowWithImages(gridAboutUsPage.BottomPagerRow, gridAboutUsPage);
    }


    protected void gridAboutUsPage_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        else if (e.Row.RowType == DataControlRowType.DataRow)
        {
          ...
          //  if(boolHasRows){
            ...
            //        gridAboutUsPage.Columns[7].Visible = false;
    ...
    //    foreach (GridViewRow gvRow in gridAboutUsPage.Rows)
    //    {
    ...
    //                strEventIDs = Convert.ToString(gridAboutUsPage.DataKeys[gvRow.RowIndex].Value);
    //            else
    //                strEventIDs = strEventIDs + "," + Convert.ToString(gridAboutUsPage.DataKeys[gvRow.RowIndex].Value);
    //        }
