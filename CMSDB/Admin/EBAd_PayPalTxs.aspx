<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EBAd_PayPalTxs.aspx.cs" Inherits="EBAd_PayPalTxs" %>
                ...
                <table cellpadding="0" cellspacing="3" class="stdtableBorder_Main" width="100%">
                    <tr style="height:30px;">
                        ...
                        <td width="98%" align="left">
                            &nbsp;<span __designer:mapid="5a" class="auto-style1"><strong __designer:mapid="5b">Note: </strong><span __designer:mapid="59" style="font-size: 11.0pt; line-height: 107%; font-family: &quot;Calibri&quot;,&quot;sans-serif&quot;; mso-ascii-theme-font: minor-latin; mso-fareast-font-family: Calibri; mso-fareast-theme-font: minor-latin; mso-hansi-theme-font: minor-latin; mso-bidi-font-family: &quot;Times New Roman&quot;; mso-bidi-theme-font: minor-bidi; mso-ansi-language: EN-US; mso-fareast-language: EN-US; mso-bidi-language: AR-SA"><strong __designer:mapid="5c">Please download the Ebook . Download URL valid for 15 days only.</strong></span></span> 
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:GridView ID="gridPayPalTx" runat="server" AutoGenerateColumns="False" DataKeyNames="TACuid"
                            ...
                            <asp:TemplateField HeaderText="Sl No">
                              <ItemTemplate>
                               <asp:Label ID="lblSlNo" runat="server" Text='<%# Container.DataItemIndex + 1  %>'/>
                                  <asp:HiddenField ID="hidBookId" Value='<%#Bind("itemNumber")%>' runat="server" />
                              ...
                              <asp:TemplateField HeaderText="eBook" SortExpression="itemNumber" >
                              <ItemTemplate>
                                  <asp:Literal ID="LtrBookID" runat="server" Text='<%# Bind("itemNumber")  %>'></asp:Literal>
                                  <br />
                                   <asp:Label ID="lblBookName" CssClass="fontBlue12" runat="server" Text='<%# Bind("ItemName")  %>'></asp:Label>
                                  <br /><br />
                                  <asp:Label ID="lblPurchaseDetails" CssClass="font_Content" runat="server" Text='Testing'/>
                              ...
                              <ItemTemplate>
                               <asp:Label ID="lblBuyerDetails" runat="server" Text=''/>
                                  ...
                                  <asp:Label ID="lblBuyerName" runat="server" Text='<%# Eval("UserName")  %>'/> <br />
                                  <asp:HyperLink ID="hypMobile" runat="server" NavigateUrl='<%# Eval("wurl")%>' Target="_blank" >
                                  <asp:Label ID="lblBuyerMobile" runat="server" Text='<%# Eval("MobileNo")  %>'/>
                                      </asp:HyperLink><br /><asp:Label ID="lblBuyerEmail" runat="server" Text='<%# Eval("BuyerEmail")  %>'/><br />
                              ...
                              <asp:TemplateField HeaderText="Purchase Date" SortExpression="TacCreated" >
                              <ItemTemplate>
                               <asp:Label ID="lblDateCreated" runat="server" Text='<%# Bind("TacCreated","{0:dd-MMM-yyyy hh:mm}")  %>'/><br /><br />
                               <asp:Label ID="lblPytStatus" CssClass="fontBlue12" runat="server" Text='<%# Bind("PytStatus")  %>'></asp:Label></ItemTemplate><ItemStyle HorizontalAlign="center"  />
                             </asp:TemplateField>

                            <asp:TemplateField HeaderText="Book Password/Download Link" >
                              <ItemTemplate>
                                   <asp:Label ID="lblBookPassword" CssClass="fontBlue12" runat="server" Text='<%# Bind("bookPassword")  %>'></asp:Label><br /><br /><asp:Label ID="lblDownload" CssClass="fontBlue12" runat="server" Text='<%# Bind("booklink")  %>'></asp:Label></ItemTemplate><ItemStyle HorizontalAlign="Left" CssClass="CellPaddingLeft"  />
                             </asp:TemplateField>

                                <asp:TemplateField HeaderText="Re-Send SMS/Email" HeaderStyle-HorizontalAlign="Center">    
                                <ItemTemplate>
                                    <asp:LinkButton ID="LinkSendSMS" runat="server" CssClass="links_FuncLinks" Visible="false" Text="Re-Send SMS" CommandArgument='<%# Eval("itemNumber")%>' OnCommand="OnCommand_ImageSendSMSNew" ToolTip='<%# "Send SMS to : " + Eval("MobileNo")%>' />
                                    <br /><br />
                                <asp:TextBox ID="txtBuyerEmail" runat="server" Text='<%# Eval("BuyerEmail")  %>' Visible="false"/><br />
                                <asp:LinkButton ID="LinkSendEmail" runat="server" CssClass="links_FuncLinks" Visible="false" Text="Re-Send Email" CommandArgument='<%# Eval("itemNumber") %>' OnCommand="OnCommand_ImageSendEmailNew" ToolTip='<%# "Send Email to : " + Eval("BuyerEmail")%>' />
                                </ItemTemplate>
