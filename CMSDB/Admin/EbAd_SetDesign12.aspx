<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EbAd_SetDesign12.aspx.cs" Inherits="Admin_EbAd_SetDesign12" %> 
            ...
            <td>
                <table cellpadding="0" cellspacing="0" class="stdtable_BdrBlue_BkgGrey" width="100%">
                  ...
                  <%--  <tr>
                    ...
                    <td>&nbsp;</td>
                        <td align="left">
                               <asp:RadioButton ID="rdoWebTemplate1_Black" Text="Template Design1 Black" 
                                   runat="server" GroupName="GrpTemplate" />
                            <br />
                            <img alt="webtmp2" src="../Images/ebImages/Design12_Black.jpg" 
                                style="width: 200px; height: 196px" />
                                </td>
                        <td>
                             <asp:RadioButton ID="rdoWebTemplate1_Blue" Text="Template Design1 Blue" 
                                 runat="server" GroupName="GrpTemplate" />
                            <br />
                            <img alt="webtmp2" src="../Images/ebImages/Design12_Blue.jpg" 
                                style="width: 200px; height: 196px" />
                                </td>
                        <td>
                            <asp:RadioButton ID="rdoWebTemplate1_Green" Text="Template Design1 Green" 
                                runat="server" GroupName="GrpTemplate" />
                            <br />
                            <img alt="webtmp2" src="../Images/ebImages/Design12_Green.jpg" 
                                style="width: 200px; height: 196px" />
                                
                                </td>
                        <td>
                              <asp:RadioButton ID="rdoWebTemplate1_Orange" Text="Template Design1 Orange" 
                                  runat="server" GroupName="GrpTemplate" />
                            <br />
                            <img alt="webtmp2" src="../Images/ebImages/Design12_Orange.jpg" 
                                style="width: 200px; height: 196px" />
                            
                            </td>
                        <td>
                                             <asp:RadioButton ID="rdoWebTemplate1_Red" Text="Template Design1 red" 
                                                 runat="server" GroupName="GrpTemplate" />
                            <br />
                            <img alt="webtmp2" src="../Images/ebImages/Design12_Red.jpg" 
                                style="width: 200px; height: 196px" />
                                </td>
                        <td>
                            &nbsp;</td>
