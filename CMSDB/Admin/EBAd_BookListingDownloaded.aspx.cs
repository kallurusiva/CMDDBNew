...
public partial class Admin_EBAd_BookListingDownloaded : System.Web.UI.Page
{
    ...
    protected void PopulateGrid(string vSortExpr, string vSortDir, string vSearchQuery)
    {
        ...
        ds = ndbs.Ebook_ListingDownloaded(Convert.ToInt32(Session["UserID"]), 0, Convert.ToInt32(strPageNo), vSearchQuery);
