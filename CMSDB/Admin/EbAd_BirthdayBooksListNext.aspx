<%@ Page Language="C#"  MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EbAd_BirthdayBooksListNext.aspx.cs" Inherits="Admin_EbAd_BirthdayBooksListNext" %>
...
<ContentTemplate>--%>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="98%">
                 ...
                 <table cellpadding="0" cellspacing="0" width="100%" class="tblSubHeader">
                  <tr>
                        ...
                        <td width="60%" align="left" class="subHeaderFontGrad">
                            &nbsp; Birthday List - Next 50 Birthdays</td>
        ...
        <asp:TemplateField HeaderText="Author Name" >        
            <ItemTemplate>
                <asp:Label ID="lblAuthorMobile" runat="server" Text='<% # Bind("AuthorMobile")%>' Visible="false"></asp:Label>
                <asp:Label ID="lblAuthorName" runat="server" Text='<% # Bind("AuthorName")%>'></asp:Label> <br />
                <asp:Label ID="lblBDate" runat="server" Text='<% # Bind("bDate")%>'></asp:Label>
            </ItemTemplate>            
            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
        </asp:TemplateField>

        <asp:TemplateField HeaderText="Book Details" SortExpression="">        
            <ItemTemplate>
                <asp:Label ID="lblBookIDs" runat="server" Text=""></asp:Label>
            </ItemTemplate>            
            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
        </asp:TemplateField>
