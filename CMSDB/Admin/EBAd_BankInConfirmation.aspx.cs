...
public partial class EBAd_BankInConfirmation : System.Web.UI.Page 
{
      ...
      protected void LoadPurchasetems(int vUserId, String vTranID, String vPurcItems)
    {
        ...
        {                     
            DataRow dRowstoreid = dsBooks.Tables[1].Rows[0]; 
            eStoreid = dRowstoreid["estoreid"].ToString();
        }
      ...
      protected void BtnUpdate_Click(object sender, EventArgs e)
      {
          ...
          int vStatus = objBALebook.Bank_Transaction_Update(vUserID, vTranID, vRemarks);

          CommonFunctions.AlertMessageAndRedirect("Remarks for Transaction Updated", "Ebad_BankInByList.aspx"); 
      }
      ...
      protected void BtnSendEmail_Click(object sender, EventArgs e)
      {
          ...
          int vUserID2 = Convert.ToInt32(Session["UserID"]);
...
//          }
          ...
          int vStatus = ndbs1.Bank_Transaction_Update(vUserID1, vTranID1, vRemarks);
          CommonFunctions.AlertMessageAndRedirect("EBOOKS Send by Email Successfully", "Ebad_BankInByList.aspx"); 

      }
      protected void BtnCancel_Click(object sender, EventArgs e)
      {
          Response.Redirect("EbAd_BankInByList.aspx"); 
      }
}
