<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EBAd_NewReleases.aspx.cs" Inherits="EBAd_NewReleases" %>
                            ...
                            <asp:TemplateField HeaderText="Sl No">
                              <ItemTemplate>
                               <asp:Label ID="lblSlNo" runat="server" Text='<%# Container.DataItemIndex + 1  %>'/>
                                  ...
                                  <asp:HiddenField ID="hdNewReleaseUID" Value='<%#Bind("NewReleaseUID")%>' runat="server" />
