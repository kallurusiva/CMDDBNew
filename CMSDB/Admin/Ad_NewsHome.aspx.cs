...
public partial class Admin_Ad_NewsHome : BasePage
{
    ...
    string tblName = "tblNews";
    string tblColumn = "NewsID";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        // Language rendering 
        ltrHeader.Text = Resources.LangResources.News + " " + Resources.LangResources.Summary;

        
        //PageType.Text = Resources.LangResources.Testimonial;
        string PageTypeText = Resources.LangResources.News;
    ...
    //                int SysEnCount = Convert.ToInt32(dbReader["sa_En_count"].ToString());
    //                int SysMyCont =  Convert.ToInt32(dbReader["sa_My_count"].ToString());
    ...
    //                //{
    //                //    rdoAppearanceStatus.Items[1].Selected = true;   // show admin Items 
    //                //}
    //                int TotEnCount = SysEnCount + UsrEnCount;
    //                int TotMycount = SysMyCont + UsrMyCont;


    //                if ((TotEnCount == WebEncount) && (TotMycount == WebMycount))
    ...
    //                else
    //                {
    //                    rdoAppearanceStatus.Items[1].Selected = true; // do no show Admin Items 
    //                }
        ...
        try
        {
            ...
            if (rowCount >= 0)
            {
               ...
               //CommonFunctions.AlertMessageAndRedirect("Status Changed", "Ad_FaqHome.aspx");
                ...
                Response.Redirect("Ad_NewsHome.aspx");
