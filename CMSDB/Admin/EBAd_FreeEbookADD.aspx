<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EBAd_FreeEbookADD.aspx.cs" Inherits="EBAd_FreeEbookADD" %>
                    ...
                    <%--<tr>
                     ...
                     <tr>
                        ...
                        <td class="tblFormText1" align="left">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtBookID" ErrorMessage=" Please enter eBook Code" ValidationGroup="VgCheck"></asp:RequiredFieldValidator>
