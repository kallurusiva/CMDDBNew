<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SideMenu_News.ascx.cs" Inherits="Admin_AdminSideMenu" %>
                  ...
                  <tr>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <asp:Image ID="Image2" ImageUrl="~/Images/tb_menuitem.jpg" runat="server" />
                                <asp:HyperLink ID="HyperLink3" CssClass="Links_TopBarMenu" runat="server" NavigateUrl="NewsCreate.aspx">
                                <asp:Literal ID="LtrAddNews" runat="server" Text="Add News Item"></asp:Literal>&nbsp;   
                                </asp:HyperLink>
                            ...
                            <td  width="150px">
                             ...
                             <asp:HyperLink ID="HyperLink1" CssClass="Links_TopBarMenu" runat="server" NavigateUrl="NewsListing.aspx?RtType=USER">
                              <asp:Literal ID="LtrMyNews" runat="server" Text="My News items"></asp:Literal>&nbsp;
                             </asp:HyperLink>
                            ...
                            <td  width="150px">
                             ...
                             <asp:HyperLink ID="HyperLink4" CssClass="Links_TopBarMenu" runat="server" NavigateUrl="NewsListing.aspx?RtType=ADMIN">
                            ...
                            <td  width="150px">
                             ...
                             <asp:HyperLink ID="HyperLink2" CssClass="Links_TopBarMenu" runat="server" NavigateUrl="NewsListing.aspx?RtType=ALL">
