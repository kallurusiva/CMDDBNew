...
public partial class Admin_PremiumSMSReport_SummaryNew : System.Web.UI.Page
{
    DataSet ds;
    DataView dv;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            lblIncentiveC.Text = "USD " + utRow["pIncentiveC"].ToString();
            lblIncentiveSC.Text = "USD " + utRow["pIncentiveSC"].ToString();
            lblIncentiveAC.Text = "USD " + utRow["pIncentiveAC"].ToString();
            lblIncentiveIC.Text = "USD " + utRow["pIncentiveIC"].ToString();
            lblTotal.Text = "USD " + utRow["pIncentiveTC"].ToString();
        }
    }
}