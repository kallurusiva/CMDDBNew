<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EbAd_SetDesign2.aspx.cs" Inherits="Admin_EbAd_SetDesign2" %>
           ...
           <table cellpadding="0" cellspacing="3" id="tblPlan" class="stdtableBorder_Main" width="100%" runat="server">
            ...
            <td>
                <table cellpadding="0" cellspacing="0" class="stdtable_BdrBlue_BkgGrey" width="100%">
                    ...
                    <td>&nbsp;</td>
                        <td align="left">
                               <asp:RadioButton ID="rdoEbD2template_Navy" Text="WebDesign2 Navy" 
                                   runat="server" ValidationGroup="VgCheck" GroupName="GrpTemplate" />
                            <br />
                            <img alt="webtmp2" src="../Images/ebImages/Desgin2_Navy.jpg" 
                                style="width: 200px; height: 160px" />
                                </td>
                        <td>
                             <asp:RadioButton ID="rdoEbD2template_Magenta" Text="WebDesign2 Magenta" 
                                 runat="server" ValidationGroup="VgCheck" GroupName="GrpTemplate" />
                            <br />
                            <img alt="webtmp2" src="../Images/ebImages/Desgin2_Magenta.jpg" 
                                style="width: 200px; height: 160px" />
                                </td>
                        <td>
                            <asp:RadioButton ID="rdoEbD2template_darkCyan" Text="WebDesign2 Cyan" 
                                runat="server" ValidationGroup="VgCheck" GroupName="GrpTemplate" />
                            <br />
                            <img alt="webtmp2" src="../Images/ebImages/Desgin2_Cyan.jpg" 
                                style="width: 200px; height: 160px" />
                                
                                </td>
                        <td>
                              <asp:RadioButton ID="rdoEbD2template_Gold" ValidationGroup="VgCheck" Text="WebDesign2  Gold" 
                                  runat="server" GroupName="GrpTemplate" />
                            <br />
                            <img alt="webtmp2" src="../Images/ebImages/Desgin2_Gold.jpg" 
                                style="width: 200px; height: 160px" />
                            
                            </td>
                        <td>
                                             <asp:RadioButton ID="rdoEbD2template_tomato" ValidationGroup="VgCheck" Text="WebDesign2 tomato" 
                                                 runat="server" GroupName="GrpTemplate" />
                            <br />
                            <img alt="webtmp2" src="../Images/ebImages/Desgin2_tomato.jpg" 
                                style="width: 200px; height: 160px" />
                                </td>
                        <td>
                            &nbsp;</td>
