...
public partial class EBAd_FreeEbooks : System.Web.UI.Page 
{
    ...
    protected void PopulateGrid(string vSortExpr, string vSortDir)
    {
        ...
        //ds = objEbook.Ebook_Listing(Convert.ToInt32(Session["UserID"]), " AND isFreeEbook = 1"); 

        ds = objEbook.Ebook_FreeEbook_LIST(Convert.ToInt32(Session["UserID"]), ""); 
        ...
        else if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            else
            {
              ...
              //  HyperLink objHypEditByUser = (HyperLink)e.Row.FindControl("HyLinkEditByUser");
                ...
                //objHypEditByUser.NavigateUrl = "EBAd_FreeEbookEdit.aspx?qBID=" + objBookUID.Value; 
                ...
                //HyLinkEdit.NavigateUrl = "EBAd_FreeEbookEdit.aspx?qBID=" + Server.UrlEncode(CommonFunctions.Encrypt(objBookID.Value)); 
                //HyLinkEdit.Visible = true;
