...
public partial class Admin_ProfitSharingCountryMonthwise : System.Web.UI.Page
{
    DataView dv;
    DataSet ds;
    //DataView DL;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            //lblMainTitle.Text = "Premium ProfitShare" + " :  Monthly Telco Report";
            //lblNotice.Text = "";
    ...
    protected void Populate_GridView1(String vSearchSql, String vSortExpr, String vSortDir)
    {
        ...
        ds = objPS.profitShare_TelcoWise(ViewState["UID"].ToString());
