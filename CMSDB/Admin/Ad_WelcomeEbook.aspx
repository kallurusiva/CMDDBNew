<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="Ad_WelcomeEbook.aspx.cs" Inherits="Ad_WelcomeEbook" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentBody" Runat="Server">
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="98%">
           ...
           <%-- <tr>
            ...
            <tr>
                    ...
                    <tr>
                       ...
                       <div id="dvProfile" style="overflow:hidden; min-width:240px;">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="80%" class="loginBkg">
                    ...
                    <tr style="vertical-align:baseline;">
                    <td align="center" >
                             <asp:Image ID="ImgContact" BorderWidth="1px" BorderColor="#ACA9A9" Width="132px" Height="165px" runat="server" /> 
                         </td>
                    </tr>
        ...
        <br />
          <%-- WebSite StatisTics Links --%>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="75%" class="loginBkg">
                    <tr>
                    ...
                    <td  align="center" colspan="3">
                        ...
                        <td>
                            ...
                            <asp:Chart ID="Chart1" runat="server" BackColor="WhiteSmoke" Palette="BrightPastel" ImageType="Png" BorderlineDashStyle="Solid" BackSecondaryColor="White" BackGradientStyle="TopBottom" BorderWidth="2" BorderColor="26, 59, 105" Width="398px">
                               <titles>
