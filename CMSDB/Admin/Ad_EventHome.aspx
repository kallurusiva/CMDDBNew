<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="Ad_EventHome.aspx.cs" Inherits="Admin_Ad_EventHome" %>

<%@ Register src="../SuperAdmin/SelectLanguage.ascx" tagname="SelectLanguage" tagprefix="uc2" %>

<%@ Register src="SideMenu_Events.ascx" tagname="SideMenu_Events" tagprefix="uc3" %>

<%@ Register src="LeftMenu_Events.ascx" tagname="LeftMenu_Events" tagprefix="uc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentLeftMenu" Runat="Server">
    <uc1:LeftMenu_Events ID="LeftMenu_Events1" runat="server" />
</asp:Content>
                            ...
                            <table cellpadding="0" cellspacing="0" class="tblForm" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td class="tblFormText">
                                        <asp:RadioButtonList ID="rdoAppearanceStatus" runat="server">
                    ...
                    <tr>
                        ...
                        <td>
                         <table cellpadding="0" cellspacing="0" class="tblForm" width="100%">
                                ...
                                <tr>
                                    <td class="tblFormLabel">&nbsp; EVENTS </td>
