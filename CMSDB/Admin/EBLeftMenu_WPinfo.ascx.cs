...
public partial class EBLeftMenu_WPinfo : System.Web.UI.UserControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            foreach (DataRow dr in t1.Rows)
            {
                ...
                String strHref1 = "EBAd_WpInfo.aspx?qInfoId=" + dr["UID"].ToString();
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            foreach (DataRow dr in t1.Rows)
            {
                ...
                menuItem1.Controls.Add(new LiteralControl("<li><a href='" + strHref1 + "'><asp:Label ID='" + strLbl + "' runat='server'>" + dr["Title"].ToString() + "</asp:Label></a></li>"));
