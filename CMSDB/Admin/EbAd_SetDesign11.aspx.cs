...
public partial class Admin_EbAd_SetDesign11 : BasePage
{
    ...
    protected void LoadTemplateInfo()
    {
        ...
        DataSet ds =  nds.WebDesign11_GetSettings(Convert.ToInt32(Session["UserID"].ToString()));
    ...
    protected void BtnSave_Click(object sender, EventArgs e)
    {
        ...
        newDBS nds = new newDBS();
        int upStatus = nds.WebDesign11_UpdateSettings(mCssvalue, Convert.ToInt32(Session["UserID"].ToString()), ImgFileName1.ToString(), ImgFileName2.ToString(), ImgFileName3.ToString(), ImgFileName4.ToString(), ImgFileName5.ToString(), "", "", "", "", "");
