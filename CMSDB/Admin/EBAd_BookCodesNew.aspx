<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/AdminMaster_DIY.master" CodeFile="EBAd_BookCodesNew.aspx.cs" Inherits="Admin_EBAd_BookCodesNew" %>
...
<ContentTemplate>--%>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="98%">
      ...
      <%--<asp:TemplateField HeaderText="Country" SortExpression="TDate">        
        ...
        <asp:TemplateField HeaderText="FullName" SortExpression="TDate">        
            <ItemTemplate>
       ...
       <%-- <asp:TemplateField HeaderText="Email" SortExpression="TDate">        
            <ItemTemplate>
