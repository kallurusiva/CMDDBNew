<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="Ad_ModifySubDomain.aspx.cs" Inherits="Admin_Ad_ModifySubDomain" %>

<%@ Register src="EBLeftMenu_SubDomainSTEPS.ascx" tagname="EBLeftMenu_RegSTEPS" tagprefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentLeftMenu" Runat="Server">
    ...
    <uc1:EBLeftMenu_RegSTEPS ID="EBLeftMenu_RegSTEPS1" runat="server" />
    </asp:Content>
                        ...
                        <td align="left">
                            ...
                            <table cellpadding="0" cellspacing="2" style="width: 100%;" class="stdtableBorder_Only">
                               ...
                               <table border="0" cellpadding="0" cellspacing="2" width="100%">
                                   <tr height="0px">
                                    <td width="20%">
                                        Your Current SubDomain</td>
                                    <td width="2%">
                                        &nbsp;</td>
                                    <td width="50%" class="FontNote">
                                       
                                        <asp:Label ID="lblDomainName" runat="server" CssClass="font_14SuccessBold"></asp:Label>
                                        &nbsp;&nbsp;&nbsp;
                                ...
                                <tr>
                                    <td>
                                        <asp:Label runat="server" ID="lblentersubdomain" Text="Enter SubDomain"> </asp:Label></td>
                                    <td>
                                        <asp:Label runat="server" ID="lblColon" Text=":"> </asp:Label></td>
                                    <td valign="top">
                                ...
                                <tr>
                                    ...
                                    <td>
                                            ...
                                            <div id="progress" runat="server" visible="true">
                                                ...
                                                Please wait...while the system checks for subdomain name availability
                                             </div>
                                            </ProgressTemplate>
                                ...
                                <tr>
                                    ...
                                    <td class="font_12Msg_Error">
                                       ...
                                       <b><asp:Label runat="server" ID="lblNote" Text="NOTE"> </asp:Label></b><asp:Label runat="server" ID="lblColon1" Text="NOTE"> </asp:Label></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="font_11Msg_Error">
                                        <asp:Label runat="server" ID="lblNoteDisp" Text="1. Please make sure the entered subdomain name is available."> </asp:Label>
                                         </td>
                                </tr>
