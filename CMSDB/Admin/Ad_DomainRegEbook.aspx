<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="Ad_DomainRegEbook.aspx.cs" Inherits="Ad_DomainRegEbook" %>
                               ...
                               <%-- <tr>
                                ...
                                <tr id="trWEB10Section" runat="server">
                                    ...
                                    <td class="font_12Msg_Error">
                                        This is feature is available for Professional Vendors only. </td>
                                </tr>
                               ...
                               <table border="0" cellpadding="0" cellspacing="2" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <td>
                                        &nbsp;
                                        <%--<asp:Button ID="btnDomainCheckNow" runat="server" ValidationGroup="VgCheck" 
                                            CssClass="stdButtonNormal" onclick="btnDomainCheckNow_Click" Text="Check availabilty" />--%>

                                        <asp:Button ID="btnDomainChk" runat="server" ValidationGroup="VgCheck" 
                                            CssClass="stdButtonNormal" Text="Check availabilty" OnClick="btnDomainChk_Click" />
                                    </td>
