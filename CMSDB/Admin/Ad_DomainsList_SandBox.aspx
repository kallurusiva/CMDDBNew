<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="Ad_DomainsList_SandBox.aspx.cs" Inherits="Ad_DomainsList_SandBox" %>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:Button ID="btnRegister" runat="server" CssClass="stdbuttonAction" 
                                            onclick="btnRegister_Click" Text="Register Domain" Visible="true" />
                                    </td>
                                </tr>
                                   <tr>
                                       <td>
