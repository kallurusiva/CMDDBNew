...
public partial class Admin_PrepaidCardSendSMSList : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ViewState["PageURL"] = "PrepaidCardSendSMSList.aspx";       
        ...
        if (!IsPostBack)
        {
            ...
            {
                iTotalCount = Convert.ToInt32(ds.Tables[4].Rows.Count);
                ViewState["iTotalCount"] = ds.Tables[4].Rows.Count;
            }
    ...
    protected void Confirm_MessageInfo()
    {
        if (Page.IsValid)
        {
            ...
            iTotalCount = Convert.ToInt32(ViewState["iTotalCount"].ToString());
