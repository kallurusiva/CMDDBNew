...
public partial class EBAd_BestSellerADD2 : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (isNum)
        {
            ...
            int inStatus = objDBS.Ebook_BestSeller_ADDNew(tmpBookUID, tmpBookID, tmpUserID, tmpShowatHP, vposition);
            ...
            if (inStatus == 1)
            {
                ...
                lblErrMessage.Text = "Ebook Marked as BestSeller Sucessfully";
                lblErrMessage.CssClass = "font_12Msg_Success";
                MessageImage.Src = "~/Images/inf_Sucess.gif";

                ; Response.Redirect("EBAd_BestSeller.aspx");

            }
            else if (inStatus == 2)
            {
                //CommonFunctions.AlertMessage("Ebook Already Exists as a BestSeller. Please enter another BookID", "EBAd_BestSeller.aspx"); 
                CommonFunctions.AlertMessage("Ebook Already Exists as a BestSeller. Please enter another BookID");

                lblErrMessage.Text = "Ebook Already Exists as a BestSeller. Please enter another BookID.";
