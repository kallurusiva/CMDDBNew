<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EbAd_EISBNupdateHistory.aspx.cs" Inherits="Admin_EbAd_EISBNupdateHistory" %>
...
<ContentTemplate>--%>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="98%">
                 ...
                 <table cellpadding="0" cellspacing="0" width="100%" class="tblSubHeader">
                  <tr>
                        ...
                        <td width="60%" align="left" class="subHeaderFontGrad">
                            &nbsp; EBooks: - EISBN Update History</td>
        ...
        <asp:TemplateField HeaderText="TransactionID" SortExpression="UID">        
            <ItemTemplate>
                <asp:Label ID="lblTanid" runat="server" Text='<% # Bind("UID")%>'></asp:Label>
            </ItemTemplate>            
            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
        </asp:TemplateField>

        <asp:TemplateField HeaderText="Cert Image Code" SortExpression="BookCode">        
            <ItemTemplate>
        ...
        <asp:TemplateField HeaderText="Book Code" SortExpression="BookCode">        
            <ItemTemplate>
                <asp:Label ID="lblBookID" runat="server" Text='<% # Bind("BookCode")%>'></asp:Label>
            </ItemTemplate>            
            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
        </asp:TemplateField>
        ...
        <asp:TemplateField HeaderText="EISBN Code" SortExpression="EISBNCode">        
            <ItemTemplate>
                <asp:Label ID="lblBookDescription" runat="server" Text='<% # Bind("EISBNCode")%>'></asp:Label>
            </ItemTemplate>            
            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
        </asp:TemplateField>
        ...
        <asp:TemplateField HeaderText="your Remarks" SortExpression="pRemarks">        
            <ItemTemplate>
                <asp:Label ID="lblPRemarks" runat="server" Text='<% # Bind("pRemarks")%>'></asp:Label>
            </ItemTemplate>            
            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
        </asp:TemplateField>

        <asp:TemplateField HeaderText="Admin Remarks" SortExpression="aRemarks">        
            <ItemTemplate>
                <asp:Label ID="lblaRemarks" runat="server" Text='<% # Bind("aRemarks")%>'></asp:Label>
            </ItemTemplate>            
            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
        </asp:TemplateField>
