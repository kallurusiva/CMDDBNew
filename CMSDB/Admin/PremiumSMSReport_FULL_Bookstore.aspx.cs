...
public partial class Admin_PremiumSMSReport_FULL_Bookstore : System.Web.UI.Page
{
    ...
    protected void PopulateGrid(string vSortExpr, string vSortDir)
    {
        ...
        ds = objPS.PremiumSMS_ReportFULL_Bookstore(ViewState["mobileValPS"].ToString(), 0);
