<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EBookPaymentReport_Introducer.aspx.cs" Inherits="Admin_EBookPaymentReport_Introducer" %>
...
<ContentTemplate>--%>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="98%">
                 ...
                 <table cellpadding="0" cellspacing="0" width="100%" class="tblSubHeader">
                  <tr>
                        ...
                        <td width="60%" align="left" class="subHeaderFontGrad">
                            &nbsp; EBooks: Purchases - Credit Card Payment - Introducer Share</td>
      ...
      <asp:TemplateField HeaderText="Country" SortExpression="TDate">        
        ...
        <asp:TemplateField HeaderText="Partner Name MobileNo" SortExpression="TDate">        
            <ItemTemplate>
                <asp:Label ID="lblName" runat="server" Text='<% # Bind("member_name")%>'></asp:Label><br />
                <asp:Label ID="lblLogin" runat="server" Text='<% # Bind("login_id")%>'></asp:Label>
            </ItemTemplate>            
            <ItemStyle Width="25px" HorizontalAlign="Left" VerticalAlign="Top" />
        </asp:TemplateField>
        ...
        <asp:TemplateField HeaderText="Mobile" SortExpression="TDate">        
            <ItemTemplate>
                <asp:Label ID="lblMobile" runat="server" Text='<% # Bind("Mobilex")%>'></asp:Label>
            </ItemTemplate>            
            <ItemStyle Width="25px" HorizontalAlign="Left" VerticalAlign="Top" />
        </asp:TemplateField>
        ...
        <%--<asp:TemplateField HeaderText="After Telco" SortExpression="TDate">        
            <ItemTemplate>
        ...
        <asp:TemplateField HeaderText="Your Share USD">    
            <ItemTemplate>
                <asp:Label ID="lblFinalShare" runat="server" ForeColor="Blue" Text='<% # Bind("sponsorshare")%>' />
            </ItemTemplate>
