...
public partial class Ad_WelcomeEbook : BasePage
{
...
//    SqlDataReader dbReader;
 //   DataSet ds;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //if ((Request.QueryString["rPage"] == null) || (Request.QueryString["rPage"].ToString() == ""))
        //{            
        //}
        //else
        //{
        //    if (Request.QueryString["rPage"].ToString() == "1")
        //    {
        //        Response.Redirect("~/Admin/EBAd_birthdaybookslist.aspx");
        //    }
        //    if (Request.QueryString["rPage"].ToString() == "2")
        //    {
        //        Response.Redirect("~/Admin/EBAd_BookListingAdminNew.aspx");
        //    }
        //}
...
//       int i = 0;
    ...
    protected void LoadWelcomePageDetails()
    {
        ...
        //{
        //    DataRow nRow = ds.Tables[0].Rows[0];

        //    String tmpNewsTitle = nRow["Title"].ToString();
        //    lblNews.Text = tmpNewsTitle;

        //    String tmphdnUID = nRow["uid"].ToString(); 
        //    HypReadMore.NavigateUrl = "javascript:OpenWindow('" + tmphdnUID + "')";
