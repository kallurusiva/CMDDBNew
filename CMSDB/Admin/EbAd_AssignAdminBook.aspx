<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EbAd_AssignAdminBook.aspx.cs" Inherits="Admin_EbAd_AssignAdminBook" %>
                 ...
                 <table cellpadding="0" cellspacing="0" width="100%" class="tblSubHeader">
                  <tr>
                        ...
                        <td width="90%" align="left" class="subHeaderFontGrad">
                            &nbsp; Assign Admin Books for your Category&nbsp; </td>
                        ...
                        <td class="tblFormText1" align="left">
                            <asp:DropDownList ID="ddlCategory" CssClass="stdDropDown2" runat="server" ValidationGroup="VgCheck" TabIndex="6">
                              ...
                              &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                            ...
                                            ValidationGroup="VgCheck"></asp:RequiredFieldValidator></td>
                        <td class="tblFormText1" align="left">
                            &nbsp;</td>
                        <td>
                            &nbsp;</td>
