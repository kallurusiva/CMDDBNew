...
public partial class Admin_Ad_EmailList : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        LtrEmailList.Text = Resources.LangResources.Create + " Email";
        LtrValidEmailALert.Text = "Only Alphanumerica Characters [Aa-Zz 0-9] and Underscore '_' are allowed."
                                    + "<br/>Once created the Email address would be permanent and cannot be changed";

        LtrEmailNoteId.Text = "<b>NOTE: </b> Email will be created within 72 hours of working day (Monday-Friday except public holiday)";
        #endregion

        ltrDomainName1.Text = ".DomainName.com";
        ltrDomainName2.Text = ".DomainName.com";
        ltrDomainName3.Text = ".DomainName.com";
