<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EBAd_BankIn_UserList.aspx.cs" Inherits="EBAd_BankIn_UserList" %>
                            ...
                            <asp:GridView ID="GridBanks" runat="server" AutoGenerateColumns="False"
                             CssClass ="mGrid" HeaderStyle-CssClass="rowheader" AlternatingRowStyle-CssClass="rowalt" 
                              AllowPaging="true" PageSize="10" onpageindexchanging="GridBanks_PageIndexChanging"
                               AllowSorting="true"  
                               ondatabound="GridBanks_DataBound" onrowdatabound="GridBanks_RowDataBound"  OnSorting="GridBanks_Sorting" OnRowDeleting="GridBanks_RowDeleting" OnRowEditing="GridBanks_RowEditing" 
                             >
                            <Columns>
                              ...
                              <ItemStyle Width="50px" HorizontalAlign="Center"  />
                                 ...
                                 <asp:TemplateField HeaderText="Functions">
                                        <ItemTemplate>
                                             ...
                                             <asp:HyperLink ID="HyLinkEdit" runat="server">
                                              <asp:Image ID="ImgEdit1" ImageUrl="~/Images/imgEdit2.gif" runat="server" />                                  
                                          </asp:HyperLink>  

                                            <asp:ImageButton ID="ImgDelete" runat="server" CommandName="DELETE" ImageUrl="~/Images/imgDelete.gif" OnClientClick="return confirm('Please click OK to confirm deletion');" ToolTip="Delete Bank Details" />
                                        </ItemTemplate>
