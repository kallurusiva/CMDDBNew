...
public partial class Admin_EBAd_eStoreAdminCats : System.Web.UI.Page
{
    ...
    protected void RenderMainCategories(string SelCatID)
    {
        ...
        DataSet ds = objDBS.EBook_Get_MainCategories_New(vUserID, "","0");        
    }
    ...
    protected void Load_MainCategories()
    {
        vUserID = Convert.ToInt32(Session["UserID"].ToString());
        newDBS objDBS = new newDBS();
        DataSet dsMainCats = objDBS.EBook_Get_MainCategories_New(vUserID, "11","0");
