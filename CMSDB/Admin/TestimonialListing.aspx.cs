...
public partial class Admin_TestimonialListing : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ViewState["SortExpr"] = "LgType, UserID desc, Priority";
    ...
    protected void gridTestimonial_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        else if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            Literal objLtrCreatedBy = (Literal)e.Row.FindControl("LtrLoginID");

            if (objLtrCreatedBy != null)
            {
                if (objLtrCreatedBy.Text.ToUpper() == "SUPERADMIN")
                {
            ...
            if (ViewState["RtType"] != null)
            {
                ...
                else
                {
                    ...
                    HyLinkEdit.NavigateUrl = "TestimonialEdit.aspx?TstID=" + ltrTstID.Text;
