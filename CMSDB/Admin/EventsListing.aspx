<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EventsListing.aspx.cs" Inherits="Admin_EventsListing" %>
                 ...
                 <table cellpadding="0" cellspacing="0" width="98%" class="tblSubHeader">
                  <tr>
                        ...
                        <td width="60%" align="left" class="subHeaderFontGrad">
                            &nbsp;<asp:Literal ID="ltrEventsListing" Text="evet" runat="server"></asp:Literal>                            
                             </td>
                        <td width="30%"> 
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:TemplateField HeaderText="Event Title" >
                              ...
                              <ItemTemplate>
                               <asp:Label ID="lblEventDate" runat="server" Text='<%# Bind("EventDate","{0:dd-MMM-yyyy hh:mm tt}")  %>'/>
                              </ItemTemplate>
                              <EditItemTemplate>
                              ...
                              <ItemTemplate>
                               <asp:Label ID="lblEventDateTO" runat="server" Text='<%# Bind("EventDateTO","{0:dd-MMM-yyyy hh:mm tt}")  %>'/>
                              </ItemTemplate>
                             <EditItemTemplate>
