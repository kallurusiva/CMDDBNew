...
public partial class Admin_ProfitSharingRequestPayment : System.Web.UI.Page
{
    DataView dv;
    DataSet ds;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            //lblMainTitle.Text = "Premium ProfitShare" + " :  Request Payment";
            //lblNotice.Text = "";
    ...
    protected void Populate_GridView1(String vSearchSql, String vSortExpr, String vSortDir)
    {
        ...
        //ds = objUsr.RetrieveDebitPurchase_ALL(Session["Login_Id"].ToString(), vSearchSql, Convert.ToInt32(strPageNo));
        ds = objPS.RequestPayment_Display(mobileValPS);
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if ((e.Row.RowType == DataControlRowType.DataRow) && (tmpRowCount > 0))
        {
            ...
            //LinkButton LinkButtonR = ((LinkButton)e.Row.FindControl("LinkButtonR"));
            //HiddenField hdnEligibleStatus = ((HiddenField)e.Row.FindControl("hdnEligibleStatus"));
            //if (hdnEligibleStatus.ToString() == "1")
            //{
            //    LinkButtonR.Text = "View";
            //}
    ...
    protected void GridView1_RowCreated(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            HeaderCell = new TableCell();
            HeaderCell.Text = "Total Profit";
            //HeaderCell.RowSpan = 2;
            HeaderGridRow.Cells.Add(HeaderCell);

            HeaderCell = new TableCell();
            HeaderCell.Text = "Total paid/Request";
            //HeaderCell.RowSpan = 2;
            HeaderGridRow.Cells.Add(HeaderCell);

            HeaderCell = new TableCell();
            HeaderCell.Text = "Balance outstanding";
            //HeaderCell.RowSpan = 2;
            HeaderGridRow.Cells.Add(HeaderCell);

            HeaderCell = new TableCell();
            HeaderCell.Text = "Claimable Amount";
            //HeaderCell.RowSpan = 2;
            HeaderGridRow.Cells.Add(HeaderCell);

            HeaderCell = new TableCell();
            HeaderCell.Text = "Minimum Request Amount";
            //HeaderCell.RowSpan = 2;
            HeaderGridRow.Cells.Add(HeaderCell);

            HeaderCell = new TableCell();
            HeaderCell.Text = "Eligible Status";
            //HeaderCell.RowSpan = 2;
            HeaderGridRow.Cells.Add(HeaderCell);
    ...
    protected void Button_View(object sender, CommandEventArgs e)
    {
        ...
        Server.Transfer(@"ProfitSharingRequestPaymentShow.aspx?cCode=" + hdnSno.Value.ToString());
    }
