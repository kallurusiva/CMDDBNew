<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EBookPaymentReport_Own.aspx.cs" Inherits="Admin_EBookPaymentReport_Own" %>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="98%">
                 ...
                 <table cellpadding="0" cellspacing="0" width="100%" class="tblSubHeader">
                  <tr>
                        ...
                        <td width="60%" align="left" class="subHeaderFontGrad">
                            &nbsp; EBooks: Purchases - Credit Card Payment</td>
      ...
      <asp:TemplateField HeaderText="Country" SortExpression="TDate">        
       ...
       <%-- <asp:TemplateField HeaderText="Your Status" SortExpression="TDate">        
        ...
        <%--<asp:TemplateField HeaderText="Book Password" SortExpression="TDate">        
            <ItemTemplate>
                <asp:Label ID="lblBookPassword" runat="server" Text='<% # Bind("bookPassword")%>'></asp:Label>
            </ItemTemplate>            
            <ItemStyle Width="25px" HorizontalAlign="Left" VerticalAlign="Top" />
        </asp:TemplateField>--%>
        <%--<asp:TemplateField HeaderText="Your Share" SortExpression="TDate">        
            <ItemTemplate>
                <asp:Label ID="lblYourShare" runat="server" Text='<% # Bind("yourshare")%>'></asp:Label>
            </ItemTemplate>            
            <ItemStyle Width="25px" HorizontalAlign="Left" VerticalAlign="Top" />
        </asp:TemplateField>--%>
