<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EBAd_BookCodes_FreeSys.aspx.cs" Inherits="Admin_EBAd_BookCodes_FreeSys" %>
...
<ContentTemplate>--%>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="98%">
      ...
      <%--<asp:TemplateField HeaderText="Country" SortExpression="TDate">        
        ...
        <asp:TemplateField HeaderText="Mobile" SortExpression="TDate">        
            <ItemTemplate>
        ...
        <asp:TemplateField HeaderText="FullName/Email" SortExpression="TDate">        
            <ItemTemplate>
                <asp:Label ID="lblFullName" runat="server" Text='<% # Bind("FullName")%>'></asp:Label><br /><br />
        ...
        <asp:TemplateField HeaderText="Download" SortExpression="TDate">        
            <ItemTemplate>
                Book Password: 
                <asp:Label ID="Label1" runat="server" Text='<% # Bind("bookPassword")%>'></asp:Label><br />
                Download at:
                <asp:Label ID="lblDownload" runat="server" Text='<% # Bind("downloadURL")%>'></asp:Label><br /><br />
                <asp:HyperLink ID="hypDownload" runat="server" NavigateUrl='<%# Eval("downloadURL")%>' Target="_blank" > Download </asp:HyperLink><br /><br />
                <asp:LinkButton ID="LinkSendEmail" runat="server" CssClass="txtDefaultSmallFont" Text="Re-Send Email" CommandArgument='<%# Eval("emailURL")%>' OnCommand="OnCommand_ImageSendEmail" ToolTip='<%# "Send Email to : " + Eval("Email")%>'/><br /><br />
                <asp:LinkButton ID="LinkSendTelegram" runat="server" CssClass="txtDefaultSmallFont" Text="Re-Send Telegram Message" CommandArgument='<%# Eval("tMessage")%>' OnCommand="OnCommand_ImageSendTelegram" ToolTip='<%# "Send Telegram Message to : " + Eval("Mobile")%>'/><br /><br />
                <asp:HyperLink  runat="server" ID="hypDAPP" NavigateUrl='<% # Bind("Wurl")%>' Target="_blank"><asp:Label ID="lblDLink" runat="server" Text="send Whatsapp"/></asp:HyperLink></ItemTemplate><ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
        </asp:TemplateField>
