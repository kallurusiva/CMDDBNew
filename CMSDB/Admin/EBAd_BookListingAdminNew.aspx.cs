...
public partial class Admin_EBAd_BookListingAdminNew : System.Web.UI.Page
{
    ...
    protected void PopulateGrid(string vSortExpr, string vSortDir, string vSearchQuery)
    {
        ...
        ds = objDBS.Ebook_ListingNew(Convert.ToInt32(Session["UserID"]), tmpUserType, Convert.ToInt32(strPageNo), vSearchQuery, "1");
