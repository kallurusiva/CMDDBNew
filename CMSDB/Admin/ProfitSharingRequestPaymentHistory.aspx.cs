...
public partial class Admin_ProfitSharingRequestPaymentHistory : System.Web.UI.Page
{
    DataView dv;
    DataSet ds;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            //lblMainTitle.Text = "Premium ProfitShare" + " :  Request Payment History";
            //lblNotice.Text = "";
    ...
    protected void Populate_GridView1(String vSearchSql, String vSortExpr, String vSortDir)
    {
        ...
        ds = objPS.RequestPayment_History(mobileValPS);
