<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="Ad_Gallery_Videos.aspx.cs" Inherits="Ad_Gallery_Videos" %>
                  ...
                  <tr>
                        ...
                        <td width="90%" align="left" class="subHeaderFontGrad">
                            &nbsp;<asp:Literal ID="LtrLogoSettingsHeader" runat="server" 
                                Text="Videos Gallery"></asp:Literal></td>
                                 ...
                                 <ItemTemplate>
                                  ...
                                  <%--  <table cellpadding = "5px" cellspacing = "0" class="dlTable">
                                    ...
                                    <%--    <div id="dvgiImageInfo" class="dvgiImageInfo">
                                        ...
                                        <div id="dvgiImageInfo" class="dvgVideoInfo">
