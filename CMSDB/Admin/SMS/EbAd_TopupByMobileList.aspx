<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EbAd_TopupByMobileList.aspx.cs" Inherits="Admin_SMS_EbAd_TopupByMobileList" %>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
                 ...
                 <table cellpadding="0" cellspacing="0" width="100%" class="tblSubHeader">
                  <tr>
                        ...
                        <td width="60%" align="left" class="subHeaderFontGrad">
                            &nbsp; SMS System : SMS Topup By Mobile Instruction History</td>
    ...
    <asp:TemplateField HeaderText="Transaction ID" SortExpression="tID" HeaderStyle-HorizontalAlign="Left">        
    <ItemTemplate>
    <asp:Label ID="lblTransID" runat="server" Text='<% # Bind("tID")%>'/>
    </ItemTemplate>            
    <ItemStyle Width="300px" HorizontalAlign="Left" VerticalAlign="Top" />
    </asp:TemplateField>
    <asp:TemplateField HeaderText="PIN No" SortExpression="PIN" HeaderStyle-HorizontalAlign="Left">        
    <ItemTemplate>
    <asp:Label ID="lblPIN" runat="server" Text='<%# Bind("PIN") %>'/>
    </ItemTemplate>            
    <ItemStyle Width="130px" HorizontalAlign="Left" VerticalAlign="Top" />
    </asp:TemplateField>
    <asp:TemplateField HeaderText="Volume" SortExpression="Volume" HeaderStyle-HorizontalAlign="Left">    
    <ItemTemplate>
    ...
    <ItemTemplate>
    <asp:Label ID="lblTDate" runat="server" Text='<% # DataBinder.Eval(Container.DataItem, "Tdate", "{0:MMMM d, yyyy h:mm:ss tt}")%>'></asp:Label>
    </ItemTemplate>
