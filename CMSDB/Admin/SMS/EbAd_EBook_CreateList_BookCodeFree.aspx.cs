...
public partial class Admin_SMS_EbAd_EBook_CreateList_BookCodeFree : System.Web.UI.Page
{
    int tmpRowCount;
    ...
    protected void PopulateGrid(string vSortExpr, string vSortDir)
    {
        ...
        ds = ndbs.Ebook_CreateList_BookCodeFree(Session["UserID"].ToString());
    ...
    protected void Button_View(object sender, CommandEventArgs e)
    {
        ...
        //hdnSno.Value = s.Trim();
        Server.Transfer(@"EbAd_EBook_CreateList_BookCode_SpecificFree.aspx?LID=" + s.Trim());
    }
    ...
    protected void Button_sms(object sender, CommandEventArgs e)
    {
        string s = e.CommandArgument.ToString();
        hdnSno.Value = s.Trim();
        Server.Transfer(@"EbAd_EBook_CreateList_BookCode_SMSFree.aspx?LID=" + s.Trim());
    }
