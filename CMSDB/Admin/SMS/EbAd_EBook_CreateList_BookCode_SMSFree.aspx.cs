...
public partial class Admin_SMS_EbAd_EBook_CreateList_BookCode_SMSFree : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            dst = ndbs.Ebook_CreateList_BookCode_sendSMS_getListFRee(Session["UserID"].ToString(), ViewState["LID"].ToString());
