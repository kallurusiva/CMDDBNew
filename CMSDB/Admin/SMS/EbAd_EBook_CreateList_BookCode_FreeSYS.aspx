<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EbAd_EBook_CreateList_BookCode_FreeSYS.aspx.cs" Inherits="Admin_SMS_EbAd_EBook_CreateList_BookCode_FreeSYS" %>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
                 ...
                 <table cellpadding="0" cellspacing="0" width="100%" class="tblSubHeader">
                  <tr>
                        ...
                        <td width="60%" align="left" class="subHeaderFontGrad">
                            &nbsp; Free EBook - Telegram : View List/Send SMS</td>
    ...
    AlternatingRowStyle-CssClass="rowalt" AllowPaging="true" PageSize="500" onpageindexchanging="GridView1_PageIndexChanging"
    ...
    <asp:TemplateField HeaderText="Product Code" SortExpression="sno" HeaderStyle-HorizontalAlign="Left">        
    <ItemTemplate>
    <asp:Label ID="lblTransID" runat="server" Text='<% # Bind("bookcodeDisp")%>'/>
    </ItemTemplate>            
    <ItemStyle Width="50px" HorizontalAlign="Left" VerticalAlign="Top" />
    </asp:TemplateField> 
        
    <asp:TemplateField HeaderText="Product Name" SortExpression="Total count" HeaderStyle-HorizontalAlign="Left">    
    <ItemTemplate>
    <asp:Label ID="lblBookName" runat="server" Text='<% # Bind("BookName")%>'/>
    </ItemTemplate>
    <ItemStyle Width="300px" HorizontalAlign="Left" VerticalAlign="Top" />
    </asp:TemplateField>
           
    <asp:TemplateField HeaderText="Volume(Unique Mobile)" SortExpression="Total count" HeaderStyle-HorizontalAlign="Left">    
    <ItemTemplate>
    <asp:Label ID="lblVolume" runat="server" Text='<% # Bind("Volume")%>'/>
    </ItemTemplate>
    <ItemStyle Width="20px" HorizontalAlign="Left" VerticalAlign="Top" /> 
    </asp:TemplateField>
    ...
    <ItemTemplate>
    <asp:LinkButton ID="ImageButtonV" runat="server" Text="View List" CommandArgument='<%# Eval("BookCode")%>' OnCommand="Button_View"/> 
    </ItemTemplate>
    <ItemStyle Width="20px" HorizontalAlign="Left" VerticalAlign="Top" />
    </asp:TemplateField> 
    ...
    <asp:TemplateField HeaderText="" SortExpression="" HeaderStyle-HorizontalAlign="Left">        
    <ItemTemplate>
    <asp:LinkButton ID="ImageButtonS" runat="server" Text="send sms" CommandArgument='<%# Eval("BookCode")%>' OnCommand="Button_sms"/> 
    </ItemTemplate>
    <ItemStyle Width="20px" HorizontalAlign="Left" VerticalAlign="Top" />
    </asp:TemplateField>
    ...
    <asp:TemplateField HeaderText="" SortExpression="" HeaderStyle-HorizontalAlign="Left">        
    <ItemTemplate>
    <asp:LinkButton ID="ImageButtonT" runat="server" Text="send Telegram" CommandArgument='<%# Eval("BookCode")%>' OnCommand="Button_Telegram"/> 
    </ItemTemplate>
    <ItemStyle Width="20px" HorizontalAlign="Left" VerticalAlign="Top" />
    </asp:TemplateField>
    ...
    <%--<asp:TemplateField HeaderText="" SortExpression="" HeaderStyle-HorizontalAlign="Left">        
    <ItemTemplate>
    <asp:LinkButton ID="ImageButtonE" runat="server" Text="send email" CommandArgument='<%# Eval("BookCode")%>' OnCommand="Button_email"/> 
    </ItemTemplate>
    <ItemStyle Width="20px" HorizontalAlign="Left" VerticalAlign="Top" />
    </asp:TemplateField>--%>
   ...
   <%-- <asp:TemplateField HeaderText="" SortExpression="" HeaderStyle-HorizontalAlign="Left">        
    <ItemTemplate>
    <asp:LinkButton ID="ImageButtonD" runat="server" Text="Download" CommandArgument='<%# Eval("BookCode")%>' OnCommand="Button_download"/> 
    </ItemTemplate>
    <ItemStyle Width="20px" HorizontalAlign="Left" VerticalAlign="Top" />
    </asp:TemplateField>--%>
