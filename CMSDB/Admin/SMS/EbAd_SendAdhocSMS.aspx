<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EbAd_SendAdhocSMS.aspx.cs" Inherits="Admin_SMS_EbAd_SendAdhocSMS" %>
            ...
            <td align="center">
                ...
                <asp:Label ID="LabelSenderIDMsg" runat="server" CssClass="FontNoteRed" Text="Note: will always take latest sender id on the schedule date."/>
                     ...
                     <tr>
                        ...
                        <td class="tblFormText1" align="left">
                            <asp:TextBox ID="TextBoxMobileList" runat="server" CssClass="stdTextArea1" TextMode="MultiLine" Rows="4" Width="421px" />
                            <br />
                            ...
                            <asp:CustomValidator ID="ctvMobile1" runat="server" ErrorMessage="Only 50 Mobile Numbers Allowed" ControlToValidate="TextBoxMobileList" Display="Dynamic" SetFocusOnError="true" onservervalidate="ctvMobile1_ServerValidate" ValidationGroup="VgCheck"/>
                         </td>
                        <td class="tblFormText1" align="left">
                            &nbsp;</td>
                    </tr>
