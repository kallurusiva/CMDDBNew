<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EbAd_PremiumReport.aspx.cs" Inherits="Admin_SMS_EbAd_PremiumReport" %>
                            ...
                            <table id="tblSearchSimple" align="center" cellpadding="0" cellspacing="2" class="stdtableBorder_Search">
                                ...
                                <tr>
                                    ...
                                    <td class="SearchLabelBold">
                                        Ebook Code</td>
                                    <td>:</td>
                                    <td align="left" class="SearchLabel" style="width:150px;">
                                ...
                                <tr>
                                    ...
                                    <td align="left" class="SearchLabel">
                                        <asp:DropDownList ID="DropDownSearchString" runat="server" CssClass="stdDropDown">
                                ...
                                <tr>
                                    ...
                                    <td class="SearchLabelBold" colspan="3">
                                        ...
                                        &nbsp;<asp:Button ID="btnDownload" runat="server" CssClass="stdbuttonAction" 
                                           Text="Download to Excel Sheet" onclick="btnDownload_Click" />
