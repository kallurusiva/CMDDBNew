...
public partial class Admin_SMS_EbAd_1WayRerportNew : System.Web.UI.Page
{
    int iStartYear = 2013;
    ...
    protected void btnDownload_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            ...
            ds = objMalaysia.Retrieve_1WayReport(Session["MERID"].ToString(), "1", "1000", "0", tmpSearchSQL);
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=1WayReport_Report_Excel.xls");
                Response.Charset = "";
    ...
    {
        Response.Redirect(@"EbAd_1WayReport.aspx");
    }
