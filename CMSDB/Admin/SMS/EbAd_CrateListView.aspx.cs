...
public partial class Admin_SMS_EbAd_CrateListView : System.Web.UI.Page
{
    int tmpRowCount;
    ...
    protected void PopulateGrid(string vSortExpr, string vSortDir)
    {
        ...
        ds = ndbs.Ebook_CreateList_getCount(Session["MERID"].ToString());
    ...
    protected void Button_sms(object sender, CommandEventArgs e)
    {
        string s = e.CommandArgument.ToString();
        hdnSno.Value = s.Trim();
        Server.Transfer(@"EbAd_CreateList_sms.aspx?LID=" + s.Trim());
    }
    ...
    protected void Button_email(object sender, CommandEventArgs e)
    {
        string s = e.CommandArgument.ToString();
        hdnSno.Value = s.Trim();
        Server.Transfer(@"EbAd_CreateList_email.aspx?LID=" + s.Trim());
    }
    ...
    protected void Button_Delete(object sender, CommandEventArgs e)
    {
        string s = e.CommandArgument.ToString();
        newDBS ndbs = new newDBS();
        ds = ndbs.Ebook_CreateList_deleteListComplete(s.Trim());
