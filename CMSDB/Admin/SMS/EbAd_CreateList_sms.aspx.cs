...
public partial class Admin_SMS_EbAd_CreateList_sms : System.Web.UI.Page
{
    DataSet ds;
    DataSet dst;
    int vTimeDiff = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            dst = ndbs.Ebook_CreateList_sendSMS_getList(Session["MERID"].ToString(), ViewState["LID"].ToString());
