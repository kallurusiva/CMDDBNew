...
public partial class Admin_SMS_EbAd_EBook_CreateList_BookCode_SMS : System.Web.UI.Page
{
    DataSet ds;
    DataSet dst;
    int vTimeDiff = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            dst = ndbs.Ebook_CreateList_BookCode_sendSMS_getList(Session["UserID"].ToString(), ViewState["LID"].ToString());
