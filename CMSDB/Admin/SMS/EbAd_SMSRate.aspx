<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EbAd_SMSRate.aspx.cs" Inherits="Admin_SMS_EbAd_SMSRate" %>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <asp:TemplateField HeaderText="SMS Credits" HeaderStyle-HorizontalAlign="Left"  HeaderStyle-Wrap="true" SortExpression="">    
    <ItemTemplate>
    <asp:Label ID="lblSMSCredits" runat="server" Text='<%# Bind("SMSCredits") %>' CssClass="flag2_60" Font-Bold="True" ForeColor="Red"/>
    </ItemTemplate>
    <HeaderStyle HorizontalAlign="Left" Wrap="True"></HeaderStyle>
    <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Width="150px" />
    </asp:TemplateField>

    <asp:TemplateField HeaderText="Price" HeaderStyle-HorizontalAlign="Left"  HeaderStyle-Wrap="true" SortExpression="">    
    <ItemTemplate>
    ...
    <asp:TemplateField HeaderText="Referral Incentive" HeaderStyle-HorizontalAlign="Left"  HeaderStyle-Wrap="true" SortExpression="">    
    <ItemTemplate>
    <asp:Label ID="lblRIncentive" runat="server" Text='<%# Bind("Reward") %>' CssClass="flag2_60" Font-Bold="True" ForeColor="Red"/>
    </ItemTemplate>
    <HeaderStyle HorizontalAlign="Left" Wrap="True"></HeaderStyle>
    <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Width="150px" />
    </asp:TemplateField>
