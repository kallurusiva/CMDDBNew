<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EbAd_CrateListView.aspx.cs" Inherits="Admin_SMS_EbAd_CrateListView" %>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <asp:TemplateField HeaderText="List Name" SortExpression="sno" HeaderStyle-HorizontalAlign="Left">        
    <ItemTemplate>
    <asp:Label ID="lblTransID" runat="server" Text='<% # Bind("ListName")%>'/>
    </ItemTemplate>            
    <ItemStyle Width="300px" HorizontalAlign="Left" VerticalAlign="Top" />
    </asp:TemplateField>    
    <asp:TemplateField HeaderText="Volume" SortExpression="Total count" HeaderStyle-HorizontalAlign="Left">    
    <ItemTemplate>
    <asp:Label ID="lblVolume" runat="server" Text='<% # Bind("Count")%>'/>
    </ItemTemplate>
    ...
    <ItemTemplate>
    <asp:Label ID="lblTDate" runat="server" Text='<% # DataBinder.Eval(Container.DataItem, "CreateDate", "{0:MMMM d, yyyy h:mm:ss tt}")%>'></asp:Label>
    </ItemTemplate>
    ...
    <ItemTemplate>
    <asp:LinkButton ID="ImageButtonV" runat="server" Text="View List" CommandArgument='<%# Eval("Sno")%>' OnCommand="Button_View"/> 
    </ItemTemplate>
    <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
    </asp:TemplateField> 
    ...
    <asp:TemplateField HeaderText="" SortExpression="" HeaderStyle-HorizontalAlign="Left">        
    <ItemTemplate>
    <asp:LinkButton ID="ImageButtonS" runat="server" Text="send sms" CommandArgument='<%# Eval("Sno")%>' OnCommand="Button_sms"/> 
    </ItemTemplate>
    <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
    </asp:TemplateField>
    ...
    <asp:TemplateField HeaderText="" SortExpression="" HeaderStyle-HorizontalAlign="Left">        
    <ItemTemplate>
    <asp:LinkButton ID="ImageButtonE" runat="server" Text="send email" CommandArgument='<%# Eval("Sno")%>' OnCommand="Button_email"/> 
    </ItemTemplate>
    <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
    </asp:TemplateField>
