...
public partial class Admin_SMS_EbAd_EBook_CreateList_BookCode_Specific : System.Web.UI.Page
{
    int tmpRowCount;
    ...
    protected void PopulateGrid(string vSortExpr, string vSortDir)
    {
        ...
        ds = ndbs.Ebook_CreateList_BookCode_Specific(Session["UserID"].ToString(), ViewState["LID"].ToString(), strPageNo);
