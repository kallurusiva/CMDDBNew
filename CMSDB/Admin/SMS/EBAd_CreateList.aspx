<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EBAd_CreateList.aspx.cs" Inherits="Admin_SMS_EBAd_CreateList" %>
                        ...
                        <td width="98%" align="left" style="padding-top:20px;padding-bottom:20px">
                            <table id="tblSearchSimple" align="center" cellpadding="0" cellspacing="2" class="stdtableBorder_Search">
                                <tr>
                                    ...
                                    <td class="auto-style1">Date From</td>
                                    <td style="width:1px;">
                                                                                :</td>
                                ...
                                <tr>
                                    <td>&nbsp;</td>
                                    <td class="auto-style1">Date To</td>
                                    <td>:</td>
                                    <td class="SearchLabel" align="left">
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style1">
                                        Search By EBook code</td>
                                    <td>:</td>
                                    <td align="left" class="SearchLabel">
                                        &nbsp;&nbsp;<asp:TextBox ID="TextBoxSearchValue" runat="server" CssClass="stdTextField1" Width="140px"/>
                                        &nbsp;
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width:10px;">
                                        &nbsp;</td>
                                    <td class="auto-style1">
                                        Enter CreateList Name</td>
                                    <td>:</td>
                                    <td align="left" class="SearchLabel">
                                        &nbsp;&nbsp;<asp:TextBox ID="txtCreateList" runat="server" CssClass="stdTextField1" Width="140px" MaxLength="50"  ValidationGroup="VgCheck"
                            ToolTip="Enter CreateList Name."/>
                                        &nbsp;
                                        <%--<asp:RegularExpressionValidator ID="RegularExpressionValidator3" Display="Dynamic" CssClass="ValError" 
                          runat="server" ValidationExpression="^\d*[a-zA-Z0-9_-]*$" ControlToValidate="txtCreateList" ValidationGroup="VgCheck" 
                          ErrorMessage="CreateList Name should be AlphaNumeric. Allows UnderScore,Hyphen"></asp:RegularExpressionValidator>--%>
                                ...
                                <tr>
                                    ...
                                    <td class="SearchLabelBold" colspan="3">
                                        &nbsp;
                                        <asp:Button ID="btnCreateList" runat="server" CssClass="stdbuttonAction" 
                                            onclick="btnCreateList_Click" Text="Create List" />
                                        &nbsp;
                                        <asp:Button ID="btnDownload" runat="server" CssClass="stdbuttonAction" 
                                            onclick="btnDownload_Click" Text="Download List" />
