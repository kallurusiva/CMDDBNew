...
public partial class Admin_SMS_EbAd_EBook_CreateList_BookCode_EMAIL : System.Web.UI.Page
{
    DataSet ds;
    DataSet dst;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            dst = ndbs.Ebook_CreateList_BookCode_sendEMAIL_getList(Session["UserID"].ToString(), ViewState["LID"].ToString());
