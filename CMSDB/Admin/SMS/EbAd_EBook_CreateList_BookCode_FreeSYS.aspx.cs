...
public partial class Admin_SMS_EbAd_EBook_CreateList_BookCode_FreeSYS : System.Web.UI.Page
{
    int tmpRowCount;
    ...
    protected void PopulateGrid(string vSortExpr, string vSortDir)
    {
        ...
        ds = ndbs.Ebook_CreateList_BookCodeFree_FreeSYS(Session["UserID"].ToString());
    ...
    protected void Button_View(object sender, CommandEventArgs e)
    {
        ...
        //hdnSno.Value = s.Trim();
        Server.Transfer(@"EbAd_EBook_CreateList_BookCode_Specific_FreeSYS.aspx?LID=" + s.Trim());
    }
    ...
    protected void Button_sms(object sender, CommandEventArgs e)
    {
        string s = e.CommandArgument.ToString();
        hdnSno.Value = s.Trim();
        Server.Transfer(@"EbAd_EBook_CreateList_BookCode_SMS_FreeSYS.aspx?LID=" + s.Trim());
    }

    protected void Button_Telegram(object sender, CommandEventArgs e)
    {
        string s = e.CommandArgument.ToString();
        hdnSno.Value = s.Trim();
        Server.Transfer(@"EbAd_EBook_FreeSYS_MessageTelegram.aspx?LID=" + s.Trim());
    }
