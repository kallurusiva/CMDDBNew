...
public partial class Admin_SMS_EbAd_PremiumReport : System.Web.UI.Page
{
    int iStartYear = 2013;
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            Server.Transfer(@"EbAd_PremiumReportListings.aspx");
        }
    }
    ...
    {
        Response.Redirect(@"EbAd_PremiumReport.aspx");
    }
    ...
    protected void Populate_EbookCodes()
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            ddlSearchItem.DataTextField = "BOOKNAME";
