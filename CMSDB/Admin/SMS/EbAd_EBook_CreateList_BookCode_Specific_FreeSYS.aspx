<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EbAd_EBook_CreateList_BookCode_Specific_FreeSYS.aspx.cs" Inherits="Admin_SMS_EbAd_EBook_CreateList_BookCode_Specific_FreeSYS" %>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
                 ...
                 <table cellpadding="0" cellspacing="0" width="100%" class="tblSubHeader">
                  <tr>
                        ...
                        <td width="60%" align="left" class="subHeaderFontGrad">
                            &nbsp; Free EBook - Telegram : View List</td>
    ...
    AlternatingRowStyle-CssClass="rowalt" AllowPaging="true" PageSize="5000" onpageindexchanging="GridView1_PageIndexChanging"
    ...
    <asp:Label ID="lblMoble" runat="server" Text='<% # Bind("Mobile")%>'/>
            </asp:HyperLink></ItemTemplate><ItemStyle Width="300px" HorizontalAlign="Left" VerticalAlign="Top" />
    </asp:TemplateField>    
    ...
    <ItemTemplate>
    <asp:Label ID="lblName" runat="server" Text='<% # Bind("fullname")%>'/>
    </ItemTemplate>
    <ItemStyle Width="50px" HorizontalAlign="Left" VerticalAlign="Top" />
    </asp:TemplateField>

    <asp:TemplateField HeaderText="From" SortExpression="Total count" HeaderStyle-HorizontalAlign="Left">    
    <ItemTemplate>
    ...
    <ItemTemplate>
    <asp:LinkButton ID="ImageButtonD" runat="server" Text="Delete" OnClientClick="return confirm('Are you sure want to delete selected criteria/record.');" CommandArgument='<%# Eval("memail")%>' OnCommand="Button_Delete"/>
    </ItemTemplate>
