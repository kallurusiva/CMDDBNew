<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SideMenu_WebPictures.ascx.cs" Inherits="SideMenu_WebPictures" %>
                 ...
                 <table cellpadding="0" cellspacing="0" width="96%" >
                  <tr>
                        ...
                        <td width="22%" align="left" class="subHeaderMenuFontGrad tblTopBarSub" >
                            &nbsp;<asp:Literal ID="Literal7" runat="server" Text="WebPicture Settings"></asp:Literal> </td>
                            ...
                            <ul>
                               <%-- <li>
                                 ...
                                 <li id="vWebSettings"  runat="server">
                                   ...
                                   <a href="Ad_Gallery_Videos.aspx">
                                   <asp:Literal ID="ltrVideoGallery" runat="server" Text="Video Gallery"></asp:Literal>
                                   </a>
                                </li> 
                                
                                 <li id="vWebTemplate" runat="server">
                                   <asp:Image ID="Image6" ImageUrl="~/Images/tb_menuitem.jpg" runat="server" />
                                   <a href="Ad_Gallery_Images2.aspx">
                                   <asp:Literal ID="ltrImageGallery" runat="server" Text="Image Gallery"></asp:Literal>
                                   </a>
                                </li> 
