...
public partial class Admin_EbAd_BirthdayMonthList : System.Web.UI.Page
{
    ...
    protected void PopulateGrid(string vSortExpr, string vSortDir)
    {
        ...
        ds = objPS.ebook_getAuthorBirthdayMonthCount("1");
        dk = new DataTable();
        dk = ds.Tables[1];
        lblMth.Text = dk.Rows[0]["mDate"].ToString();
