<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EBAd_eBookADD_ReqAdmTest.aspx.cs" Inherits="Admin_EBAd_eBookADD_ReqAdmTest" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function up_eBookFile(sender, args) {
            ...
            if (parseInt(nfileSize) > 26214400) {
                document.getElementById('dvEbFileUploadErrorInfo').style.display = 'block';
                document.getElementById('dvEbFileUploadInfo').style.display = 'none';
                document.getElementById('<%=lblError1.ClientID %>').innerHTML = "Book File size should be less then 25MB";
                return;
            }
                ...
                <table cellpadding="0" cellspacing="3" class="stdtableBorder_Main" width="100%">
                    <tr>
                        ...
                        <td width="60%" class="FontNote" align="left" style="font-size: medium; font-weight: bold">
                            ...
                            9) Currency Table (<a href="http://14.102.146.116/Admin/EbAd_CurrencyTableNew.aspx" target="_blank">view here</a>)
                        </td>
                        <td width="15%">
                            &nbsp;</td>
                        <td width="2%">
                    ...
                    <tr>
                        <td class="auto-style7" >
                            &nbsp;</td>
                        <td class="auto-style7" >
                            Changes Looking for : <span class="font_12Msg_Error">*</span></td>
                        <td class="tblFormText1" align="left">
                            <asp:CheckBoxList runat="server" ID="chkChanges" >
                        ...
                        <td class="auto-style6" align="left">
                            <asp:Button ID="btnCheck" runat="server"  CssClass="stdbuttonCRUD" 
                                Text="Check" onclick="btnCheck_Click" /></td>
                        <td>
                            &nbsp;</td>
                    </tr>
                     ...
                     <tr>
                        ...
                        <td class="tblFormText1" align="left">
                            ...
                            &nbsp; <a href="http://183.81.165.117/Admin/EbAd_CurrencyTableNew.aspx" target="_blank">View Currency Table</a><br />
                    ...
                    <asp:TextBox ID="txtPrepaidPrice"  runat="server" CssClass="stdTextField1" TabIndex="14" Visible="false"></asp:TextBox>
                     ...
                     <tr>
                        ...
                        <td class="auto-style6" align="left">
                         ...
                         &nbsp;
                            <asp:Label runat="server" ID="BookImgThrobber" Style="display: none;"> <img alt="loader" id="BookImgLoader" class="auto-style8" src="../Images/Loader1.gif" /></asp:Label>
                     ...
                     <tr>
                        ...
                        <td class="auto-style6" align="left">
                              &nbsp;
                            <asp:Label runat="server" ID="BookFileThrobber" Text="Uploading File... Please Wait..." Style="display: none;"> <img alt="loader" id="BookfileLoader" class="auto-style8" src="../Images/Loader1.gif" /></asp:Label>
...
&nbsp;
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="UploadEbookFile" Display="Dynamic" runat="server" ErrorMessage="Please Choose a File for EBook."></asp:RequiredFieldValidator>
                             ...
                             <asp:RegularExpressionValidator ID="FileUploadValidator0"  runat="server" Display="Dynamic"  ValidationGroup="VgCheck"
                                ...
                                ValidationExpression="^.*\.(pdf|PDF|zip|ZIP)$" Enabled="true"></asp:RegularExpressionValidator>
