<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EBAd_PhysicalBooksHistory.aspx.cs" Inherits="Admin_EBAd_PhysicalBooksHistory" %>
...
<ContentTemplate>--%>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="98%">
                 ...
                 <table cellpadding="0" cellspacing="0" width="100%" class="tblSubHeader">
                  <tr>
                        ...
                        <td width="60%" align="left" class="subHeaderFontGrad">
                            &nbsp; Physical Books - Ordered History</td>
      ...
      <%--<asp:TemplateField HeaderText="Country" SortExpression="TDate">        
        ...
        <asp:TemplateField HeaderText="TranID" SortExpression="UID">        
            <ItemTemplate>
        ...
        <asp:TemplateField HeaderText="Book Title" SortExpression="BookCode">        
            <ItemTemplate>
                <asp:Label ID="lblBookTitle" runat="server" Text='<% # Bind("Title")%>'></asp:Label>
            </ItemTemplate>            
            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
        </asp:TemplateField>
        <asp:TemplateField HeaderText="Size of Book" SortExpression="vSize">        
            <ItemTemplate>
                <asp:Label ID="lblSize" runat="server" Text='<% # Bind("vSize")%>'></asp:Label>
            </ItemTemplate>            
            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
        </asp:TemplateField>
        <asp:TemplateField HeaderText="No. of Books" SortExpression="vUnits">        
            <ItemTemplate>
                <asp:Label ID="lblUnits" runat="server" Text='<% # Bind("vUnits")%>'></asp:Label><br /><br />
            </ItemTemplate>            
            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
        </asp:TemplateField>
        ...
        <asp:TemplateField HeaderText="Books Price" SortExpression="unitPrice">        
            <ItemTemplate>
                <asp:Label ID="lblPrice" runat="server" Text='<% # Bind("unitPrice")%>'></asp:Label>
            </ItemTemplate>            
            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
        </asp:TemplateField>
        <asp:TemplateField HeaderText="Handling Price" SortExpression="handlingfees">        
            <ItemTemplate>
                <asp:Label ID="lblHPrice" runat="server" Text='<% # Bind("handlingfees")%>'></asp:Label>
            </ItemTemplate>            
            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
        </asp:TemplateField>
        <asp:TemplateField HeaderText="Shipping Fees" SortExpression="Shippingfees">        
            <ItemTemplate>
                <asp:Label ID="lblSPrice" runat="server" Text='<% # Bind("Shippingfees")%>'></asp:Label>
            </ItemTemplate>            
            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
        </asp:TemplateField>
        <asp:TemplateField HeaderText="Total Charges" SortExpression="TotalPrice">        
            <ItemTemplate>
                <asp:Label ID="lblTPrice" runat="server" Text='<% # Bind("TotalPrice")%>'></asp:Label>
            </ItemTemplate>            
            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
        </asp:TemplateField>
        <asp:TemplateField HeaderText="Shipping Address">        
            <ItemTemplate>
                <asp:Label ID="lblSAddress" runat="server" Text='<% # Bind("shippingAddress")%>'></asp:Label>
            </ItemTemplate>            
            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
        </asp:TemplateField>
        ...
        <asp:TemplateField HeaderText="Tracking Website">        
            <ItemTemplate>
                <asp:Label ID="lblTrackingWebsite" runat="server" Text='<% # Bind("TrackingWebsite")%>'></asp:Label>
            </ItemTemplate>            
            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
        </asp:TemplateField>
