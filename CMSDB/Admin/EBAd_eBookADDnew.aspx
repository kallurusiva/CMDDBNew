<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/AdminMaster_DIY.master" CodeFile="EBAd_eBookADDnew.aspx.cs" Inherits="Admin_EBAd_eBookADDnew" %>
            ...
            <td align="center">
                <table cellpadding="0" cellspacing="3" class="stdtableBorder_Main" width="100%">
                    <tr>
                        ...
                        <td width="25%">
                            &nbsp;</td>
                        <td width="60%" class="FontNote" align="left">
                            <%--<strong>Note</strong>:&nbsp; <span class="font_11Msg_Error">  <strong>5 credits</strong></span>  would be charged for ADDing a new eBook.--%></td>
                        <td width="15%">
                            &nbsp;</td>
                        <td width="2%">
                            &nbsp;</td>
