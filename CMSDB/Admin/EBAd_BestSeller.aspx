<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EBAd_BestSeller.aspx.cs" Inherits="EBAd_BestSeller" %>
                            ...
                            <asp:TemplateField HeaderText="Sl No">
                              <ItemTemplate>
                               <asp:Label ID="lblSlNo" runat="server" Text='<%# Container.DataItemIndex + 1  %>'/>
                                  ...
                                  <asp:HiddenField ID="hdBestSellerUID" Value='<%#Bind("BestSellerUID")%>' runat="server" />
