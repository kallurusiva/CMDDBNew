<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="Ad_WP_BottomImage.aspx.cs" Inherits="Ad_WP_BottomImage" %>
                                ...
                                <tr>
                                    ...
                                    <td align="left" class="HelpInputCss">
                                        ...
                                        <asp:Literal ID="Literal5" runat="server" 
                                            ...
                                            Text="[ For better Page Settings and presentation, &lt;br&gt; please upload image with size &lt;= (width=550 &amp; height=150) image."></asp:Literal>
                                    </td>
                                </tr>
                            </table>
        </td></tr>
                  ...
                  <tr>
                        ...
                        <td width="30%">
                           <%-- <uc2:SelectLanguage ID="ucSelectLanguage" runat="server" />--%>
                            <asp:Button ID="btnSave" CssClass="stdbuttonAction" runat="server" Text="Save Bottom Banner Selection" 
