<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EbAd_BuyAdminBookBirthday.aspx.cs" Inherits="Admin_EbAd_BuyAdminBookBirthday" %>
              ...
              &nbsp; 
                                 ...
                                 <tr>
                                    <td>
                                        &nbsp;</td>
                                    <td class="auto-style6" align="left">
                                        <asp:Label ID="Label1" runat="server" Text="Enter Birthday Message"></asp:Label></td>
                                  
                                    <td class="auto-style4">
                                        <asp:TextBox ID="txtBMessage" runat="server" Width="444px" MaxLength="200" Text="Happy Birthday to you!! Have a nice day."></asp:TextBox> 
             </td>
                                </tr>
                                ...
                                <tr>
                                    <td >
                                        &nbsp;</td>
                                    <td class="font_12Msg_Error" align="left" style=" padding-left: 36px;" colspan="3" >
                                        Note – A congratulation Birthday Greeting will be sent to the Author giving your Name and Mobile No if you Purchase their respective EBook. You can Purchase 1 or few Birthday Author EBooks.
                                        <br />Birthday Author Might personally Whatapps or telegram message you to thank you for the Birthday Gift. Is a good way to start a meaningful friendship and building existing friendship.
                                        <br /><br />Note – Default is retrieving your Name and email Setting. You can also edit to buy the ebook from the Author to give to someone else. ( Just edit the Buyer Name &  Buyer Email</td>
                                </tr>
