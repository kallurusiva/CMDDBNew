<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" EnableEventValidation="true" AutoEventWireup="true" CodeFile="Ad_BannerSettingsTest.aspx.cs" Inherits="Admin_Ad_BannerSettingsTest" %>
                            ...
                            <asp:TemplateField HeaderText="Sl No">
                              <ItemTemplate>
                               <asp:Label ID="lblSlNo" runat="server" Text='<%# Container.DataItemIndex + 1  %>'/>
                                  ...
                                  <br />
                                  <asp:Literal ID="ltlVDisp" Text="" runat="server" />
                              </ItemTemplate>
