<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EBAd_eBookADD_ReqAdm_start.aspx.cs" Inherits="Admin_EBAd_eBookADD_ReqAdm_start" %>
                ...
                <table cellpadding="0" cellspacing="3" class="stdtableBorder_Main" width="100%">
                   ...
                   <tr style="color: #CC0000;align-content:center;">
                        <td colspan="4" style="font-weight: 700">
                            ...
                            New ebook upload or existing ebook changes with be completed with 3 - 7 working days. <br />Authors will be notified via Telegram Notifications</td>
                    </tr>
                     <tr>
