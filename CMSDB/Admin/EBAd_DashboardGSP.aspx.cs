...
public partial class Admin_EBAd_DashboardGSP : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void LoadDashBoard()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            string dispInfo;
            dispInfo = "<br><br><br>";
            dispInfo = "Your Status: " + dr["gspBuyStatus"].ToString() + "<br><br>Purchase Date: " + dr["gspurchaseDate"].ToString() + "<br>Expiry Date: " + dr["gsexpiryDate"].ToString();
            dispInfo = dispInfo + "<br><br>No of Books: " + dr["booksCount"].ToString();
            dispInfo = dispInfo + "<br><br>Note – " + dr["gsInfo"].ToString();
