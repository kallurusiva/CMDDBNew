<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="Ad_DomainsListMerged.aspx.cs" Inherits="Ad_DomainsListMerged" %>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="98%">
        ...
        <ItemTemplate>
            ...
            <td>
                ...
                <HeaderTemplate>
                 <table class="mGrid" cellspacing="0" rules="all" border="1" id="ctl00_ContentBody_gridAnchorDomains" style="border-collapse:collapse;">
                 <tr class="rowheader">
        			<th scope="col">Sl No</th><%--<th scope="col">Industry</th>--%><th scope="col">AnchorDomain</th><th scope="col">SubDomain</th><th scope="col">Your SubDomain URL Link</th><th scope="col">Sample Website URL</th>
    		     </tr>
