<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EBAd_FreeEbooks.aspx.cs" Inherits="EBAd_FreeEbooks" %>

<%@ Register src="EBLeftMenu_ebButtons.ascx" tagname="EBLeftMenu_ebButtons" tagprefix="uc1" %> 

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentLeftMenu" Runat="Server">
    <uc1:EBLeftMenu_ebButtons ID="EBLeftMenu_ebButtons1" runat="server" />
    </asp:Content>
                             ...
                             CssClass ="mGrid" HeaderStyle-CssClass="rowheader" AlternatingRowStyle-CssClass="rowalt" 
                              AllowPaging="true" PageSize="10" onpageindexchanging="gridEbooks_PageIndexChanging"
                               AllowSorting="true"  
                                ...
                                onrowdeleting="gridEbooks_RowDeleting" ondatabound="gridEbooks_DataBound" onrowdatabound="gridEbooks_RowDataBound" OnRowUpdating="gridEbooks_RowUpdating" OnSorting="gridEbooks_Sorting" OnRowCommand="gridEbooks_RowCommand"
                             >
                            <Columns>
                        <%--    <asp:TemplateField HeaderText="Sl No">
                            ...
                            <asp:TemplateField HeaderText="Sl No">
                              <ItemTemplate>
                               <asp:Label ID="lblSlNo" runat="server" Text='<%# Container.DataItemIndex + 1  %>'/>
                                  ...
                                  <asp:HiddenField ID="hdFreeEbookUID" Value='<%#Bind("FreeBookUID")%>' runat="server" />
                            ...
                            <asp:TemplateField HeaderText="Position" SortExpression="BookID" >
                              ...
                              <ItemTemplate>
                                  ...
                                  <br /> <br />
                                  <%--<asp:ImageButton ID="ImgDownloadFile" ImageUrl="~/Images/DownloadBtn.jpg" CommandArgument='<%# Bind("eBookFileName")  %>' OnClick="ImgDownloadFile_Click" runat="server" />--%>
                            ...
                            <asp:TemplateField HeaderText="Description" SortExpression="Description">
                             ...
                             <asp:TemplateField HeaderText="Display at Web<br>Created By" SortExpression="isDisplay">
                              <ItemTemplate>
                          ...
                          <asp:TemplateField HeaderText="Functions">
                              <ItemTemplate>  
                                 <%--  <asp:ImageButton ID="ImgEditByUser" CommandName="EditByUser" runat="server" ToolTip="Edit Ebook"  ImageUrl="~/Images/imgEdit2.gif" CommandArgument='<%# Eval("UID") + "," + Eval("BookID") %>'/>        --%>  
                                 <%--  <asp:HyperLink ID="HyLinkEdit" runat="server" Visible="false">
                                      <asp:Image ID="ImgEdit1" ImageUrl="~/Images/imgEdit2.gif" runat="server" />                                  
                                  </asp:HyperLink>   --%>
                                                          
                                   <asp:ImageButton ID="ImgEdit" CommandName="EDIT" ToolTip="Show or Hide EBook at WebSite" runat="server" ImageUrl="~/Images/imgEdit.gif"/>                
                              ...
                              <EditItemTemplate>
                                  ...
                                  <asp:ImageButton ID="ImgUpdate" CommandName="UPDATE" ToolTip="Show or Hide EBook at WebSite" runat="server" ImageUrl="~/Images/imgUpdate.gif" />
