...
public partial class EBAd_NewReleaseADD : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (isNum)
        {
            ...
            int inStatus = objDBS.Ebook_NewRelease_ADDNew(tmpBookUID, tmpBookID, tmpUserID, tmpShowatHP, vposition);

            if (inStatus == 1)
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmessage11", "javascript:alert('" + tmpBookID + ": eBook marked as Best Seller successfully')", true);

                tblMessageBar.Visible = true;
                lblErrMessage.Text = "Ebook Marked as NewRelease Sucessfully";
                lblErrMessage.CssClass = "font_12Msg_Success";
                MessageImage.Src = "~/Images/inf_Sucess.gif";

                ; Response.Redirect("EBAd_NewReleases.aspx");

            }
            else if (inStatus == 2)
            {
                //CommonFunctions.AlertMessage("Ebook Already Exists as a NewRelease. Please enter another BookID", "EBAd_NewRelease.aspx"); 
                CommonFunctions.AlertMessage("Ebook Already Exists as a NewRelease. Please enter another BookID");

                lblErrMessage.Text = "Ebook Already Exists as a NewRelease. Please enter another BookID.";
            ...
            {
                CommonFunctions.AlertMessage("Ebook Does not Exists. Please enter another BookID");

                lblErrMessage.Text = "Ebook Does not Exists. Please enter another BookID.";
                lblErrMessage.CssClass = "font_12Msg_Error";
                tblMessageBar.Visible = true;
                MessageImage.Src = "~/Images/inf_Error.gif";
     ...
     //   Response.Redirect("EBAd_NewRelease.aspx"); 
    ...
    protected void btnCancel_Click(object sender, EventArgs e)
    {
       ...
       Server.Transfer("EBAd_NewReleases.aspx"); 
    }
