<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EbAd_BanKInConfirmationResend.aspx.cs" Inherits="Admin_EbAd_BanKInConfirmationResend" %>
                ...
                <table cellpadding="0" cellspacing="3" class="stdtableBorder_Main" width="100%">
                    ...
                    <%--<tr>
                     ...
                     <tr>
                        ...
                        <td class="tblFormText1" align="left" colspan="2">
                         &nbsp;&nbsp;
                            <asp:Button ID="BtnSendEmail" runat="server" ValidationGroup="vCheck" CssClass="small awesome blue" Text="ReSend Books by Email" OnClick="BtnSendEmail_Click"  />
                         &nbsp;
                            </td>
