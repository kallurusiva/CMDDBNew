<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EBAd_BookCodesFree.aspx.cs" Inherits="Admin_EBAd_BookCodesFree" %>
      ...
      <%--<asp:TemplateField HeaderText="Country" SortExpression="TDate">        
        ...
        <asp:TemplateField HeaderText="Download" SortExpression="TDate">        
            <ItemTemplate>
                ...
                <asp:LinkButton ID="LinkButtonSendSMS" runat="server" Text="Re-Send SMS" CommandArgument='<%# Eval("TID") %>' OnCommand="OnCommand_ImageSendSMS" ToolTip='<%# "Send SMS to : " + Eval("Mobile")%>' CssClass="txtDefaultSmallFont"/><br /><br />
