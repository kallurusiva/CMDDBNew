<%@ Page Language="C#"  MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EbAd_BirthdayMonthList.aspx.cs" Inherits="Admin_EbAd_BirthdayMonthList" %>
...
<ContentTemplate>--%>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="98%">
                ...
                <table cellpadding="0" cellspacing="3" class="stdtableBorder_Main" width="100%">
                    <tr style="height:30px;">
                        ...
                        <td width="98%" align="left">
                            ...
                            <asp:Label ID="lblMth" runat="server"></asp:Label>
        ...
        <asp:TemplateField HeaderText="Date" >        
            <ItemTemplate>
                <asp:Label ID="lblbDay" runat="server" Text='<% # Bind("bDay")%>'></asp:Label>
            </ItemTemplate>            
            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
        </asp:TemplateField>
        ...
        <asp:TemplateField HeaderText="No. of Authors" >        
            <ItemTemplate>
                <asp:Label ID="lblAuthors" runat="server" Text='<% # Bind("bCnt")%>'></asp:Label>
            </ItemTemplate>            
            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
        </asp:TemplateField>
        ...
        <asp:TemplateField HeaderText="" >        
            <ItemTemplate>
                <asp:HyperLink ID="hypURL" runat="server" NavigateUrl='<% # Bind("link")%>'>
                <asp:Label ID="lblURL" runat="server" Text="[Click Here]"></asp:Label>
                    </asp:HyperLink>
            </ItemTemplate>            
            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
        </asp:TemplateField>
