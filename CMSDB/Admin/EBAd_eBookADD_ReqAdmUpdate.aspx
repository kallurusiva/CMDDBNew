<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EBAd_eBookADD_ReqAdmUpdate.aspx.cs" Inherits="Admin_EBAd_eBookADD_ReqAdmUpdate" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentBody" Runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ValidateCheckBoxList(sender, args) {
            var checkBoxList = document.getElementById("<%=chkChanges.ClientID %>");
                        ...
                        <td class="tblFormText1" align="left">
                             <asp:CheckBoxList runat="server" ID="chkChanges" Visible="false">
                                ...
                                <asp:ListItem Value="title" Text="title"></asp:ListItem>
                                 <asp:ListItem Value="eisbn" Text="eisbn"></asp:ListItem>
                            </asp:CheckBoxList><br />
                            <asp:CustomValidator ID="CustomValidator1" ErrorMessage="Please select at least one item - Request Changes" ValidationGroup="VgCheck"
                            ForeColor="Red" ClientValidationFunction="ValidateCheckBoxList" runat="server" /></td>
                            </td>
