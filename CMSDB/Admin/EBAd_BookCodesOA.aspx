<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster_DIY.master" AutoEventWireup="true" CodeFile="EBAd_BookCodesOA.aspx.cs" Inherits="Admin_EBAd_BookCodesOA" %>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="98%">
                 ...
                 <table cellpadding="0" cellspacing="0" width="100%" class="tblSubHeader">
                  <tr>
                        ...
                        <td width="60%" align="left" class="subHeaderFontGrad">
                            &nbsp; EBooks: - Last 30 Days Other Author EBooks</td>
      ...
      <asp:TemplateField HeaderText="Sno">
       ...
       <asp:TemplateField HeaderText="Book Title">        
            <ItemTemplate>
                <asp:Label ID="lblBookTitle" runat="server" Text='<% # Bind("BTtitle")%>'></asp:Label>
            </ItemTemplate>            
            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
        </asp:TemplateField>
        ...
        <asp:TemplateField HeaderText="Bookstore Incentive">        
            <ItemTemplate>
                <asp:Label ID="lblBookIncentive" runat="server" Text='<% # Bind("share")%>'></asp:Label>
            </ItemTemplate>            
            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
        </asp:TemplateField>

        <asp:TemplateField HeaderText="Date Purchase" >        
            <ItemTemplate>
