<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TrainingSam.aspx.cs" Inherits="TrainingSam" %>
        ...
        <div class="card card-login">
            <form class="form" method="POST"  runat="server">
              ...
              <div class="card-body">
                  ...
                  <div class="col-md-12 text-muted" style="margin-bottom: 10px;">
                                             Language : 
                    <asp:DropDownList runat="server" ID="txtLanguage" CssClass="stdDropDown">
