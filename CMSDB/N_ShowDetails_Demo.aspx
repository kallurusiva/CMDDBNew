<%@ Page Language="C#" MasterPageFile="~/N_Master.master" AutoEventWireup="true" CodeFile="N_ShowDetails_Demo.aspx.cs" Inherits="N_ShowDetails_Demo" %>
                                ...
                                <div class="smspurchase">
                                    ...
                                    <div runat="server" id="dvBookPurchaseFormat">
                                                    ...
                                                    <div visible="false" runat="server" id="tblFreeEbooksPurchase">
                                                        <div class="smspurchase">
                                                            <h3><i class="fa fa-mobile" aria-hidden="true"></i> <asp:Literal ID="Literal10" runat="server" Text="" ></asp:Literal> SMS Purchase</h3>
