...
public partial class N_User_Account : System.Web.UI.Page
{
    ...
    {
        Server.Transfer("N_User_AccountEdit.aspx");
    }
    ...
    protected void lnkEmailVerification_Click(object sender, EventArgs e)
    {
        ...
        strMsg1 = strMsg1 + "<a href='http://www.ebdvy.com/verifyBuyerEmail.aspx?k=2&id=" + linkID.ToString() + "' target='_blank'>[Please click here to verify  your email]</a>";
        strMsg1 = strMsg1 + "<br><br>";
...
<body>
    ...
    {
        Server.Transfer("N_User_EditMobile.aspx");
    }
