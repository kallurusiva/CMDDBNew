...
public partial class DefaultRedirectPaypal : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (!tmpMasterfile.Equals(string.Empty))
            {
                ...
                DataSet dstUser = ndbs.Paypal_getReturnValues(UD.ToString());
                ...
                switch (tmpMasterfile)
                {
                    ...
                    case "O_MasterBlue.master": Response.Redirect("O_dt_User_Paypal_History.aspx");
                        break;

                    case "O_MasterNew.master": Response.Redirect("O_dt_User_Paypal_History.aspx");
                        break;

                    case "N_Master.master": Response.Redirect("N_User_Paypal_History.aspx");
                        break;

                    case "N_Master2.master": Response.Redirect("N_User_Paypal_History.aspx");
                        break;

                    case "N_Master3.master": Response.Redirect("N_User_Paypal_History.aspx");
                        break;
                }
