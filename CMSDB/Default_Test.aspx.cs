...
public partial class Default_Test : System.Web.UI.Page 
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
           ...
           // Session["ClientID"] = Convert.ToInt32(GlobalVar.GetTestLoginUser);
            ...
            {
               MyGetUserIdfromURL();
               CommonFunctions.fnGetUserIdfromURL_TEST();  
            }
    ...
    public void MyGetUserIdfromURL()
    {
        ...
        //tmpMainURL = "http://scoreawebsite.1smsbusiness.com";
        //tmpMainURL = "http://sms.1carwebsite.com";
