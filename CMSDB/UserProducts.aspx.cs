...
public partial class UserProducts : UserWeb
{
...
//    DataTable dt;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ltrProductHeader.Text = Resources.LangResources.Products;
        ltrProducts.Text = Resources.LangResources.Products; 
    ...
    protected void LoadProducts()
    {
        ...
        ds = objBAL_Products.User_GETAll_Products_ByUserID(Convert.ToInt32(Session["ClientID"]),Convert.ToInt16(GlobalVar.ProductTypes.Product));
