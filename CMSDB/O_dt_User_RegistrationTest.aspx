<%@ Page Language="C#" MasterPageFile="~/O_MasterBlue.master" AutoEventWireup="true" CodeFile="O_dt_User_RegistrationTest.aspx.cs" Inherits="O_dt_User_RegistrationTest" %>
                                        ...
                                        <tbody>                                           
                                            ...
                                            <tr>
                                                ...
                                                <td class="">
                                                   ...
                                                   &nbsp; <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtPrepaidPassword" ValidationGroup="VgCheck"  runat="server" CssClass="text-custom" ErrorMessage="Password cannot be Empty"></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="">
                                                   ...
                                                   &nbsp; <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="txtPrepaidPassword" ValidationGroup="VgCheck"  runat="server" CssClass="text-custom" ErrorMessage="ReType Password cannot be Empty"></asp:RequiredFieldValidator>
                                                    &nbsp;<asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="txtPrepaidPassword" ControlToValidate="txtRPrepaidPassword" ErrorMessage="Passwords does not match" Text="Passwords does not match" ValueToCompare="txtPrepaidPassword"></asp:CompareValidator>
                                                </td>
                                            </tr>
                                             <tr>
                                                ...
                                                <td class="">
                                                   ...
                                                   &nbsp; <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ControlToValidate="txtcName" ValidationGroup="VgCheck"  runat="server" CssClass="text-custom" ErrorMessage="Full Name cannot be Empty"></asp:RequiredFieldValidator>
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtcName" ValidationGroup="VgCheck" CssClass="font_11Msg_Error" ValidationExpression="[a-zA-Z ]*$" ErrorMessage="*Valid characters: Alphabets and space." />
                                                </td>
                                            </tr>
                    ...
                    <div class="row">
                            <div class="col-xs-12 col-lg-12">
                                ...
                                <div class="text-right">
                                    ...
                                    <asp:Button ID="BtnSubmit" runat="server" ValidationGroup="VgCheck" CssClass="btn btn-custom min-width" Text="Register Now" OnClick="BtnSubmit_Click" />
