<%@ Page Language="C#" MasterPageFile="~/N_Master.master" AutoEventWireup="true" CodeFile="N_BankInConfirmVEmail.aspx.cs" Inherits="N_BankInConfirmVEmail" %>
                    ...
                    <div class="row">
                            <div class="col-xs-12 col-lg-12">
                                <div class="text-right">
                                    ...
                                    <asp:Button ID="BtnSubmit" CssClass="button -blue center" runat="server" ValidationGroup="VgCheck" Text="Submit Bank-In Details" OnClick="BtnSubmit_Click" />
                                </div>
                            </div>
                   </div>
