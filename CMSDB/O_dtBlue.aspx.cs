...
public partial class O_dtBlue : System.Web.UI.Page
{
    ...
    protected void LoadHomePageItems(int vUserId)
    {
        ...
        if (dtHomePictures.Rows.Count > 0)
        {
            foreach (DataRow pRow in dtHomePictures.Rows)
            {
                ...
                if (imgPicture1 == "") { imgSlide1.ImageUrl = "assets/images/homesliders/slide1.jpg"; } else { imgSlide1.ImageUrl = tmpImageFolder + imgPicture1; }
                if (imgPicture2 == "") { imgSlide2.ImageUrl = "assets/images/homesliders/slide2.jpg"; } else { imgSlide2.ImageUrl = tmpImageFolder + imgPicture2; }
                if (imgPicture3 == "") { imgSlide3.ImageUrl = "assets/images/homesliders/slide3.jpg"; } else { imgSlide3.ImageUrl = tmpImageFolder + imgPicture3; }
                if (imgPicture4 == "") { imgBanner1.ImageUrl = "assets/images/banners/banner1.jpg"; } else { imgBanner1.ImageUrl = tmpImageFolder + imgPicture4; }
                if (imgPicture5 == "") { imgBanner2.ImageUrl = "assets/images/banners/banner2.jpg"; } else { imgBanner2.ImageUrl = tmpImageFolder + imgPicture5; }
            }
        }
        else
        {
            imgSlide1.ImageUrl = "assets/images/homesliders/slide1.jpg";
            imgSlide2.ImageUrl = "assets/images/homesliders/slide2.jpg";
            imgSlide3.ImageUrl = "assets/images/homesliders/slide3.jpg";
            imgBanner1.ImageUrl = "assets/images/banners/banner1.jpg";
            imgBanner2.ImageUrl = "assets/images/banners/banner2.jpg";
        }

        if (vECode1.ToString().Trim() != "")
        {
            imgSlide1.NavigateUrl = "~/O_dtShowDetails.aspx?qBookID=" + vECode1.ToString();
        }
        if (vECode2.ToString().Trim() != "")
        {
            imgSlide2.NavigateUrl = "~/O_dtShowDetails.aspx?qBookID=" + vECode2.ToString();
        }
        if (vECode3.ToString().Trim() != "")
        {
            imgSlide3.NavigateUrl = "~/O_dtShowDetails.aspx?qBookID=" + vECode3.ToString();
        }
        if (vECode4.ToString().Trim() != "")
        {
            imgBanner1.NavigateUrl = "~/O_dtShowDetails.aspx?qBookID=" + vECode4.ToString();
        }
        if (vECode5.ToString().Trim() !="")
        {
            imgBanner2.NavigateUrl = "~/O_dtShowDetails.aspx?qBookID=" + vECode5.ToString();
        }
