...
public partial class N_User_DirectBankin_Hitory : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            if (!IsPostBack)
            {
                ...
                DataSet dst = ndbs.getUserCurrency(Session["ClientID"].ToString());
    ...
    protected void Populate_GridView1(String vSearchSql, String vSortExpr, String vSortDir)
    {
        ...
        ds2 = clsObjNewDbs.user_getDirectBankinHistory(Session["cLogin"].ToString());
