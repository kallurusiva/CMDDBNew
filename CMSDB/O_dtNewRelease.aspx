<%@ Page Language="C#" MasterPageFile="~/O_MasterBlue.master" AutoEventWireup="true" CodeFile="O_dtNewRelease.aspx.cs" Inherits="O_dtNewRelease" %>
                                    ...
                                    <div class="col-md-12" runat="server">
                                        ...
                                        <div class="product-action-wrapper" runat="server">
                                            ...
                                            <div class="product-action" runat="server">
                                                ...
                                                <asp:LinkButton ID="lnkAddtoCart" class="btn-add-cart custom4" Visible="false" Text="Add To Card" OnCommand="lnkAddtoCart_Command" CommandArgument='<%# Eval("BookID") + "#" + Eval("BookNAme") + "#" + Eval("DiscountedPrice", "{0:0.00}") + "#" + Eval("ImageFileFullURL") %>' runat="server">                                                                                                  
