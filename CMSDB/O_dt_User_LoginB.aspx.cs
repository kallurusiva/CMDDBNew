...
public partial class O_dt_User_LoginB : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ViewState["CallingPage"] = ViewState["CallingPage"].ToString().Replace("O_dtCart", "O_dtDirectBankin");
            Nreg.HRef = "O_dt_User_Registration.aspx?CpUri=" + ViewState["CallingPage"].ToString();
            //ViewState["CallingPage"] = Request.UrlReferrer.ToString();
        }
    }
    ...
    protected void btnLogin_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            //Response.Redirect(@"O_dt_User_Account.aspx");
