<%@ Page Title="" Language="C#" MasterPageFile="~/UserEbookMaster.master" AutoEventWireup="true" CodeFile="eBooksBestSeller.aspx.cs" Inherits="eBooksBestSeller" %>
                ...
                <div id="dvRightContent" style="padding-left: 10px;" runat="server">
                    ...
                    <asp:Repeater ID="RepBooks" runat="server" OnItemDataBound="RepBooks_ItemDataBound">
                            ...
                            <tr>
                                <td colspan="3" align="center">
                                     <div id="dvEbHeader" class="ebHeaderBox" runat="server">
                                         ...
                                         <asp:Label ID="lblHeader" CssClass="eb_head" runat="server" Text="<%$ Resources:LangResources, BestSeller %>"></asp:Label>&nbsp;
                        ...
                        <FooterTemplate>
                            ...
                            <td>&nbsp; </td>
                            <td> &nbsp;
                                <input id="hdIP1" type="hidden" value=""/>
                                <input id="hdIP2" type="hidden" value=""/>
                                <input id="hdIP3" type="hidden" value=""/>
