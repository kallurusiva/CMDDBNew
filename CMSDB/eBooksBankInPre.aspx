<%@ Page Title="" Language="C#" MasterPageFile="~/UserEbookMaster.master" AutoEventWireup="true" CodeFile="eBooksBankInPre.aspx.cs" Inherits="eBooksBankInPre" %>
                          ...
                          ErrorMessage=" <br/>Invalid Mobile No. format. <br/>Cannot start with zero or (+) Plus sign. <br/>Format : Input prefixed with country code e.g. 60169664566"></asp:RegularExpressionValidator>
                                           ...
                                           <tr>
                                               <td colspan="2" align="center">
                                                    ...
                                                    <asp:Button ID="BtnSubmit" runat="server" ValidationGroup="VgCheck" CssClass="stdbuttonBuy" Text="Continue to Direct Bank-In" OnClick="BtnSubmit_Click" />
                                                 </td>
                                           </tr>
