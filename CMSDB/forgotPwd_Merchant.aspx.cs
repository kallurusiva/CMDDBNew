...
public partial class forgotPwd_Merchant : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            else
            {
                ...
                strMsg1 = strMsg1 + "Please login at www.MerchantLogin.club to use the facilities. Your Login Deatails as follows:";
                strMsg1 = strMsg1 + "<br>";
                ...
                strMsg1 = strMsg1 + "<br>";
                strMsg1 = strMsg1 + "MerchantLogin.club Support Team";
                ...
                sendMail(Email, "noreply@ebooksmsdelivery.com", Contact_EmailBody, "MerchantLogin.Club", fullname, "", "");
            }
        }
        else
        {
...
<body>
    <div>
     <table cellpadding='0' cellspacing='0' width='600px' class='stdtableBorder_Main'>
        ...
        request.AddParameter("from", "MerchantLogin.club <me@maildly.ebdvy.com>");
        request.AddParameter("to", VEmailTO);
        request.AddParameter("subject", vEmailSubject);
        request.AddParameter("html", tmpHtmlBody);
        request.Method = Method.POST;
        client.Execute(request);
        CommonFunctions.AlertMessageAndRedirect("Password sent to you Email", "Merchant.aspx");
    }
