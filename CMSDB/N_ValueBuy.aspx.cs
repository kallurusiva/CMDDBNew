...
public partial class N_ValueBuy : System.Web.UI.Page
{
    ...
    protected void RepBooks_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        if ((e.Item.ItemType == ListItemType.Item) || (e.Item.ItemType == ListItemType.AlternatingItem))
        {
            ...
            url = url.Replace("N_ValueBuy.aspx", "N_ValueBuyShowDetails.aspx?qBookID=" + objlblBookID.Text.ToString());
    ...
    {
        Session["ipCtry"] = "MY";
        Response.Redirect("N_ValueBuyShowDetails.aspx?qBookID=" + e.CommandArgument.ToString());
    }
