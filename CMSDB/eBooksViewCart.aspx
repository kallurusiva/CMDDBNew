<%@ Page Title="" Language="C#" MasterPageFile="~/UserEbookMaster.master" AutoEventWireup="true" CodeFile="eBooksViewCart.aspx.cs" Inherits="eBooksViewCart" %>
        ...
        <tr>
            ...
            <td valign="top">
                 ...
                 <div id="dvContinueShopping" style="float:left; padding-left: 10px;" >
                     ...
                     <asp:LinkButton ID="LnkBtnContinueShopping" runat="server" OnClick="LnkBtnContinueShopping_Click">
                    <img id="imgContShopping" src="Images/ebImages/cart/contShoping.png" />
                    </asp:LinkButton>
                    </div>
                ...
                <div id="dvCheckOutPayPal" style=" float:right; padding-right: 10px; ">
                    <asp:LinkButton ID="lnkCheckOut2PayPal" runat="server" OnClick="lnkCheckOut2PayPal_Click">
                    <img id="imgCheckOutPayPal" src="Images/ebImages/cart/chkoutPayPal.png" />
                        </asp:LinkButton>
                </div>


                 <div id="dvDirectBankIn" runat="server" visible="false" style=" float:right; padding-right: 20px; ">
                    <asp:LinkButton ID="LnkDirectBankIn" runat="server" OnClick="LnkDirectBankIn_Click">
                    <img id="imgDirectBankIn" src="Images/ebImages/cart/directBankIn.png" />
                        </asp:LinkButton>
                </div>

                <div id="dvPrepaidPurchase" runat="server" visible="false" style=" float:right; padding-right: 20px; height: 50px; width: 200px;">
                    <asp:LinkButton ID="LnkPrepaidPurchase" runat="server" OnClick="LnkPrepaidPurchase_Click">
                    <img id="imgPrepaidPurchase" src="Images/ebImages/cart/PrepaidButton.png" />
                        </asp:LinkButton>
                </div>&nbsp;&nbsp;&nbsp;&nbsp;
