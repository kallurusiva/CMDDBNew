...
public partial class N_User_LoginB : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ViewState["CallingPage"] = ViewState["CallingPage"].ToString().Replace("N_Cart", "N_DirectBankin");
            Nreg.HRef = "N_User_Registration.aspx?CpUri=" + ViewState["CallingPage"].ToString();
    ...
    protected void btnLogin_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            //Response.Redirect(@"N_User_Account.aspx");
