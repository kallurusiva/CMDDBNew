...
public partial class TelegramMerchantLogin : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Request.QueryString != null && Request.QueryString.Count > 0)
        {
            ...
            dbConn.Open();
            SqlCommand dbCmd = new SqlCommand("globalapi.dbo.USPT_Telegram_merchantlogin", dbConn);
            ...
            if (mobile.ToString().Trim() == "")
            {
                ...
                Response.Redirect("http://www.bigdatalogin.club/Merchant.aspx");
            }
            else
            {
                ...
                ds = objNewDB.Merchant_validateLogin(mobile, password);
