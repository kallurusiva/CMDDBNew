<%@ Page Language="C#" MasterPageFile="~/O_MasterBlue.master" AutoEventWireup="true" CodeFile="O_dtShowDetails.aspx.cs" Inherits="O_dtShowDetails" %>
                                ...
                                <div class="col-sm-7" runat="server">
                                    <div class="product-details">
                                        ...
                                        <ul class="product-meta-list">
                                            ...
                                            <li><span>Star Rating: </span><asp:Label ID="lblStarRating" runat="server" Text=""></asp:Label></li>
                                        </ul>
                                        ...
                                        <div class="row row-lg" runat="server">
                                            <div class="col-md-12 text-left" runat="server">
                                                ...
                                                <div class="mobile-purchase-detail" runat="server" id="tblTelegramFree">
                                                    ...
                                                    <div class="code-mobile-detail" runat="server">
                                                        <p><asp:Literal ID="Literal3" runat="server" Text="Step 1 – Register Telegram Apps<br>Step 2 – Register FREE-Ebook Bot – Link Below"></asp:Literal></p>
