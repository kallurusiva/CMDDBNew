...
public partial class N_User_BookList_Purchased : System.Web.UI.Page
{
    ...
    protected void Populate_GridView1(String vSearchSql, String vSortExpr, String vSortDir)
    {
        ...
        ds2 = clsObjNewDbs.user_getBookListPurchased(Session["cLogin"].ToString());
    ...
    protected void OnCommand_ImageSendEmailNew(object sender, CommandEventArgs e)
    {
        ...
        CommonFunctions.AlertMessageAndRedirect("EBOOKS ReSend by Email Successfully....", "N_User_Banking_History.aspx");
    }
