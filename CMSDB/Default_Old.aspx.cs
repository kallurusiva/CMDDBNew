    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       // Response.Redirect("~/Template3.aspx");
        ...
        if (!IsPostBack)
        {
            ...
            #region // Commented as Data would be retreied from Master Page // Retrieve HomePageContent
            ...
            #region //  Commented Code.. as the top menu links are retreie from master page /// Retrieve Menu Links
