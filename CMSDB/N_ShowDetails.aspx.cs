...
public partial class N_ShowDetails : System.Web.UI.Page
{
    ...
    protected void LoadEbook(string qBookID, int vUserID)
    {
        ...
        HtmlMeta metatwittertitle = Master.FindControl("metatwittertitle") as HtmlMeta;
        HtmlMeta metatwitterimage = Master.FindControl("metatwitterimage") as HtmlMeta;
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            metaogimage.Content = pBookImage.ImageUrl.ToString();
            ...
            metatwitterimage.Content = pBookImage.ImageUrl.ToString();
            metatwittertitle.Content = url.ToString();
            hfPinterest.NavigateUrl = "http://pinterest.com/pin/create/button/?url=" + url + "&media=" + tmpDomain + pBookImage.ImageUrl.ToString();
            hfLinkedIn.NavigateUrl = "http://www.linkedin.com/shareArticle?mini=true&url=" + Server.UrlEncode(url.ToString());
            ...
            pStarRating.Text = dr["starRatingDisp"].ToString();
            ...
            if (isFreeBook == 1)
            {
                pBookOrgPrice.Text = dr["UserCurrency"].ToString() + " 0.00";
                pBookDiscountPrice.Text = dr["UserCurrency"].ToString() + " 0.00";
                //pBookPrepaidPrice.Text = "not Available";
            }
            ...
            if (tmpKeyword != "")
            {
                    ...
                    else
                    {
                        ...
                        if (dst1.Tables[0].Rows.Count > 0)
                        {
                            ...
                            if (nrow["countryName"].ToString() != null)
                            {
                                ...
                                if (isDisplay == "0") { dvPBookFormat.Visible = false; flgIndonesia.Visible = false; }
                            }
                            else
                            {
                            ...
                            if (nrow1["countryName"].ToString() != null)
                            {
                                ...
                                if (isDisplay == "0") { dvPBookFormat1.Visible = false; flgSingapore.Visible = false; }
                            }
                            else
                            {
                            ...
                            if (nrow2["countryName"].ToString() != null)
                            {
                                ...
                                if (isDisplay == "0") { dvPBookFormat2.Visible = false; flgMalaysia.Visible = false; }
                            }
                            else
                            {
                            ...
                            if (nrow3["countryName"].ToString() != null)
                            {
                                ...
                                if (isDisplay == "0") { dvPBookFormat3.Visible = false; flgThailand.Visible = false; }
                            }
                            else
                            {
                            ...
                            if (nrow4["countryName"].ToString() != null)
                            {
                                ...
                                if (isDisplay == "0") { dvPBookFormat4.Visible = false; flgPhilippines.Visible = false; }
                            }
                            else
                            {
                            ...
                            if (nrow5["countryName"].ToString() != null)
                            {
                                ...
                                if (isDisplay == "0") { dvPBookFormat5.Visible = false; flgVietnam.Visible = false; }
                            }
                            else
                            {
                ...
                else
                {
                    ...
                    Literal13.Text = "Step3 - Request Free EBook<br>" + "FREE " + vStoreID + " " + pBookID.Text + " YourEmail YourName";
