...
public partial class O_dtNewRelease : System.Web.UI.Page
{
    ...
    protected void RepBooks_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        if ((e.Item.ItemType == ListItemType.Item) || (e.Item.ItemType == ListItemType.AlternatingItem))
        {
            ...
            url = url.Replace("O_dtNewRelease.aspx", "O_dtShowDetails.aspx?qBookID=" + objlblBookID.Text.ToString());
    ...
    protected void lnkAddtoCart_Command(object sender, CommandEventArgs e)
    {
        ...
        foreach (string part in BookInfo)
        {
            ...
            // UpdatePanel1.Update(); 
            Server.Transfer("O_dtNewRelease.aspx");
        }
    }
