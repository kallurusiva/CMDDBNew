...
public partial class TmpMaster4 : System.Web.UI.MasterPage
{
...
//        DataTable tbNews;
        ...
        if (!IsPostBack)
        {
            ...
            //if (strMenuBarChars.Length >= 112)
            //{
            //    sbMenu.Replace("links_MainMenuBar", "links_MainMenuBar11");
            //}
            //else if ((strMenuBarChars.Length > 105) && (strMenuBarChars.Length < 112))
            //{
            //    sbMenu.Replace("links_MainMenuBar", "links_MainMenuBar11");
            //}


            //else if ((strMenuBarChars.Length > 90) && (strMenuBarChars.Length < 99))
            //{
            //    sbMenu.Replace("links_MainMenuBar", "links_MainMenuBar10");
            //}
