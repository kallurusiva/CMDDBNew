<%@ Page Language="C#" MasterPageFile="~/N_Master.master" AutoEventWireup="true" CodeFile="N_User_Registration.aspx.cs" Inherits="N_User_Registration" %>
                                        ...
                                        <tbody>
                                                ...
                                                <td class="">
                                                  <asp:TextBox ID="txtPIN" runat="server" CssClass="form-control input-sm" ValidationGroup="VgCheck"></asp:TextBox>                                                   
                                                   &nbsp;<asp:LinkButton ID="LnkBtnValidatePIN" runat="server" OnClick="LnkBtnValidatePIN_Click" Text="Validate PIN" CssClass="btn btn-custom min-width">
                                                    ...
                                                    <asp:Label runat="server" ID="lblPINV" Text="" Visible="false"></asp:Label>
                                                </td>
                                            </tr>--%>
                                            <tr>
                                                ...
                                                <td class="">
                                                   ...
                                                   <asp:RegularExpressionValidator ID="revEmail" runat="server" ValidationGroup="VgCheck" SetFocusOnError="true" ControlToValidate="txtcEmail" ErrorMessage="<br/>Enter a Valid Email<br/>Eg:user@domain.com" CssClass="note-bankinform" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" Display="Dynamic"/>
                                                    <asp:Label runat="server" ID="lblLoginV" Text="" Visible="false"></asp:Label>
                                                </td>
                                            </tr>  
                                            <tr>
                                                <td class="bg-custom"><b>Password*</b></td>
                                                <td class="">
                                                    <asp:TextBox ID="txtPrepaidPassword" runat="server" CssClass="form-control input-sm" ValidationGroup="VgCheck"></asp:TextBox>
                                                   &nbsp; <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtPrepaidPassword" ValidationGroup="VgCheck"  runat="server" CssClass="note-bankinform" ErrorMessage="Password cannot be Empty"></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="bg-custom" style="width: 368px"><b>ReType Password</b></td>
                                                <td class="">
                                                     <asp:TextBox ID="txtRPrepaidPassword" runat="server" CssClass="form-control input-sm" ValidationGroup="VgCheck"></asp:TextBox>
                                                   &nbsp; <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="txtRPrepaidPassword" ValidationGroup="VgCheck"  runat="server" CssClass="text-custom" ErrorMessage="ReType Password cannot be Empty"></asp:RequiredFieldValidator>
                                                    &nbsp;<asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="txtRPrepaidPassword" ControlToValidate="txtPrepaidPassword" ErrorMessage="Passwords does not match" Text="Passwords does not match" ValueToCompare="txtPrepaidPassword"></asp:CompareValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="">
                                                   ...
                                                   &nbsp; <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ControlToValidate="txtcName" ValidationGroup="VgCheck"  runat="server" CssClass="note-bankinform" ErrorMessage="Full Name cannot be Empty"></asp:RequiredFieldValidator>
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtcName" ValidationGroup="VgCheck" ValidationExpression="[a-zA-Z ]*$" ErrorMessage="*Valid characters: Alphabets and space." />
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="">
                                                  ...
                                                  ErrorMessage=" <br/>Cannot start with zero or (+) Plus sign."></asp:RegularExpressionValidator>
                                                    <br />
                                                    Cannot start with zero <br />
                                                    ...
                                                    Note - No need to enter CountryCode - Just select your country
                                                </td>
                                            </tr>
                   ...
                   <div class="row">
                        <div class="col-xs-12 col-lg-12">
                            <div class="float-left">
                                <div class="text-left">
                                    <asp:Button ID="BtnSubmit" runat="server" ValidationGroup="VgCheck" CssClass="button -blue center" Text="Register Now" OnClick="BtnSubmit_Click" />
                                </div>
                            </div>
