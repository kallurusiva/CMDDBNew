<%@ Page Title="" Language="C#" MasterPageFile="~/UserEbookMaster.master" AutoEventWireup="true" CodeFile="eBooksBankInPost.aspx.cs" Inherits="eBooksBankInPost" %>
                ...
                <div id="dvRightContent" style="padding-left: 10px;" runat="server">
                    ...
                    <div id="dvBookDetails" class="CssdvBookDetails" runat="server">
                                       ...
                                       <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                           ...
                                           <tr>
                                              ...
                                              <td width="75%" class="bkFormText" align="left">
                                                  ...
                                                  <span class="cssfaq_head">Purchase Details Confirmation</span></td>
                                          </tr>
                                           ...
                                           <tr>
                                              <td class="bkFormLabel">Transaction Reference No:</td>
                                           ...
                                           <tr>
                                              <td class="bkFormLabel">Bank details </td>
                                              <td class="bkFormText" align="left">
                                                   <span class="BkfontNote"> <strong>NOTE</strong>: Amount can be banked in any of the following Banks as mentioned below :-</span>
                                               </td>
                                          </tr>
                            ...
                            <asp:GridView ID="GridBanks" runat="server" AutoGenerateColumns="False"
                             ...
                             PageSize="3"  onrowdatabound="GridBanks_RowDataBound"  >
                            <Columns>
                            ...
                            <asp:TemplateField HeaderText="Bank Name" SortExpression="BankName">
                              <ItemTemplate>
                               <asp:Label ID="lblBankName" runat="server" Text='<%# Bind("BankName")  %>'/>
                                  <br />
                                  <asp:Image ID="ImgBankLogo" CssClass="imgBankLogo" runat="server" />
                              </ItemTemplate>
                              ...
                              <ItemStyle Width="50px" HorizontalAlign="Center"  />
                                           ...
                                           <tr>
                                              ...
                                              <td class="bkFormText" align="right">
                                                   ...
                                                   <asp:LinkButton ID="lnkPrintForm" CssClass="links_TopLine" runat="server">[ Print Form ]</asp:LinkButton>
                                               </td>
                                          </tr>
                                           ...
                                           <tr>
                                              ...
                                              <td class="bkFormText" align="left">
                                                   ...
                                                   &nbsp;<span class="cssfaq_head">Bank-In Details Submission Form</span> </td>
                                          </tr>
                                           ...
                                           <tr>
                                              ...
                                              <td class="bkFormText" align="left">
                                                ...
                                                <span class="font_12BlueBold">   If you have just Bank-In Online Now, Please fill up the form below :-  </span>
                                           ...
                                           <tr>
                                              ...
                                              <td class="bkFormText" align="left">
                                                   ...
                                                   &nbsp; <asp:RequiredFieldValidator ID="RequiredFieldValidator8" ControlToValidate="txtTransactionID" ValidationGroup="VgCheck"  runat="server" CssClass="font_11Msg_Error" ErrorMessage="TransactionID cannot be Empty"></asp:RequiredFieldValidator>
                                                   </td>
                                          </tr>
                                              ...
                                              <td class="bkFormText"  align="left">
                                                  ...
                                                  <br />
                                                   <div id="dvSelBankDetails" runat="server" visible="false">
                                                      ...
                                                      <br />
                                                      <asp:Label ID="lblCountry" CssClass="fontCurrency" runat="server" Text=""></asp:Label>&nbsp; 
                                                      <br />
                    ...
                    <div id="dvInVoice" class="CssdvBookDetails" runat="server" visible="false">
                        ...
                        <table class="style1">
                            ...
                            <tr>
                                ...
                                <td class="" align="right">Transaction ID :
                                ...
                                <td colspan="2" align="center">
                                    ...
                                    <table class="gridtable" width="96%">
                                        ...
                                        <tr>
                                            ...
                                            <td align="right">
                                                <asp:Label ID="lblItemsPriceTotal" CssClass="fontEBPrice" runat="server"></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
