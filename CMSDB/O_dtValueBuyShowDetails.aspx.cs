...
public partial class O_dtValueBuyShowDetails : System.Web.UI.Page
{
    ...
    protected void RepBooks_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        if ((e.Item.ItemType == ListItemType.Item) || (e.Item.ItemType == ListItemType.AlternatingItem))
        {
            ...
            //url = url.Replace("O_dtValueBuyShowDetails.aspx", "N_ValueBuyShowDetails.aspx?qBookID=" + objlblBookID.Text.ToString());
    ...
    {
        Session["ipCtry"] = "MY";
        Response.Redirect("O_dtValueBuyShowDetails.aspx?qBookID=" + Request.QueryString["qBookID"].ToString());
    }
