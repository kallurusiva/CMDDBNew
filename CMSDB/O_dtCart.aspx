<%@ Page Language="C#" MasterPageFile="~/O_MasterBlue.master" AutoEventWireup="true" CodeFile="O_dtCart.aspx.cs" Inherits="O_dtCart" %>
                        ...
                        <div runat="server" class="row">
                            <div runat="server" class="col-xs-12 col-lg-12">
                                <div runat="server" class="text-right">
                                    <asp:LinkButton ID="lnkCheckOut2PayPal" class="btn btn-blue min-width" runat="server" Text="Checkout" OnClick="lnkCheckOut2PayPal_Click">
                                        Checkout
                                    </asp:LinkButton>                             
                                    <asp:LinkButton ID="LnkOnlineBanking" class="btn btn-lightgreen min-width" runat="server" Text="Online Banking" OnClick="LnkOnlineBanking_Click" Visible="false">
                                        OnlineBanking
                                    </asp:LinkButton>
                                    <asp:LinkButton ID="LnkDirectBankIn" class="btn btn-yellow min-width" runat="server" Text="Direct Bank In" OnClick="LnkDirectBankIn_Click">
                                        Direct Bank In
                                    </asp:LinkButton><br />
                                    <asp:Image runat="server" ID="imgBanks" ImageUrl="~/Images/Malaysia-Banks.png" Height="75px" Width="200px" /><br />
                                    <asp:Image runat="server" ID="imgPaypal" ImageUrl="~/Images/paypalimage.jpg" Height="75px" />
