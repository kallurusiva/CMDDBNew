...
public partial class N_FeatureBuy : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            //Response.Write(Session["ipCtry"].ToString());
            ...
            //string ipList = HttpContext.Current.Request.ServerVariables["REMOTE_ADDR"];
            //Response.Write(ipList.ToString());
        }
    }
    ...
    protected void RepBooks_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        if ((e.Item.ItemType == ListItemType.Item) || (e.Item.ItemType == ListItemType.AlternatingItem))
        {
            ...
            url = url.Replace("N_FeatureBuy.aspx", "N_ShowDetails.aspx?qBookID=" + objlblBookID.Text.ToString());
    ...
    protected void lnkAddtoCart_Command(object sender, CommandEventArgs e)
    {
        ...
        foreach (string part in BookInfo)
        {
            ...
            // UpdatePanel1.Update(); 
            Server.Transfer("N_FeatureBuy.aspx");
        }
    }
