...
public partial class TmpMaster3 : System.Web.UI.MasterPage
{
        ...
        if (!IsPostBack)
        {
            ...
            foreach (DataRow mRow in tbMenu.Rows)
            {
                ...
                //{
                    ...
                    {
                        sbMenu.Append(Server.UrlDecode(tmpCultureMenuName));
                        strMenuBarChars += tmpCultureMenuName;
                    }
                    else
                    {
                        sbMenu.Append(Server.UrlDecode(mRow["LinkName"].ToString()));
