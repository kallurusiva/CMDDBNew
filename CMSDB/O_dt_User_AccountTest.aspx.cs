...
public partial class O_dt_User_AccountTest : System.Web.UI.Page
{
    ...
    protected void lnkEmailVerification_Click(object sender, EventArgs e)
    {
            ...
            strMsg1 = strMsg1 + "<a href='http://www.ebdvy.com/verifyBuyerEmail.aspx?id=" + linkID.ToString() + "' target='_blank'>[Please click here to verify  your email]</a>";
            strMsg1 = strMsg1 + "<br><br>";
