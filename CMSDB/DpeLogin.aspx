<%@ page title="" language="C#" masterpagefile="~/UserMaster.master" autoeventwireup="true" maintainscrollpositiononpostback="true" CodeFile="DpeLogin.aspx.cs" inherits="DpeLogin" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
.loginDivCss2       {width: 240px; height: 200px; float: left; margin-left: 10px; margin-right: 10px;
    ...
    .modalPopup .body
    {
        ...
        text-align: center;
        font-weight: bold;
        font: bold 102%/100% "Trebuchet MS","Lucida Console", Arial, sans-serif;
...
padding: 10px; 
        ...
        .auto-style3 {
            ...
            color: #94804D;
            font-family: Tahoma, Arial, Verdana, Lucida Bright;
            padding-left: 5px;
            width: 167px;
        }
        .auto-style4 {
    ...
    <table class="style1">
        ...
        <table border="0" cellpadding="0" cellspacing="0" class="loginBkg">
                    ...
                    <td colspan="4">
                        ...
                        <div class="LogoBoxheadBlue">
                                    ...
                                    <div class="sideBoxheadText"> 
                                        <asp:Literal ID="LtrSMSAdminLogin" Text="DPE  Login" runat="server"></asp:Literal></div>
                                </div>   
                      </td> 
                    ...
                    <td class="loginfont12" style=" padding-left: 30px;">
                        &nbsp;</td>
                    <td class="auto-style1" style=" padding-left: 30px;">
                        &nbsp;</td>
                    <td>&nbsp;</td>
                    </tr>
                    ...
                    <td align="center" style="padding-left:50px">
                        &nbsp;</td>
                    <td align="center" style="padding-left:50px" class="auto-style2">
                        <asp:Button CssClass="stdButtonLogin" ID="btnSignIn_DPE" runat="server" 
        ...
        <div id="dvSMSLogin0" class="loginDivCss1">
        ...
        <table border="0" cellpadding="0" cellspacing="0" class="loginBkg">
                    ...
                    <td colspan="4">
                        ...
                        <div class="LogoBoxheadBlue">
                                    ...
                                    <div class="sideBoxTRtarc"><img src="Images/table_top_Rightarc.gif" /></div>
                                    <div class="sideBoxheadText"> 
                                        <asp:Literal ID="LtrSMSAdminLogin0" Text="DPE  Product Login" runat="server"></asp:Literal></div>
                                </div>   
                      </td> 
                    ...
                    <td>&nbsp;</td>
                    <td class="loginfont12" style=" padding-left: 30px;">
                        <asp:Literal ID="ltrSMS_Login0" Text="Login" runat="server"></asp:Literal>&nbsp;&nbsp;
                            </td>
                    <td class="auto-style1" style=" padding-left: 30px;">
                    <asp:TextBox ID="pLoginID" MaxLength="25" CssClass="inputTextBoxcss" runat="server" 
                            ValidationGroup="VgPLogin"></asp:TextBox>
                            </td>
                    <td>&nbsp;</td>
                    </tr>
                    ...
                    <td class="auto-style2">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" 
                            ErrorMessage="Please enter LoginID"  CssClass="font_12Msg_Error" Display="Dynamic"
                            ControlToValidate="pLoginID" SetFocusOnError="True" 
                            ValidationGroup="VgPLogin"></asp:RequiredFieldValidator>
                    ...
                    <td>&nbsp;</td>
                      ...
                      <tr  style="height:20px; vertical-align:baseline;">
                    <td>&nbsp;</td>
                    <td  class="loginfont12" style=" padding-left: 30px;"> <asp:Literal ID="ltrSMS_Password0" Text="Password" runat="server"></asp:Literal>
                          </td>
                    <td  class="auto-style1" style=" padding-left: 30px;"> 
                     <asp:TextBox ID="pPassword" CssClass="inputTextBoxcss" runat="server" 
                            style="margin-bottom: 0px" TextMode="Password" 
                            ValidationGroup="VgPLogin"></asp:TextBox></td>
                    <td>&nbsp;</td>
                    </tr>
                    ...
                    <td class="auto-style2">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" 
                            ErrorMessage="Please enter password" CssClass="font_12Msg_Error" 
                            ControlToValidate="pPassword" Display="Dynamic" SetFocusOnError="True" 
                            ValidationGroup="VgPLogin"></asp:RequiredFieldValidator>
                          </td>
                    <td>&nbsp;</td>
                    </tr>
                    ...
                    <td align="center" style="padding-left:50px">
                        &nbsp;</td>
                    <td align="center" style="padding-left:50px" class="auto-style2">
                        <asp:Button CssClass="stdButtonLogin" ID="btnSignIn_Product" runat="server" 
                            Height="26px" Text="Sign In"  Width="72px"  ValidationGroup="VgPLogin" OnClick="btnSignIn_Product_Click" />
                          </td>
                    <td>&nbsp;</td>
                    </tr>
                    ...
                    <td align="right" class="auto-style2">
                        <asp:Label ID="lblErrMsg_SmsSystem0" CssClass="valError" Text="InValid LoginID or Password" Visible="false" runat="server"></asp:Label>
                        </td>
                    <td>&nbsp;</td>
                    </tr>
                    ...
                    <td align="right" class="auto-style2">
                        ...
                        <asp:HyperLink ID="HypSMS_fp0" CssClass="links_ForgotPwd" runat="server" 
                            NavigateUrl="~/UserForgotPassword.aspx?fp=SMS">[Forgot Password]</asp:HyperLink>
...
<td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr><tr>
<td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr></table><%-- <asp:Button ID="btnYes" runat="server" Text="Yes" CssClass="yes" />
        <asp:Button ID="btnNo" runat="server" Text="No" CssClass="no" />--%>     <%-- <asp:Button ID="btnYes" runat="server" Text="Yes" CssClass="yes" />
        <asp:Button ID="btnNo" runat="server" Text="No" CssClass="no" />--%>
