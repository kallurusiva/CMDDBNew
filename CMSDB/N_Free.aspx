<%@ Page Language="C#" MasterPageFile="~/N_Master.master" AutoEventWireup="true" CodeFile="N_Free.aspx.cs" Inherits="N_Free" %>
                            ...
                            <div class="row">
                                <div class="col-xs-8">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-8" runat="server" id="dvBookPurchaseFormat">                                            
                                    ...
                                    <table class="table-fill">
                                        ...
                                        <tbody class="table-hover">
                                            ...
                                            <%--<tr>
                                                ...
                                                <td class="text-left"><asp:Label ID="lblPrepaidPrice" runat="server" Text="0 Credits"></asp:Label></td>
                                            </tr>--%>
                                        </tbody>
                                    </table>
