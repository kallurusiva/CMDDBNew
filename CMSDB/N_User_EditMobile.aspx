<%@ Page Language="C#" MasterPageFile="~/N_Master.master" AutoEventWireup="true" CodeFile="N_User_EditMobile.aspx.cs" Inherits="N_User_EditMobile" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderRight" runat="Server">
   ...
   <div class="col-xs-9 content-middle">
                ...
                <div class="col-xs-12">
                    <div class="row">
                        <div class="col-xs-12">
                            <h2 class="main-title">Edit Mobile</h2>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered bankinform-table">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="bg-custom"><b>Enter New Mobile*</b></td>
                                                <td class="">
                                                  ...
                                                  ErrorMessage=" <br/>Cannot start with zero or (+) Plus sign."></asp:RegularExpressionValidator>
                                                    <br />
                                                    <span class="auto-style1">Cannot start with zero <br />
                   ...
                   <div class="row">
                        <div class="col-xs-12 col-lg-12">
                            <div class="float-left">
                                <div class="text-left">
                                    <asp:Button ID="BtnSubmit" runat="server" ValidationGroup="VgCheck" CssClass="button -blue center" Text="Update Now" OnClick="BtnSubmit_Click" />
                                </div>
                            </div>
