...
public partial class O_dtCart : System.Web.UI.Page
{
        ...
        //{
            if (!IsPostBack)
            {
                ...
                //{
                    ...
                    {
                        ViewState["CallingPage"] = "O_dtNew.aspx";
                    }
                    else
                    {
                        ViewState["CallingPage"] = "O_dtBlue.aspx";
                    }                    
                //}
                    ...
                    if (CartDataTable1 != null)
                    {
                        if (CartDataTable1.Rows.Count < 1)
                        {
                            ...
                            CommonFunctions.AlertMessageAndRedirect("Cart is empty.", "O_dt_User_Account.aspx");
                        }
                    }
                    else
                    {
    ...
    protected void LnkPrepaidPurchase_Click(object sender, EventArgs e)
    {
        ...
        String vURL = "O_dtPrepaidPre.aspx?CpUri=" + tmpURI;
    ...
    {
        //String tmpURI = ViewState["CallingPage"].ToString();
        //String vURL = "O_dtPaypalConfirm.aspx?CpUri=" + tmpURI;
        //Response.Redirect(vURL);
        ...
        if ((Session["navcheckout"].ToString() == "0"))
            ...
            {
                Response.Redirect("O_dtPaypalConfirm.aspx");
            }        
    }
    ...
    {
        String tmpURI = ViewState["CallingPage"].ToString();
        String vURL = "O_dtDirectBankin.aspx?CpUri=" + tmpURI;
        //  String vURL = "eBooksBankInSubmit.aspx?CpUri=" + tmpURI;
        Response.Redirect(vURL);
