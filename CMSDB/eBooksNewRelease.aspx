<%@ Page Title="" Language="C#" MasterPageFile="~/UserEbookMaster.master" AutoEventWireup="true" CodeFile="eBooksNewRelease.aspx.cs" Inherits="eBooksNewRelease" %>
...
<td>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            ...
            <td width="150px"></td>
            <td align="right" >
               <%--<asp:UpdateProgress ID="UpdateProgress1" AssociatedUpdatePanelID="UpdatePanel1" DynamicLayout="true"  DisplayAfter="5000" runat="server">
                            <ProgressTemplate>
                            <div id="progress" runat="server" visible="true">
                                <img id="Img1" src="~/Images/Loader1.gif" runat="server"/> Adding items to Cart... Please wait... 
                             </div>
                            </ProgressTemplate>
                            ...
                            <tr>
                                <td colspan="3" align="center">
                                     <div id="dvEbHeader" class="ebHeaderBox" runat="server">
                                         ...
                                         <asp:Label ID="lblHeader" CssClass="eb_head" runat="server" Text="<%$ Resources:LangResources, NewReleases %>"></asp:Label>
