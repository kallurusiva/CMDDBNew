...
public partial class DefaultMain : System.Web.UI.Page 
{
            ...
            //{
                ...
                if (!tmpMasterfile.Equals(string.Empty))
                {
                    ...
                    switch (tmpMasterfile)
                    {
                        ...
                        case "O_MasterBlue.master": Response.Redirect("O_dtBlue.aspx");
                            break;

                        case "O_MasterNew.master": Response.Redirect("O_dtNew.aspx");
                            break;

                        case "N_Master.master": Response.Redirect("N_Main.aspx");
                            break;

                        case "N_Master2.master": Response.Redirect("N_Main2.aspx");
                            break;

                        case "N_Master3.master": Response.Redirect("N_Main3.aspx");
                            break;
                    }                    
                }
    ...
    protected int ValidateLoginStatus(string vLoginID, String vPassword, String vType)
    {
        ...
        if (dtExpiry.Rows.Count > 0)
        {
            ...
            {
                //LblNotice.Text = @"Your Account will expire on " + vExpiryDate.ToString("dddd, dd MMMM yyyy HH:mm tt") + ". Please renew immediately. ";
                //retStatus = 3;
                //CommonFunctions.AlertMessage(LblNotice.Text);
                //ModalPopUpExtender1.Show();
