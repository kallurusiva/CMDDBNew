<%@ Page Title="" Language="C#" MasterPageFile="~/UserEbookMaster.master" AutoEventWireup="true" CodeFile="eBooksBankInSubmit.aspx.cs" Inherits="eBooksBankInSubmit" %>
                                       ...
                                       <table border="0" cellpadding="0" cellspacing="0" width="100%" style="height: 535px">
                                           ...
                                           <tr>
                                              ...
                                              <td class="bkFormText" align="left">
                                                  ...
                                                  <span class="cssfaq_head">Bank-In Details Submission</span>
                                                   </td>
                                          </tr>
                                           ...
                                           <tr>
                                              <td class="bkFormLabel">&nbsp;</td>
                                              <td class="bkFormText" align="left">
                                                  <div id="dvBankDetails" runat="server" visible="false">
                                           ...
                                           <tr>
                                              ...
                                              <td class="bkFormText" align="left">
                                                   ...
                                                   &nbsp; <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ControlToValidate="txtBankinBy" ValidationGroup="VgCheck"  runat="server" CssClass="font_11Msg_Error" ErrorMessage="BankIn Date cannot be Empty"></asp:RequiredFieldValidator>
                                                </td>
                                          </tr>
                                           ...
                                           <tr>
                                              ...
                                              <td class="bkFormText"  align="left">
                                                   ...
                                                   &nbsp; <asp:RequiredFieldValidator ID="RequiredFieldValidator6" ControlToValidate="txtBankinBy" ValidationGroup="VgCheck"  runat="server" CssClass="font_11Msg_Error" ErrorMessage="BankIn Time cannot be Empty"></asp:RequiredFieldValidator>
                                                </td>
                                          </tr>
