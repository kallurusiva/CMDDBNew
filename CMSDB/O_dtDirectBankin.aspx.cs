...
public partial class O_dtDirectBankin : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if ((Session["cLogin"] == null) || (Session["cLogin"].ToString() == ""))
        {
            ...
            Response.Redirect("O_dt_User_LoginB.aspx");
        }
        else
        {
            if (!IsPostBack)
    ...
    protected void BtnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {            
            ...
            Server.Transfer("O_dtDirectBankInConfirm.aspx?qtrID=" + vTranID);
        }
        else
        {
    ...
    protected void Send_TransactionInvoice_ToBuyer(String vbFullName, String vbMobile, String vbEmail, string vbTotalAmount, String vbCurrency, string vPurchaseItems, int vUserID, string vTranID)
    {
        ...
        //String strSubmitLink = "http://14.102.146.116/O_dtBankInConfirmVEmail.aspx?vTID=" + vTranID.ToString();
        ...
        request.AddParameter("bcc", userEmail);
