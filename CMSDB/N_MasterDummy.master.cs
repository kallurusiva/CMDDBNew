...
public partial class N_MasterDummy : System.Web.UI.MasterPage
{
    DataSet MainDS;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (tbTopRowLinks.Rows.Count > 0)
        {
            ...
            foreach (DataRow cRow in tbTopRowLinks.Rows)
            {
                ...
                {
                    sb.AppendLine("<a href='http://www.evenchiselogin.com' target='_blank'><i class='fa fa-lock' aria-hidden='true'></i> E-vendor Login</a>");
                }
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    sbUM.AppendLine("<li class='divider'></li>");
                    sbUM.AppendLine("<li><a href='N_User_Banking_History.aspx'>Online Purchases</a></li>");
                }
                sbUM.AppendLine("<li class='divider'></li>");
                sbUM.AppendLine("<li><a href='N_User_Signout.aspx'>Sign Out</a></li>");
                sbUM.AppendLine("</ul>");
