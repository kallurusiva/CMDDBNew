...
public partial class N_Paypalconfirm : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            if (!IsPostBack)
            {
                ...
                //{
                //    Response.Redirect("N_User_Login.aspx");
                //}
                //else
                //{
                LoadCartItems();
        ...
        if (CartDataTable != null)
        {
            if (CartDataTable.Rows.Count > 0)
            {
                ...
                foreach (DataRow cRow in CartDataTable.Rows)
                {
                    ...
                    tmpCurrency = cRow["currency"].ToString();
                    Response.Write(tmpCurrency.ToString());
                ...
                //lblAmtCurrency.Text = tmpCurrency;
