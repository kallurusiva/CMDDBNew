...
public partial class eBookFeaturedXX : UserWeb
{
                ...
                if (isFreeBook == 0)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            objLit12_1.Text = "send To 36247";
                            if (objlblPurchaseNote != null)
                                objlblPurchaseNote.Text = "<b>" + Resources.LangResources.Note + ":- </b> <span class='PriceFont'>" + string.Format("{0:0.00}", tmpBookPrice) + " </span> " + Resources.LangResources.persmsreceived + ". Eg. " + ViewState["vEbUserKeyword"] + "  " + objlblBookID.Text + "  JohnW@yahoo.com  John Woo";
                        }
    ...
    protected void lnkAddtoCart_Command(object sender, CommandEventArgs e)
    {
        ...
        foreach (string part in BookInfo)
        {
            ...
            Server.Transfer("eBooksFeatured.aspx");
