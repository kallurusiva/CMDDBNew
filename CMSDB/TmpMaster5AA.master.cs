...
public partial class TmpMaster5AA : System.Web.UI.MasterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (tmpCurrPageName.Contains("default") || (tmpCurrPageName.Contains("dt")))
            {
            ...
            for (i = 0; i <= tbHomePgContent.Rows.Count - 1; i++)
            {
                ...
                //if (Session["defLanguage"].ToString() == GlobalVar.Lang_English)
                //{
