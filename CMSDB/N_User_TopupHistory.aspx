<%@ Page Language="C#" MasterPageFile="~/N_Master.master" AutoEventWireup="true" CodeFile="N_User_TopupHistory.aspx.cs" Inherits="N_User_TopupHistory" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderRight" runat="Server">
    ...
    <div class="col-xs-9 content-middle">
        ...
        <div class="m-b-20"></div>
                    ...
                    <div class="row">
                        <div class="col-xs12">
                            <h2>Prepaid Topup History</h2>
                            <div class="row">                                
                                <div runat="server" class="table-responsive">

                            <asp:GridView ID="GridView1" CssClass="table-fill-cart" runat="server" AllowPaging="True"  AllowSorting="True" AutoGenerateColumns="False" ondatabound="GridView1_DataBound" onpageindexchanging="GridView1_PageIndexChanging" 

OnRowCreated="GridView1_RowCreated" onrowdatabound="GridView1_RowDataBound" onsorting="GridView1_Sorting" PageSize="50" ShowFooter="True" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" CellPadding="4" 
...
EnableModelValidation="True" GridLines="None" BorderWidth="1px">
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="PIN" SortExpression="sno">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="lblMName" runat="server" Text='<% # Bind("PIN")%>'></asp:Label>
                                                                                </ItemTemplate>
                                                                                <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
                                                                            </asp:TemplateField>
                                                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Credits">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="lblPytStatus" runat="server" Text='<% # Bind("Credits")%>'></asp:Label>
                                                                                </ItemTemplate>
                                                                                <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Width="60px" />
                                                                            </asp:TemplateField>
                                                                            <asp:TemplateField HeaderText="Date" SortExpression="sno">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="lblPDate" runat="server" Text='<% # DataBinder.Eval(Container.DataItem, "Tdate", "{0:MMMM d, yyyy h:mm tt}")%>'></asp:Label>
                                                                                </ItemTemplate>
                                                                                <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
                                                                            </asp:TemplateField>
                                                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="StoreID">
                                                                                <ItemTemplate>
