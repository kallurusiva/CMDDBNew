<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TestMasWebReg.aspx.cs" Inherits="TestMasWebReg" %>
...
<td>&nbsp;</td>
<td>
    <table cellpadding="0" cellspacing="0" style="margin: 3px; display:block; background-color:#FEFFDE; border: solid 3px #FB4242; width:100%; height:40px;" id="tblMessageBar" visible="false" runat="server">
     <tr>
...
&nbsp; Own domain registration will be done inside admin login for PLATINUM users. ]</td>
                ...
                <%--    <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" RenderMode="Inline" runat="server">
                        <ContentTemplate>--%>
                            ...
                            CssClass="stdTextField1" MaxLength="20" ValidationGroup="VgCheck"  
