...
public partial class TestLogin123 : System.Web.UI.Page 
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
           ...
           // Session["ClientID"] = Convert.ToInt32(GlobalVar.GetTestLoginUser);
            ...
            {
                if((Request.QueryString["pgFrom"] == "1MACC") || (Request.QueryString["pgFrom"] == "SMSSYSTEM"))
                {
            ...
            //{
                ...
                if (!tmpMasterfile.Equals(string.Empty))
                {
                    ...
                    switch (tmpMasterfile)
                    {
                        ...
                        case "TmpMaster5AA.master": Response.Redirect("default_T5AA.aspx");
                            break;
    ...
    public int GetUserIdfromURL()
    {
        ...
        //tmpMainURL = "http://60166362863.1smsbusiness.com";
        //tmpMainURL = "http://60133625275.1smsbusiness.com";
           ...
           ////valid login 
            ...
            if ((tmpCountryPrefix == "60") || (tmpCountryPrefix == "65") || (tmpCountryPrefix == "62"))
            {
                ...
                else
                {
                    ...
                    CommonFunctions.TestCheckSubDomainByLoginID(tmpCountryPrefix, mUserName, mPassword); 
    ...
    protected void Log2AdminforUser(string inComingURL)
    {
        ...
        if ((UserStatus_Value == "MATCHED") || (UserStatus_Value == "SUBDOMAIN_FOUND"))
        {
            ...
            if (tmpOwnDomainName != "")
                ...
                Response.Redirect("http://" + tmpOwnDomainName + "/pgFromASP.aspx?qUserID=" + Session["UserID"].ToString() + "&qLoginID=" + Session["LoginID"].ToString() + "&qUserDomainType=" + Session["UserDomainType"].ToString() + "&qMobileLoginID=" + Session["MobileLoginID"].ToString() + "&qRefferringURL=" + tmpReferringURL);
