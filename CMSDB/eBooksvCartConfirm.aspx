<%@ Page Title="" Language="C#" MasterPageFile="~/UserEbookMaster.master" AutoEventWireup="true" CodeFile="eBooksvCartConfirm.aspx.cs" Inherits="eBooksvCartConfirm" %>
                ...
                <div id="dvRightContent" style="padding-left: 10px;" runat="server">
                    ...
                    <div id="dvBookDetails" class="CssdvBookDetails">
                                       ...
                                       <table border="0" cellpadding="0" cellspacing="0" width="100%" style="height: 535px">
                                          <tr>
                                              <td width="100px" class="bkFormLabel">&nbsp;</td>
                                              <td class="bkFormText" align="left"> 
                                                  
                                                  <span class="cssfaq_head">Confirm and Enter Personal Details </span></td>
                                          </tr>

                                          <tr>
                                              <td  class="bkFormLabel">&nbsp;</td>
                                              <td  class="bkFormText"> &nbsp;</td>
                                          </tr>

                                          <tr>
                                              <td class="bkFormLabel">Product Seleted:</td>
                                              <td  class="bkFormText"> <asp:Label ID="lblBookID" CssClass="fontEBName" runat="server" Text=""></asp:Label></td>
                                          </tr>

                                           <tr>
                                              <td class="bkFormLabel">Total Items:</td>
                                              <td class="bkFormText"> <asp:Label ID="lblTotalItems" CssClass="fontEBName" runat="server" Text=""></asp:Label></td>
                                          </tr>
                                           ...
                                           <tr>
                                            ...
                                            <tr>
                                              ...
                                              <td class="bkFormText" style=" vertical-align: bottom;"> 
                                                  &nbsp;
                                                 <span class="BkfontNote">Product would be sent to this email address. </span>  </td>
                                          </tr>
...
<asp:Button ID="buttonCancel" runat="server" CssClass="stdbuttonBuy" Text="Back to Cart" OnClick="buttonCancel_Click" />
                                                   </div>

                                                   <asp:LinkButton ID="lnkBuyNow" runat="server" ValidationGroup="VgCheck" OnClick="lnkBuyNow_Click"  OnClientClick="skm_LockScreen('Please wait while we take you to PayPal Site...');" >
                                                       <img src="Images/ebImages/cart/paypal_buynow.gif" style="" /></asp:LinkButton>
                                           ...
                                           <tr>
                                               <td colspan="2" class="font_11Msg_Error" align="left">
                                          ...
                                          <hr />
                                           ...
                                           <tr>
                                               <td colspan="2" class="font_11Msg_Error" align="right">
