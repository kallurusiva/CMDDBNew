...
public partial class VBDay : System.Web.UI.Page
{
    string glbFrom;
    string glbText;
    string glbMsgID;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataSet ds = ndbs.BirthDay_Incoming(glbFrom.ToString(), glbUniqueID.ToString(), glbDay.ToString(), glbMonth.ToString(), glbYear.ToString(), glbFullName.ToString(), glbCName.ToString(), glbEmail.ToString(), glbText.ToString(), glbMsgID.ToString(), glbSCode.ToString());
