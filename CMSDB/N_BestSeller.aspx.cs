...
public partial class N_BestSeller : System.Web.UI.Page
{
    ...
    protected void RepBooks_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        if ((e.Item.ItemType == ListItemType.Item) || (e.Item.ItemType == ListItemType.AlternatingItem))
        {
            ...
            url = url.Replace("N_BestSeller.aspx", "N_ShowDetails.aspx?qBookID=" + objlblBookID.Text.ToString());
    ...
    protected void lnkAddtoCart_Command(object sender, CommandEventArgs e)
    {
        ...
        foreach (string part in BookInfo)
        {
            ...
            // UpdatePanel1.Update(); 
            Server.Transfer("N_BestSeller.aspx");
        }
    }
