...
public partial class N_cartPrepaidOld : System.Web.UI.Page
{
    ...
    protected void BtnSubmit_Click(object sender, EventArgs e)
    {
        ...
        DataSet dst = ndbs.user_PrepaidTransaction(vClientId.ToString(), Session["cLogin"].ToString(), ViewState["vPrepaidPassword"].ToString(), vPurchaseAmt.ToString(), vPurchaseItems.ToString(), "");
    ...
    protected void LoadCartItems()
    {
        ...
        if (ds2.Tables[0].Rows.Count > 0)
        {
            ...
            ViewState["vPrepaidPassword"] = krow["password"].ToString();
