...
public partial class TmpMaster1 : System.Web.UI.MasterPage
{
    ...
    //            //ContentPlaceHolder cph = (ContentPlaceHolder)this.FindControl("ContentPlaceHolderRight");
    //            //Literal objLblNotice = (Literal)cph.FindControl("LblNotice");

    //            //// Label objLblNotice = (Label)Master.FindControl("LblNotice");
    //            //if (objLblNotice != null)
    //            //    objLblNotice.Text = ValidStatusText;

    //            //AjaxControlToolkit.ModalPopupExtender Mp = (AjaxControlToolkit.ModalPopupExtender)cph.FindControl("ModalPopUpExtender1");
    //            //Mp.Show(); 
    //            //Label objLblNotice = (Label)Master.FindControl("LblNotice");
    //            //objLblNotice.Text = ValidStatusText; 
