<%@ Page Language="C#" MasterPageFile="~/O_MasterBlue.master" AutoEventWireup="true" CodeFile="O_dt_User_Banking_History.aspx.cs" Inherits="O_dt_User_Banking_History"  %>
            ...
            <div class="row" runat="server">
                <div runat="server" class="col-md-9 col-md-push-3">
                        <div runat="server" class="table-responsive">
                            <h2>NetBank Purchase History</h2>
                            <asp:GridView ID="GridView1" CssClass="table table-bordered cart-table" runat="server" AllowPaging="True"  AllowSorting="True" 
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <%--<asp:TemplateField HeaderText="Buyer Details" SortExpression="TACuid">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="lblBName" runat="server" Text='<% # Bind("name")%>'></asp:Label><br />
                                                                                    <asp:Label ID="lblBMobile" runat="server" Text='<% # Bind("mobile")%>'></asp:Label><br />
                                                                                    <asp:Label ID="lblBEmail" runat="server" Text='<% # Bind("email")%>'></asp:Label>
                                                                                </ItemTemplate>
                                                                                <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
                                                                            </asp:TemplateField>--%>
                                                                             <asp:TemplateField HeaderText="Purchased Items" >
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="lblPItems" runat="server" Text='<% # Bind("productCode")%>'></asp:Label>
                                                                                </ItemTemplate>
                                                                                <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
                                                                            </asp:TemplateField>  
                                                                            <asp:TemplateField HeaderText="Amount" >
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="lblAmount" runat="server" Text='<% # Bind("Price")%>'></asp:Label>
                                                                                </ItemTemplate>
                                                                                <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" />
                                                                            </asp:TemplateField>                                                                              
