...
public partial class SA_WP_BottomImage : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                CommonFunctions.AlertMessage("Web Picture - Bottom Image successfully uploaded and saved");
            }
            else if (Request.QueryString["qBannerUp"] == "CHANGED")
            {
                CommonFunctions.AlertMessage("Web Picture - Bottom Image  successfully updated");
            }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        objBAL_AccountSettings.WP_Save_Images(objImageUser, Convert.ToInt32(Session["saUserID"]), SelIndustryID, "WP_BOTTOM");
        ...
        Response.Redirect("SA_WP_BottomImage.aspx?qBannerUp=CHANGED");
    ...
    protected void btn_Banner_Logo0_Click(object sender, EventArgs e)
    {
        ...
        if (FU_Banner.HasFile)
        {
            ...
            Response.Redirect("SA_WP_BottomImage.aspx?qBannerUp=TRUE");
