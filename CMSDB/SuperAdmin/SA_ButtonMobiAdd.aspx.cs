...
public partial class SA_ButtonMobiAdd : System.Web.UI.Page
{
    ...
    protected void LoadButtonContent(int vButtonNo, int vAnchorDomainID)
    {
        ...
        {
            ds = objBAL_OwnButton.Retrieve_DefWebButtonInfoBYSA(vButtonNo, vAnchorDomainID,2);
    ...
    protected void FvOwnPage_ItemUpdating(object sender, FormViewUpdateEventArgs e)
    {
       ...
       // bool upStatus = objBAL_OwnButton.Update_OwnButtonData(objTxtLinkName.Text, TA_Editor.Value, Convert.ToInt32(Session["saUserID"]), true, 1, qMenuButtonNo);
        int upStatus = objBAL_OwnButton.Insert_DefWebButtonBySA(SelButtonNo, objtxtButtonName.Text.Trim(), TA_Editor.Value, Convert.ToInt32(HdAnchorDomainId.Value),2);
    ...
    protected void FvOwnPage_ItemInserting(object sender, FormViewInsertEventArgs e)
    {
        if (Page.IsValid)
        {
            ...
            int inStatus = objBAL_OwnButton.Insert_DefWebButtonBySA(SelButtonNo, objtxtButtonName.Text.Trim(), TA_Editor.Value, Convert.ToInt32(objddlCategory.SelectedValue),2);
    ...
    {
        Response.Redirect("SA_ButtonMobiListing.aspx"); 
    }
    ...
    protected void CheckAndRenderPage(int vAnchorDomainId)
    {
        ...
        ds = objBAL_OwnButton.Retrieve_DefWebButtonsByAnchorDomainID(vAnchorDomainId,2); 
