...
public partial class SuperAdmin_SA_EMS_DpeListing : System.Web.UI.Page 
{
    DataSet ds;
    DataView dv;
    ...
    protected void PopulateGrid(string vSortExpr, string vSortDir, string vSearchQuery)
    {
        ...
        ds = objDPE.DPE_GetUserForEMS(vSearchQuery); 
    ...
    {
        Response.Redirect(@"SA_EMS_DpeEmailSetup.aspx?" + e.CommandArgument.ToString());
    }
