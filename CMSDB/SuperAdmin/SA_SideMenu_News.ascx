<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SA_SideMenu_News.ascx.cs" Inherits="SuperAdmin_SA_SideMenu_News" %>
                  ...
                  <tr>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <asp:Image ID="Image2" ImageUrl="~/Images/tb_menuitem.jpg" runat="server" />
                                <asp:HyperLink ID="HyperLink3" CssClass="Links_TopBarMenu" runat="server" NavigateUrl="SA_NewsCreate.aspx">
                            ...
                            <td  width="150px">
                             ...
                             <asp:HyperLink ID="HyperLink1" CssClass="Links_TopBarMenu" runat="server" NavigateUrl="SA_NewsListing.aspx?RtType=USER">
