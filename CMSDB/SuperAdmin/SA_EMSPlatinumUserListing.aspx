<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin/SuperAdminMaster.master" AutoEventWireup="true" CodeFile="SA_EMSPlatinumUserListing.aspx.cs" Inherits="SuperAdmin_SA_EMSPlatinumUserListing" %>
                  ...
                  <tr>
                        ...
                        <td width="60%" align="left" class="subHeaderFontGrad">
                            ...
                            <asp:Literal ID="ltrAllUsersListing" runat="server" 
                                Text="Email System Requests : PLATINUM Users"></asp:Literal></td>
                ...
                <table cellpadding="0" cellspacing="3" class="stdtableBorder_Main" width="100%">
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:GridView ID="gridUsers" runat="server" AutoGenerateColumns="False" DataKeyNames="MobileID"
                            ...
                            <asp:TemplateField HeaderText="Sl No">
                              <ItemTemplate>
                               ...
                               <asp:HiddenField ID="hidMobileID" Value='<%#Bind("MobileID")%>' runat="server" />
                               <asp:HiddenField ID="hidEMSsetup" Value='<%#Eval("EMSsetup")%>' runat="server" />
                              </ItemTemplate>
                              <ItemStyle Width="40px" />
                            </asp:TemplateField>
                            
                            <asp:TemplateField HeaderText="Mobile No." SortExpression="MobileID" >
                              <ItemTemplate>
                                  <asp:Literal ID="ltrMobileLoginID" Text='<%# Eval("MobileID")  %>' runat="server"></asp:Literal>
                              </ItemTemplate>
                             <ItemStyle Width="70px" HorizontalAlign="Left"  />
                              <HeaderStyle HorizontalAlign="Left" />
                             </asp:TemplateField>
                             
                              <asp:TemplateField HeaderText="Member Name<br>Account Type<br>Email" SortExpression="Member_Name" >
                              <ItemTemplate>
                                  <asp:Literal ID="ltrFullName" Text='<%# Eval("Member_Name")  %>' runat="server"></asp:Literal>
                                  <br />
                                  <asp:Label ID="lblACCTYPE" runat="server" CssClass="FontNote" Text='<%# Eval("ACC_TYPE")  %>'></asp:Label>
                                  <br />
