...
public partial class SuperAdmin_SA_EMSPlatinumUserListing : System.Web.UI.Page 
{
    DataSet ds;
    DataView dv;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ViewState["SortExpr"] = "RegisterDate";
    ...
    protected void PopulateGrid(string vSortExpr, string vSortDir, string vSearchQuery)
    {
        ...
        ds = objBAL_MasUser.EMS_GetPlatinumUsers(vSearchQuery); 
    ...
    protected void gridUsers_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        HiddenField objhidMobileID = (HiddenField)gRow.FindControl("hidMobileID");
        HiddenField objhidEMSsetup = (HiddenField)gRow.FindControl("hidEMSsetup");
    ...
    protected void gridUsers_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        else if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            HiddenField objhidMobileID = (HiddenField)e.Row.FindControl("hidMobileID");
            HiddenField objhidEMSsetup = (HiddenField)e.Row.FindControl("hidEMSsetup");
            ...
            if (objhidEMSsetup != null)
            {

                ImageButton objEditEmsButton = (ImageButton)e.Row.FindControl("ImgEditEMS");
                ImageButton objAddEmsButton = (ImageButton)e.Row.FindControl("ImgAddEMS");

                if (objhidEMSsetup.Value == "NOT YET")
                {
                    objAddEmsButton.Visible = true;
                    objEditEmsButton.Visible = false;
                    ...
                    if (objImgAddEMS != null)
                    {
                        ...
                        objImgAddEMS.CommandArgument = "qMobileLoginID=" + objLtrMobileLoginID.Text + "&qFullName=" + objLtrFullName.Text + "&vReturnPage=PEMS";
                    }
                ...
                {
                    objEditEmsButton.Visible = true;
                    objAddEmsButton.Visible = false;

                    ImageButton objImgEditEMS = (ImageButton)e.Row.FindControl("ImgEditEMS");

                    if (objImgEditEMS != null)
                    {
                        objImgEditEMS.CommandArgument = "qMobileLoginID=" + objLtrMobileLoginID.Text + "&vAction=EDIT&vReturnPage=PEMS";
