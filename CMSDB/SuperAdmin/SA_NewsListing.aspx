<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin/SuperAdminMaster.master" AutoEventWireup="true" CodeFile="SA_NewsListing.aspx.cs" Inherits="SuperAdmin_SA_NewsListing" %>
                 ...
                 <table cellpadding="0" cellspacing="0" width="98%" class="tblSubHeader">
                  <tr>
                        ...
                        <td width="60%" align="left" class="subHeaderFontGrad">
                            &nbsp; News Listing</td>
                            <td width="30%" align="right"><uc2:SelectLanguage ID="ucSelectLanguage" 
                                    runat="server" />
                        </td>
                            ...
                            <asp:TemplateField HeaderText="News Title" >
                             ...
                             <asp:TemplateField HeaderText="Priority">
                              ...
                              <EditItemTemplate>
                                  ...
                                  <asp:ImageButton ID="ImgUpdate" CommandName="UPDATE" ToolTip="Update News" runat="server" ImageUrl="~/Images/imgUpdate.gif" />
