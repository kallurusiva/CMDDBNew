<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin/SuperAdminMaster.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="SA_WP_SideImage.aspx.cs" Inherits="SA_WP_SideImage" %>
                ...
                <table cellpadding="0" cellspacing="3" class="stdtableBorder_Main" width="98%">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:TemplateField HeaderText="Side Banner">
                              <ItemTemplate>
                               <%--<asp:Image ID="ImgBanner" ImageUrl='<%# Bind("FullImgPath")%>' Width="100" Height="100" runat="server" />--%>
