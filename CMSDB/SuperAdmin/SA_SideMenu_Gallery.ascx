<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SA_SideMenu_Gallery.ascx.cs" Inherits="SA_SideMenu_Gallery" %>
                 ...
                 <table cellpadding="0" cellspacing="0" width="96%" >
                  <tr>
                        ...
                        <td width="22%" align="left" class="subHeaderMenuFontGrad tblTopBarSub" >
                            <asp:Literal ID="Literal2" runat="server" Text="Gallery"></asp:Literal> 
                             </td>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <asp:Image ID="Image2" ImageUrl="~/Images/tb_menuitem.jpg" runat="server" />
                                <asp:HyperLink ID="HyperLink3" CssClass="Links_TopBarMenu" runat="server" NavigateUrl="~/SuperAdmin/SA_Gallery_UploadImages.aspx">
                                <asp:Literal ID="LtrAddImages" runat="server" Text="Add Images"></asp:Literal>&nbsp;   
                                </asp:HyperLink>
                            ...
                            <td  width="150px">
                             ...
                             <asp:HyperLink ID="HyperLink1" CssClass="Links_TopBarMenu" runat="server" NavigateUrl="~/SuperAdmin/SA_Gallery_ListImages.aspx">
                              <asp:Literal ID="LtrListImages" runat="server" Text="View Images"></asp:Literal>&nbsp;
                             </asp:HyperLink>
                            ...
                            <td  width="150px">
                             ...
                             <asp:HyperLink ID="HyperLink2" CssClass="Links_TopBarMenu" runat="server" NavigateUrl="~/SuperAdmin/SA_Gallery_UploadVideos.aspx">
                              <asp:Literal ID="Literal1" runat="server" Text="Add Videos"></asp:Literal>&nbsp;
                             </asp:HyperLink>
                            ...
                            <td  width="150px">
                             ...
                             <asp:HyperLink ID="HyperLink4" CssClass="Links_TopBarMenu" runat="server" NavigateUrl="~/SuperAdmin/SA_Gallery_ListVideos.aspx">
                              <asp:Literal ID="Literal3" runat="server" Text="View Videos"></asp:Literal>&nbsp;
                             </asp:HyperLink>
