...
public partial class SuperAdmin_SA_SystemNewsListing : System.Web.UI.Page 
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["LgType"] != null && Request.QueryString["LgType"] != "")
        {
        ...
        if (!IsPostBack)
        {
            ...
            ViewState["SortExpr"] = "CreatedDate desc,LgType";
    ...
    protected void PopulateGrid(string vSortExpr, string vSortDir)
    {
        ...
        strSQL = "EXEC usp_SystemNews_Retrieve_ByUserID " + Convert.ToInt32(Session["saUserID"]) + "," + qLgType;
    ...
    protected void gridSystemNews_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        Literal ltrSysNewsID = (Literal)gvRow.FindControl("hdSnId");

        int SysIdToDelete = Convert.ToInt32(ltrSysNewsID.Text);
        ...
        {
            dbConn.Open();
            strSQL = "Update tblSystemNews set Deleted = 1 where UserID = " + Convert.ToInt32(Session["saUserID"]) + " and snID =" + SysIdToDelete;
            dbCmd = new SqlCommand(strSQL, dbConn);
    ...
    protected void gridSystemNews_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        objNews.NewsUserID = Convert.ToInt32(Session["saUserID"]);

        string tmpSysContent = tbSysContent.Text;
        //tmpSysContent = tmpSysContent.ToString().Replace(Environment.NewLine, "<br/>");
        tmpSysContent = CommonFunctions.HandleNewLines(tmpSysContent, Request.UserAgent);
        ...
        //strSQL = "EXEC [usp_SystemNews_Update_ByUserID] '" + tbSysSubject.Text + "','" + tmpSysContent + "'," + Convert.ToInt32(Session["saUserID"]) + "," + Convert.ToInt16(chkActive.Checked) + "," + objHidLgType.Value + "," + ltrSnID.Text;
       //dbConn = new SqlConnection(GlobalVar.GetDbConnString);
