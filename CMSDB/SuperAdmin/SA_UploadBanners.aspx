<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin/SuperAdminMaster.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="SA_UploadBanners.aspx.cs" Inherits="SA_UploadBanners" %>
                                ...
                                <tr>
                                 ...
                                 <td align="left">
                                    <%-- <asp:ImageButton ImageUrl='' ID='imgDelete' OnClick='imgDelete_Click' ToolTip='Delete logo' AccessKey='' runat='server'/>--%>
                                     <asp:Button ID="btnUploadBanner" Visible="false" CssClass="stdbuttonCRUD" runat="server" 
                                         Text="Upload Banner" onclick="Button1_Click" />
                                    </td>
                                </tr>
