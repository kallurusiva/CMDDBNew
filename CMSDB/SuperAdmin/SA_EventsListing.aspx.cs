...
public partial class SuperAdmin_SA_EventsListing : System.Web.UI.Page 
{
    ...
    protected void PopulateGrid(string vSortExpr, string vSortDir)
    {
        ...
        ds = objBAL_Events.RetrieveAllEvents_ByUserID(Convert.ToInt32(Session["saUserID"]), ViewState["RtType"].ToString(), qLgType);
    ...
    protected void gridEvents_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        bool delStatus = objBAL_Events.DeleteEventsData(Convert.ToInt32(Session["saUserID"]), EventIdToDelte);
    ...
    protected void gridEvents_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        string tmpEvntContent = tbEventContent.Text;
        //tmpEvntContent = tmpEvntContent.ToString().Replace("\n", Environment.NewLine);
        ...
        objEvents.EventContent = tmpEvntContent.ToString();
        ...
        int upLgType = 0;
        if (objHidLgType == null)
            upLgType = Convert.ToInt16(objHidLgType.Value);
        ...
        if (Convert.ToInt16(objHidUserType.Value) == 2)
        {
            ...
            bool tmpStatus = objBAL_CommonFunc.InsertUpdate_ShowAdminItems("tblEvents",ltrEventID.Text, Convert.ToInt32(Session["saUserID"]));
          
        }

        upStatus = objBAL_Events.UpdateEventsData(objEvents, chkActive.Checked, upLgType);
    ...
    protected void gridEvents_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        else if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            //objChkSelect.Attributes.Add("onClick", "SelectRow('" + objChkSelect.ClientID + "')");
                ...
                //onclick="javascript:NewCssCal('<%=txtEvtTOdate.ClientID%>','ddmmyyyy','ARROW',true);"
    ...
    protected void btnPrt_UP_Click(object sender, EventArgs e)
    {
        ...
        if (PrevRowIndex >= 0)
        {
            ...
            if (objLtr_CurrPriority != null)
            {
                ...
                int upStatus = objBAL_CommonFunc.ChangePriorityOrder("tblEvents", "EventID", "IX_Events_Priority", CurrPriority, CurrFaqID, PrevPriority, PrevFaqID, Session["saUserID"].ToString());
    ...
    protected void btnPrt_DOWN_Click(object sender, EventArgs e)
    {
        ...
        if (NextRowIndex < MaxRows)
        {
            ...
            if (objLtr_CurrPriority != null)
            {
                ...
                int upStatus = objBAL_CommonFunc.ChangePriorityOrder("tblEvents", "EventID", "IX_Events_Priority", CurrPriority, CurrFaqID, NextPriority, NextFaqID, Session["saUserID"].ToString());
    ...
    //    if (strEventIDs != string.Empty)
    //    {
    //        bool delMulStatus = objBAL_Events.DeleteEventsData_Multiple(Convert.ToInt32(Session["saUserID"]), strEventIDs);
