<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin/SuperAdminMaster.master" AutoEventWireup="true" CodeFile="SA_EMS_EbookEmailSetup.aspx.cs" Inherits="SA_EMS_EbookEmailSetup" %>
                            ...
                            <table class="style1" id="tblButtonInfo">
                                ...
                                <tr>
                                    ...
                                    <td class="tblFormText1" width="75%">
                                        <asp:TextBox ID="txtFullName" runat="server"  Text='<%# Bind("MemberName") %>' CssClass="stdTextField1_disabled" 
                                ...
                                <tr>
                                    <td class="tblFormLabel1" width="25%">
                                        Mobile Number :</td>
                                    <td class="tblFormText1" width="75%">
                                        <asp:TextBox ID="txtMobileNo" runat="server" CssClass="stdTextField1_disabled"  Text='<%# Bind("MobileLoginId") %>'
                                            Width="300px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="tblFormLabel1" width="25%">
                                        SubDomain :</td>
                                    <td class="tblFormText1" width="75%">
                                        <asp:TextBox ID="txtSubDomain" runat="server" Text='<%# Bind("SubDomain") %>'
                                ...
                                <tr>
                                    ...
                                    <td class="tblFormText1">
                                        <asp:TextBox ID="txtOwnDomain" Text='<%# Bind("Owndomain") %>' runat="server" CssClass="stdTextField1_disabled" 
                                            Width="300px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <table class="style1" id="tblButtonInfo">
                                ...
                                <tr>
                                    <td class="tblFormLabel1" width="25%">
                                        Mobile Number :</td>
                                    <td class="tblFormText1" width="75%">
                                        <asp:TextBox ID="txtMobileNo" runat="server" Text='<%# Bind("MobileLoginID") %>' CssClass="stdTextField1_disabled" 
                                            Width="300px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="tblFormText1" width="75%">
                                        <asp:TextBox ID="txtSubDomain" runat="server" 
                                            CssClass="stdTextField1_disabled" Text='<%# Bind("SubDomain") %>' Width="300px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="tblFormLabel1">
                                        OwnDomain :</td>
                                    <td class="tblFormText1">
                                        <asp:TextBox ID="txtOwnDomain" runat="server" Text='<%# Bind("owndomain") %>' CssClass="stdTextField1_disabled" 
                                            Width="300px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
