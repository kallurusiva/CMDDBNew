...
public partial class SA_EMSContentAdd : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            LoadMobileUserDetails(qMobileLoginID);
            LoadEMSContent(vSearchStr);
    ...
    protected void LoadMobileUserDetails(string vMobileLoginId)
    {
        string SearchStr = "Where MobileLoginID = '" + vMobileLoginId + "'";
        ...
        {
              ViewState["vSubDomain"]= URow["SubDomain"].ToString();
    ...
    protected void LoadEMSContent(string vSearchStr)
    {
    ...
    protected void FvEMS_ModeChanging(object sender, FormViewModeEventArgs e)
    {
        ...
        LoadEMSContent(ViewState["vSearchStr"].ToString()); 
    }
    ...
    protected void FvEMS_ItemUpdating(object sender, FormViewUpdateEventArgs e)
    {
      ...
      //  int upStatus = objBAL_OwnButton.Insert_DefWebButtonBySA(SelButtonNo, objtxtButtonName.Text.Trim(), TA_Editor.Value, Convert.ToInt32(HdAnchorDomainId.Value),1);
        ...
        int upStatus = objBAL_Gems.InsertUpdate_EMSContent(objtxtAdmLoginID.Text, objtxtAdmPassword.Text, objtxtEnquiryID.Text, objtxtEnquiryPwd.Text, objtxttxtHttpURLlink.Text, Convert.ToInt64(ViewState["qMobileLoginID"].ToString())); 
    ...
    protected void btnBackToListing_Click(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["vReturnPage"].ToString() == "PEMS")
            Response.Redirect("SA_EMSPlatinumUserListing.aspx");
        else
            Response.Redirect("SA_EMSUserListing.aspx"); 
    }
