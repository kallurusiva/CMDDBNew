<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin/SuperAdminMaster.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="SA_WP_BottomImage.aspx.cs" Inherits="SA_WP_BottomImage" %>

<%@ Register src="SA_SideMenu_WebPictures.ascx" tagname="SA_SideMenu_WebPictures" tagprefix="uc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentLeftMenu" Runat="Server">
    <uc1:SA_SideMenu_WebPictures ID="SA_SideMenu_WebPictures1" runat="server" />
</asp:Content>
        ...
        <table border="0" cellpadding="0" cellspacing="2" width="100%" class="stdtableBorder_Search ContentBkg">
                                ...
                                <tr height="35px">
                                    ...
                                    <td width="2%">
                                        &nbsp;</td>
                                    <td align="left" width="75%">
                                          <asp:DropDownList ID="ddlCategorySave" runat="server" CssClass="stdDropDown" 
                                            Width="209px">
                                            </asp:DropDownList>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td align="left" class="HelpInputCss">
                                        ...
                                        <asp:Literal ID="Literal5" runat="server" 
                                            ...
                                            Text="[ For better Page Settings and presentation, &lt;br&gt; please upload image with size &lt;= (width=820 &amp; height=200) image."></asp:Literal>
                                    </td>
                                </tr>
                            </table>
        </td></tr>
                 ...
                 <table cellpadding="0" cellspacing="0" width="98%" class="tblSubHeader">
                  <tr>
                        ...
                        <asp:Literal ID="ltrHeading" runat="server" 
                                Text="WebBanner Settings"></asp:Literal>
                                &nbsp;- Bottom Banner</td>
                        <td width="30%">
                ...
                <table cellpadding="0" cellspacing="3" class="stdtableBorder_Main" width="98%">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:TemplateField HeaderText="Bottom Banner">
                              <ItemTemplate>
                               <%--<asp:Image ID="ImgBanner" ImageUrl='<%# Bind("FullImgPath")%>' Width="100" Height="100" runat="server" />--%>
