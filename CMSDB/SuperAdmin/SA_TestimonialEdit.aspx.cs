...
public partial class SuperAdmin_SA_TestimonialEdit : System.Web.UI.Page 
{
    ...
    protected void LoadData()
    {
        ...
        if (qryTestimonialID != 0)
        {
            ...
            dt = objBAL_Testimonial.RetrieveAllTestimonials_ByTestimonialID(Convert.ToInt32(Session["saUserID"]), qryTestimonialID);
    ...
    protected void btnCancel_Click(object sender, EventArgs e)
    {
        ...
        Server.Transfer("SA_TestimonialListing.aspx?LgType=" + qLgType);
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
       ...
       // int inStatus = objBAL_Testimonial.InsertTestimonial(objTestimonial, Convert.ToInt32(Session["saUserID"]), objMyImage);

        int upStatus = objBAL_Testimonial.UpdateTestimonialsData(objTestimonial, Convert.ToInt32(Session["saUserID"]), objMyImage, chkActive.Checked);
        ...
        if (upStatus >= 1)
        {
            ...
            Response.Redirect("SA_TestimonialListing.aspx?LgType=" + qLgType);
            return;
