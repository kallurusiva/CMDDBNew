<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin/SuperAdminMaster.master" AutoEventWireup="true" CodeFile="SA_AdsUserListing.aspx.cs" Inherits="SuperAdmin_SA_AdsUserListing" %>
                ...
                <table cellpadding="0" cellspacing="3" class="stdtableBorder_Main" width="100%">
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:TemplateField HeaderText="Mobile No." SortExpression="MobileLoginID" >
                              <ItemTemplate>
                                  <asp:Literal ID="ltrMobileLoginID" Text='<%# Eval("MobileLoginID")  %>' runat="server"></asp:Literal>
                              </ItemTemplate>
                             ...
                             <ItemStyle Width="100px" HorizontalAlign="Left"  />
                              ...
                              <ItemTemplate>
                                  <asp:ImageButton id="ImgAddAdSense" ToolTip="Add Google AdSense" runat="server" ImageUrl="~/Images/AddGAdSense.png" OnCommand="AddGAdSense_Click"/>
