...
public partial class SuperAdmin_SA_EMSeBookUserListing : System.Web.UI.Page 
{
    DataSet ds;
    DataView dv;
    ...
    protected void PopulateGrid(string vSortExpr, string vSortDir, string vSearchQuery)
    {
        ...
        ds = objEbook.EMS_GetEbookUsers(vSearchQuery); 
            ...
            if (objhidEMSsetup != null)
            {
                ...
                if (objhidEMSsetup.Value == "NOT YET")
                {
                    ...
                    if (objImgAddEMS != null)
                    {
                        ...
                        objImgAddEMS.CommandArgument = "qMobileLoginID=" + objLtrMobileLoginID.Text;
                    }
    ...
    {
        Response.Redirect(@"SA_EMS_EbookEmailSetup.aspx?" + e.CommandArgument.ToString());
    }
