<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SA_SideMenu_INFO.ascx.cs" Inherits="SuperAdmin_SA_SideMenu_INFO" %>
                 ...
                 <table cellpadding="0" cellspacing="0" width="96%" >
                  <tr>
                        ...
                        <td width="22%" align="left" class="subHeaderMenuFontGrad tblTopBarSub" >
                            <asp:Literal ID="LtrManageProducts" runat="server" Text="Manage INFO"></asp:Literal> 
                             </td>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <asp:Image ID="Image2" ImageUrl="~/Images/tb_menuitem.jpg" runat="server" />
                                <asp:HyperLink ID="HypInfoCreate" CssClass="Links_TopBarMenu" runat="server" NavigateUrl="~/SuperAdmin/SA_INFOcreate.aspx">
                                <asp:Literal ID="LtrAddProduct" runat="server" Text="Add New INFO item"></asp:Literal>&nbsp;   
                                </asp:HyperLink>
                            ...
                            <td  width="150px">
                             ...
                             <asp:HyperLink ID="HypINFOList" CssClass="Links_TopBarMenu" runat="server" NavigateUrl="~/SuperAdmin/SA_INFOListing.aspx">
                              <asp:Literal ID="LtrMyProducts" runat="server" Text="INFO List"></asp:Literal>&nbsp;
                             </asp:HyperLink>
