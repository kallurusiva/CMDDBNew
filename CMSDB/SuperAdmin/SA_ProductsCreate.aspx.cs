...
public partial class SuperAdmin_SA_TProductsCreate : System.Web.UI.Page 
{
    ...
    protected void btnCancel_Click(object sender, EventArgs e)
    {
        ...
        Server.Transfer("SA_ProductListing.aspx");
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        objProducts.ProductType = Convert.ToInt16(GlobalVar.ProductTypes.Product);
        ...
        if (inStatus >= 1)
        {
            ...
            Response.Redirect("SA_ProductListing.aspx?LgType=" + mSelLanguage);
