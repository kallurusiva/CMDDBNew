<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin/SuperAdminMaster.master" AutoEventWireup="true" CodeFile="SA_Gallery_UploadVideos.aspx.cs" Inherits="SA_Gallery_UploadVideos" %>
            ...
            <td align="center">
              ...
              <tr>
                  ...
                  <td class="tblFormText1Help" width="80%" align="left" >
                      Copy and Paste the Youtube Link</td>
              ...
              <tr>
                  ...
                  <td class="tblFormLabel1" align="right">Insert Video Link :</td>
...
&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                          ControlToValidate="txtVideoLink" CssClass="font_11Msg_Error" Display="Dynamic"
                          ErrorMessage=" Video Link cannot be empty." ValidationGroup="vgCheck"></asp:RequiredFieldValidator>
                  &nbsp;    
                   </td>
              ...
              <tr>
                  ...
                  <td class="tblFormText1Help" align="left">
                      Enter suitable video&nbsp; title [ max 100 chars only]</td>
              ...
              <tr>
                  ...
                  <td class="tblFormText1" align="left">
                      <asp:TextBox ID="txtVideoTitle" runat="server" MaxLength="100" CssClass="stdTextField2" 
                          ValidationGroup="vgCheck"></asp:TextBox>
              ...
              <tr>
                  ...
                  <td class="tblFormText1" align="left">
                      <asp:DropDownList ID="ddlCategory" runat="server" CssClass="stdDropDown" 
                          Width="209px" ValidationGroup="vgCheck">
                      </asp:DropDownList>
              ...
              <tr>
                  ...
                  <td class="tblFormLabel1" align="right">&nbsp;</td>
                  <td class="tblFormText1" align="left">
                      <asp:Button ID="btnSaveVideo" runat="server" CssClass="stdbuttonCRUD" 
                          Text="Save Video" onclick="btnSaveVideo_Click" ValidationGroup="vgCheck" />
                  </td>
