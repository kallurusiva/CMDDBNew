<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin/SuperAdminMaster.master" AutoEventWireup="true" CodeFile="SA_Gallery_ListVideos.aspx.cs" Inherits="SA_Gallery_ListVideos" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentBody" Runat="Server">
    <script language="javascript" type="text/javascript">
        ...
        function fnDeleteVideo(VID) {
            //alert(imgID);
            if (confirm('Are you sure to Delete the Video')) {
                location.href = 'SA_Gallery_ListVideos.aspx?VideoToDelete=' + VID;
            }

        }

        function fnEditVideo(VID) {
            //alert(imgID);
            location.href = 'SA_Gallery_ListVideos.aspx?VideoToEdit=' + VID;
                        ...
                        <td>
                            <asp:DataList ID="DLImageGallery" runat="server" RepeatColumns="4" 
                                ...
                                onitemdatabound="DLImageGallery_ItemDataBound">
                                 ...
                                 <ItemTemplate>
                                     <asp:HiddenField ID="hidVidTitle" Value='<%# Eval("VideoTitle")%>' runat="server" />
                                     <asp:HiddenField ID="hidVidLink" Value='<%# Eval("VideoLink")%>' runat="server" />
                                      <asp:HiddenField ID="hidVidActive" Value='<%# Eval("Active")%>' runat="server" />
                                     
                                  <%--  <table cellpadding = "5px" cellspacing = "0" class="dlTable">
                                    <tr>
                                        <td>--%>
                                        <div id="dvgiImage" class="dvgiImages" runat="server"> 
                                            <%--<asp:Image ID="Image1" runat="server" CssClass="giImage" ImageUrl = '<%# Eval("VideoLink")%>'       --%>   
                                            <asp:Literal ID="LtrYouTubeInfo" runat="server"></asp:Literal>   
                                            <iframe id='ifrYouTube' width='250' height='250' src='' frameborder='0' allowfullscreen runat='server'></iframe>          
                                            <br />
                                    ...
                                    <%--    <div id="dvgiImageInfo" class="dvgiImageInfo">
                                        ...
                                        <div id="dvgiImageInfo" class="dvgVideoInfoSA">
                                        <table border="0" cellpadding="1" cellspacing="1">
                                            <tr>
                                            <td class="gilblFontHeader" align="left">Title : </td>
                                            <td align="left"><asp:Label ID="lblVidTitle" CssClass="gilblFont" runat="server" Text=""></asp:Label></td>
                                            </tr>
                                            <tr>
                                            <td class="gilblFontHeader" align="left">Link : </td>
                                            <td align="left"><asp:Label ID="lblVidLink" CssClass="giurlFont" runat="server" Text=""></asp:Label></td>
                                            </tr>
                                             <tr>
                                            <td class="gilblFontHeader" align="left" valign="top">Embed : </td>
                                            <td align="left">&nbsp;
                                                <asp:TextBox ID="txtEmbedLink" TextMode="MultiLine" ToolTip="Copy and Paste the Embed Link" CssClass="giTextEmbed" runat="server"></asp:TextBox>
                                            </td>
                                            </tr>
                                            <tr>
                                            <td>&nbsp;</td>
                                            <td align="left">
                                                <img src="../Images/image_edit.png" class="showCursor" alt='Edit Video Details' title='Edit Video Details' onclick='fnEditVideo(<%# Eval("VideoID")%>)' />
                                                &nbsp; &nbsp;
                                                <img src="../Images/image_remove.png" class="showCursor" alt='Delete Video' title='Delete Video' onclick='fnDeleteVideo(<%# Eval("VideoID")%>)' />
                                                &nbsp; &nbsp;
                                                <img src="../Images/image_NotActive.png" id="imgNotActive" runat="server" class="showCursor" alt='Video Not Displayed at Website' title='Video Not Displayed at Website' />
                                            </td></tr>
                                        </table>
                                        </div>
