<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin/SuperAdminMaster.master" AutoEventWireup="true" CodeFile="SA_SpButtonWebAdd.aspx.cs" Inherits="SA_SpButtonWebAdd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentLeftMenu" Runat="Server">
    <uc2:SA_SideMenu_WebButtons ID="SA_SideMenu_WebButtons1" runat="server" />
</asp:Content>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
        ...
        <tr>
           ...
           <table cellpadding="0" cellspacing="3" id="tblPlan" class="stdtableBorder_Main" width="98%" runat="server">
            ...
            <tr><td>
                <asp:FormView ID="FvSpButton" runat="server"
                 GridLines="Vertical" Width="100%" onmodechanging="FvSpButton_ModeChanging" 
                    ondatabound="FvSpButton_DataBound" 
                    oniteminserting="FvSpButton_ItemInserting" 
                    onitemupdating="FvSpButton_ItemUpdating"
                >
               <ItemTemplate>
                            ...
                            <table class="style1" id="tblButtonInfo">
                                ...
                                <tr>
                                    <td class="tblFormLabel1" width="25%">
                                        Display Status at Website:</td>
                                    <td class="tblFormText1" width="75%">
                                        <asp:Image ID="ImgActive" runat="server" />
                                        <asp:Label ID="lblShowHide" CssClass="font_stdupdateMsg" runat="server" Text=""></asp:Label>
                                        <asp:HiddenField ID="hidActive" Value='<%# Bind("Active") %>' runat="server" />
                                        <asp:HiddenField ID="hidGAdsPosition" Value='<%# Bind("GAdsPosition") %>' runat="server" />
                                        <%--<asp:CheckBox ID="chkShowHide" Checked='<%# Bind("Active") %>' runat="server" />--%>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="tblFormLabel1" width="25%">
                                        Google AdSense Shown at :</td>
                                    <td class="tblFormText1" width="75%">
                                        <asp:RadioButtonList ID="RdoBtnShowPosition" runat="server" 
                                            CssClass="font_12Normal" RepeatDirection="Horizontal">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <table class="style1" id="tblButtonInfo">
                                ...
                                <tr>
                                    <td class="tblFormLabel1" width="25%">
                                        Show Google AdSense at :</td>
                                    <td class="tblFormText1" width="75%">
                                        <asp:RadioButtonList ID="RdoBtnShownPosition" runat="server" 
                                            CssClass="font_12Normal" RepeatDirection="Horizontal">
                                            <asp:ListItem  Value="1">TOP</asp:ListItem>
                                            <asp:ListItem  Value="2">BOTTOM</asp:ListItem>
                                        </asp:RadioButtonList>
...
<script type="text/javascript" language="javascript">
    ...
    var FormViewMode = '<%=FvSpButton.CurrentMode.ToString() %>';
    //alert(FormViewMode);
    ...
    if (FormViewMode == 'ReadOnly') {
        ...
        var vEditor = document.getElementById('<%=FvSpButton.FindControl("myEditor").ClientID%>');
