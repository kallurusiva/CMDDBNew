...
public partial class SuperAdmin_SA_AboutUsPage : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ltrAboutUsPage.Text = Resources.LangResources.AboutUs;
    ...
    protected void LoadAboutUsDetails(int vLanguage)
    {
        ...
        strSQL = "Select top 1 Description,UserID,LgType from tblAboutUs where UserID = " + Convert.ToInt32(Session["saUserID"]) + " and LgType = " + vLanguage;
        ...
        {
            tmpWpDescription = "<br/> No description for About Us  Page has been added yet. <br/> To Create, click on the Add AboutUs Description";
        }
    ...
    protected void BtnSave_Click(object sender, EventArgs e)
    {
        ...
        strSQL = "EXEC usp_AboutUsPage_InsertUpdate N'" + tmpDescription + "'," + Convert.ToUInt32(Session["saUserID"]) + "," + mSelLanguage + ",1"; 
        dbCmd = new SqlCommand(strSQL, dbConn);
