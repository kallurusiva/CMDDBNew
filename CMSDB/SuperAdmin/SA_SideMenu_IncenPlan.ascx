<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SA_SideMenu_IncenPlan.ascx.cs" Inherits="SuperAdmin_SA_SideMenu_IncenPlan" %>
                 ...
                 <table cellpadding="0" cellspacing="0" width="96%" >
                  <tr>
                        ...
                        <td width="22%" align="left" class="subHeaderMenuFontGrad tblTopBarSub" >
                            <asp:Literal ID="ltrIncentivePlan" runat="server" Text=""></asp:Literal> 
                             </td>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <asp:Image ID="Image2" ImageUrl="~/Images/tb_menuitem.jpg" runat="server" />
                                <asp:HyperLink ID="Hyp_IncPlanCreate" Text="" CssClass="Links_TopBarMenu" runat="server" NavigateUrl="SA_IncentivePlanCreate.aspx">
                                </asp:HyperLink>
                            ...
                            <td  width="180px">
                             ...
                             <asp:HyperLink ID="Hyp_IncPlanListing" Text="" CssClass="Links_TopBarMenu" runat="server" NavigateUrl="SA_IncentivePlanListing.aspx?RtType=USER">
