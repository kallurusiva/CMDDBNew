<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin/SuperAdminMaster.master" AutoEventWireup="true" CodeFile="SA_EMS_DPEEmailSetup.aspx.cs" Inherits="SA_EMS_DPEEmailSetup" %>
                            ...
                            <table class="style1" id="tblButtonInfo">
                                ...
                                <tr>
                                    ...
                                    <td class="tblFormText1" width="75%">
                                        <asp:TextBox ID="txtFullName" runat="server"  Text='<%# Bind("dpFullName") %>' CssClass="stdTextField1_disabled" 
                                ...
                                <tr>
                                    <td class="tblFormLabel1" width="25%">
                                        Mobile Number :</td>
                                    <td class="tblFormText1" width="75%">
                                        <asp:TextBox ID="txtMobileNo" runat="server" CssClass="stdTextField1_disabled"  Text='<%# Bind("TopUpMobile") %>'
                                            Width="300px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <table class="style1" id="tblButtonInfo">
                                ...
                                <tr>
                                    <td class="tblFormLabel1" width="25%">
                                        Mobile Number :</td>
                                    <td class="tblFormText1" width="75%">
                                        <asp:TextBox ID="txtMobileNo" runat="server" Text='<%# Bind("topUpMobile") %>' CssClass="stdTextField1_disabled" 
                                            Width="300px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
