...
public partial class SuperAdmin_SA_AdsUserListing : System.Web.UI.Page 
{
    DataSet ds;
    DataView dv;
    ...
    protected void gridUsers_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        else if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            ImageButton objImgAdSense = (ImageButton)e.Row.FindControl("ImgAddAdSense");

            if (objImgAdSense != null)
            {
                ...
                objImgAdSense.CommandArgument = "Ads4UID=" + hd_UserId.Value + "&qMobileLoginID=" + objLtrMobileLoginID.Text + "&qFullName=" + objLtrFullName.Text; 
    ...
    protected void AddGAdSense_Click(object sender, CommandEventArgs e)
    {
        Response.Redirect(@"SA_AdSenseContentAdd.aspx?" + e.CommandArgument.ToString());
    }
