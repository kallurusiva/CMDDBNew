<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin/SuperAdminMaster.master" AutoEventWireup="true" CodeFile="SA_AllUsersListing.aspx.cs" Inherits="SuperAdmin_SA_AllUsersListing" %>
                 ...
                 <table cellpadding="0" cellspacing="0" width="100%" class="tblSubHeader">
                  <tr>
                        ...
                        <td width="60%" align="left" class="subHeaderFontGrad">
                            &nbsp; 
                            <asp:Literal ID="ltrAllUsersListing" runat="server" Text="All Users Listing"></asp:Literal></td>
                ...
                <table cellpadding="0" cellspacing="3" class="stdtableBorder_Main" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td class="SearchLabel" style="width:150px;" align="left">
                                        <asp:DropDownList ID="ddlSearchParam" CssClass="stdDropDown1" runat="server"                                             
                                            >
                                            <asp:ListItem Value="LoginID">WebLoginID</asp:ListItem>
                                            <asp:ListItem Value="U.Owndomain">Own Domain</asp:ListItem>
                                            <asp:ListItem Value="U.Subdomain">Sub Domain</asp:ListItem>
                                            <asp:ListItem Value="CompanyName">CompanyName</asp:ListItem>
                                            <asp:ListItem Value="FullName">Name</asp:ListItem>
                                            <asp:ListItem Value="UD.Email">Email</asp:ListItem>
                                            <asp:ListItem Value="MobileLoginID">MobileLoginID</asp:ListItem>
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:TemplateField HeaderText="Hitech <br/>Logins" SortExpression="LoginID" >
                              <ItemTemplate>
                              <%-- <asp:Label ID="lblLoginName" runat="server" Text='<%# Eval("LoginID")  %>'/>
                               <br />--%>
                               <asp:Label ID="lblMobileLoginID" CssClass="font_Content" runat="server" Text='<%# Eval("MobileLoginID")  %>'/>
                               <br />
                              <asp:Label ID="lblLoginPassword" CssClass="FontNote" runat="server" Text='<%# Eval("Password")  %>'/>
                                  <br />
                              <%--<asp:Literal ID="ltrWebDomainType" Text='<%# Eval("Acc_Type")  %>' runat="server"></asp:Literal>--%>
                              <asp:Label ID="ltrWebDomainType" CssClass="font_11Msg_Error" runat="server" Text='<%# Eval("Acc_Type")  %>'/>
                              <asp:HiddenField ID="hidDomainType" Value='<%#Eval("UserDomainType")%>' runat="server" />
                              </ItemTemplate>
                             <ItemStyle Width="100px" HorizontalAlign="Left"  />
                                <HeaderStyle HorizontalAlign="Left" />
                             </asp:TemplateField>
                             
                            <asp:TemplateField HeaderText="WebPortal<br/>Logins" SortExpression="LoginID" >
                              <ItemTemplate>
                               
                                  <asp:Label ID="lblWpLogin" runat="server" CssClass="font_Content" Text='<%# Eval("LoginID")  %>'/>
                                  <br />
                                  <asp:Label ID="lblWpPassword"  CssClass="FontNote" runat="server" Text='<%# Eval("LoginPassword")  %>'/>
                              </ItemTemplate>
                             <ItemStyle Width="100px" HorizontalAlign="Left"  />
                             </asp:TemplateField>
                             
                              <%--<asp:TemplateField HeaderText="WebDomain<br/>Type" SortExpression="UserDomainType" >
                              <ItemTemplate>
                                  <asp:Literal ID="ltrWebDomainType" Text='<%# Eval("Acc_Type")  %>' runat="server"></asp:Literal>
                             ...
                             <asp:TemplateField HeaderText="Sub Domain<br/>URL" SortExpression="OwnDomain" >
                              <ItemTemplate>
                             ...
                             <ItemStyle Width="70px" HorizontalAlign="Left"  />
                               ...
                               <asp:TemplateField HeaderText="Full Name<br>CompanyName<br>Email" SortExpression="CompanyName" >
                              <ItemTemplate>
                                  <asp:Literal ID="ltrFullName" Text='<%# Eval("FullName")  %>' runat="server"></asp:Literal>
                                  <br />
                                   <asp:Label ID="ltrCompanyName" CssClass="font_Content" runat="server" Text='<%# Eval("CompanyName")  %>'/>
                                  <br />
                                   <asp:Label ID="ltrEmail" CssClass="font_Content" runat="server" Text='<%# Eval("Email")  %>'/>
                              </ItemTemplate>
                             <ItemStyle Width="100px" HorizontalAlign="Left"  />
                                    <HeaderStyle HorizontalAlign="Left" />
                             </asp:TemplateField>
                           ...
                           <%--  <asp:TemplateField HeaderText="Name" SortExpression="FullName" >
                            ...
                            <asp:TemplateField HeaderText="Activated" SortExpression="ActivatedStatus" >
                             ...
                             --%>
                              ...
                              <ItemTemplate>
                                  <asp:ImageButton ID="ImgAddDomain" ToolTip="Add Domain" runat="server" ImageUrl="~/Images/btn_AddDomain.gif" />
                                  <asp:ImageButton ID="ImgEdit" CommandName="EDIT" ToolTip="Edit User" runat="server" ImageUrl="~/Images/imgEdit2.gif" />
