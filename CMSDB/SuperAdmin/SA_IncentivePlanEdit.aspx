<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin/SuperAdminMaster.master" AutoEventWireup="true" CodeFile="SA_IncentivePlanEdit.aspx.cs" Inherits="SuperAdmin_SA_IncentivePlanEdit" %>
            ...
            <td align="center">
                <table cellpadding="0" cellspacing="3" id="tblPlan" class="stdtableBorder_Main" width="98%" runat="server">
                    ...
                    <tr>
                        ...
                        <td align="left">
                        Select Language : &nbsp; 
                            <asp:DropDownList ID="ddlLanguage" CssClass="stdDropDown1" Enabled="false" AutoPostBack="true" runat="server">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            ...
                            <asp:Button ID="BtnUpdate" runat="server" 
                                Text="UPDATE Incentive Plan" onclick="BtnUpdate_Click" />
                        </td>
                        <td>
                            &nbsp;</td>
