<%@ Page Title="" Language="C#" MasterPageFile="~/UserEbookMaster.master" AutoEventWireup="true" CodeFile="eBookShowDetails.aspx.cs" Inherits="eBookShowDetails" %>
                                          ...
                                          <div id="dvBookPurchaseFormat" class="CssdvBookPurchase" style="margin-left: 3px;" runat="server" visible="false">
                                            ...
                                            <table id="tblPurchase" runat="server" border="0">
                                                ...
                                                <tr><td class="Purchase_format">  
                                                 ...
                                                 <tr><td align="right" class="Purchase_send">&nbsp;<asp:Literal ID="Literal12" Text="<%$ Resources:LangResources, SendTo %>" runat="server"></asp:Literal> </br></br> </td></tr>
                                                <tr><td align="left">
                                             ...
                                             <table id="tblFreeEbooksPurchase" runat="server" border="0" visible="false">
                                               ...
                                               <tr><td align="left" class="font_EventDates11">&nbsp;<asp:Literal ID="Literal1" Text="<%$ Resources:LangResources, SendTo %>" runat="server"></asp:Literal> &nbsp;&nbsp; &nbsp;&nbsp;1) <b>+60146367111</b> &nbsp;&nbsp;2) <b>+6584200138</b> &nbsp;&nbsp;3) <b>+628989111995</b> &nbsp;&nbsp;4) <b>+447860041399</b> </td></tr>
                                                <tr><td align="left">
