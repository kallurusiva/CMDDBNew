...
public partial class BillPlzConfirmTest : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Response.Write(BillPlzURL.ToString());
        Response.End();
    }
    ...
    public int GetUserIdfromURL()
    {
        ...
        else
        {
            ...
            Session["MasUSER"] = objMasUser;
            //    //.................................................................
            String WebRegURL = string.Empty;
            if (objMasUser.MID != "NONE")
            {
                WebRegURL = "Mas1UserWebRegistration.aspx";
            }
        }
