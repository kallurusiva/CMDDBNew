<%@ Page Language="C#"  MasterPageFile="~/O_MasterBlue.master" AutoEventWireup="true" CodeFile="O_dtBankInConfirmVEmail.aspx.cs" Inherits="O_dtBankInConfirmVEmail" %>
                    ...
                    <div class="row">
                            <div class="col-xs-12 col-lg-12">
                                <div class="text-right">
                                    <%--<asp:LinkButton ID="lnkBuyNow" runat="server" CssClass="btn btn-custom min-width" ValidationGroup="VgCheck" OnClick="lnkBuyNow_Click"  >
                                                       Submit Bank-In Details</asp:LinkButton>--%>
                                    <asp:Button ID="BtnSubmit" CssClass="btn btn-custom min-width" runat="server" ValidationGroup="VgCheck" Text="Submit Bank-In Details" OnClick="BtnSubmit_Click" />
                                </div>
                            </div>
                   </div>
