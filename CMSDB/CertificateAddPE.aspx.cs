...
public partial class CertificateAddPE : System.Web.UI.Page
{
    ...
    protected void FileUpload_OnserverValidate()
    {
        ...
        String tmpImageFolder = "/DocumentRepository/Certificates/PE/";
        string ImgFileUrl = Server.MapPath("~") + tmpImageFolder;

        UploadImgCtrl.SaveAs(ImgFileUrl + ImgFileName);

        newDBS objNewDB = new newDBS();
        DataSet ds = objNewDB.products_Upload_CertificatePE(ViewState["TID"].ToString(), ViewState["Mobile"].ToString());
