...
public partial class EBooksPrepaidPreNew : UserWeb
{
    ...
    protected void BtnSubmit_Click(object sender, EventArgs e)
    {
        ...
        DataSet dstL = ndbsL.Prepaid_RegValidateLogin(vPrepaidLogin.ToString(),"");
    ...
    protected void LnkBtnValidateLogin_Click(object sender, EventArgs e)
    {
        ...
        newDBS ndbsL = new newDBS();
        DataSet dstL = ndbsL.Prepaid_RegValidateLogin(newLogin.ToString(),"");
