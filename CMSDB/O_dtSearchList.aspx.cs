...
public partial class O_dtSearchList : System.Web.UI.Page
{
    ...
    protected void RepBooks_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        if ((e.Item.ItemType == ListItemType.Item) || (e.Item.ItemType == ListItemType.AlternatingItem))
        {
            ...
            url = url.Replace("O_dtSearchList.aspx?", "O_dtShowDetails.aspx?qBookID=" + objlblBookID.Text.ToString() + "&");
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        rptPages1.ItemCommand +=
           new RepeaterCommandEventHandler(rptPages1_ItemCommand);
    }
