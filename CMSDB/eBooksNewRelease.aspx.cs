...
public partial class eBooksNewRelease : UserWeb
{
                    ...
                    if (ctryVal != "MY")
                    {
                        ...
                        if (dst.Tables[0].Rows.Count > 0)
                        {
                            ...
                            if ((nrow["countryName"].ToString() != null) && (nrow["countryName"].ToString() != ""))
                            {
                                ...
                                string ctryLabel = nrow["countryLabel"].ToString();
                                ...
                                string sendTo = nrow["SendTO"].ToString();
                                ...
                                //objLit12.Text = "send To " + ctryShortcode;
                                objLit10.Text = ctryLabel;
                                objLit12.Text = sendTo;
                                objLit11.Text = "";
                                objlblPurFormat.Text = ctryKeyword + " " + vStoreID1 + "  " + objlblBookID.Text + "  YourEmail  YourName";
                                //lblPNote.Text = "<b>" + Resources.LangResources.Note + ":- </b> <span class='PriceFont'>" + ctryNote + " </span> " + Resources.LangResources.persmsreceived + ". Eg. " + ctryKeyword + " " + vStoreID1 + "  " + objlblBookID.Text + "  JohnWoo@yahoo.com  John Woo";
    ...
    protected void lnkAddtoCart_Command(object sender, CommandEventArgs e)
    {
        ...
        foreach (string part in BookInfo)
        {
          ...
          // UpdatePanel1.Update(); 
            ...
            Server.Transfer("ebooksNewRelease.aspx"); 
