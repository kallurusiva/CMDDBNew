...
public partial class N_List : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString.Count > 0)
            {
                ...
                {
                    qCatID = Convert.ToInt32(Request.QueryString["qCatID"].ToString().Replace("/", "").Replace("'", ""));
                }
            }
    ...
    protected void RepBooks_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        if ((e.Item.ItemType == ListItemType.Item) || (e.Item.ItemType == ListItemType.AlternatingItem))
        {
            ...
            url = url.Replace("N_List.aspx?", "N_ShowDetails.aspx?qBookID=" + objlblBookID.Text.ToString() + "&");
