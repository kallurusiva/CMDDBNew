<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mas1SmeWebRegAjax.aspx.cs" Inherits="Mas1SmeWebRegAjax" %>
                        ...
                        <div style="float:left;">
                           <asp:TextBox ID="txtSMEUserID" runat="server" 
                            ...
                            ToolTip="Enter SME UserID / LoginID."
                               Width="200px" AutoPostBack="True" ontextchanged="txtSMEUserID_TextChanged"></asp:TextBox>
                    ...
                    <td class="tblFormText1" width="80%">
                        ...
                        <div style="float:left;">
                          <asp:TextBox ID="txtSMEPIN" runat="server" 
                            CssClass="stdTextFieldRnd" MaxLength="10"  ValidationGroup="VgCheck" AutoPostBack="true" 
                            ToolTip="Enter Pin Number." 
                               Width="200px" ontextchanged="txtSMEPIN_TextChanged"></asp:TextBox>
                    ...
                    <td class="tblFormText1" width="80%">
                        ...
                        <div style="float:left;">
                           <asp:TextBox ID="txtSubDomainName" runat="server" 
                            CssClass="stdTextFieldRnd" MaxLength="20"  ValidationGroup="VgCheck" AutoPostBack="true" 
                            ToolTip="Enter Subdomain name. Only Alphanumeric values are allowed." 
                               Width="200px" ontextchanged="txtSubDomainName_TextChanged"></asp:TextBox>
                               <div id="dvSubDomainCheck" runat="server"></div>
                           </div>    
                        </ContentTemplate>
                        </asp:UpdatePanel>
...
<%--              </table>
              ...
              <%-- <tr>
                ...
                <tr>
                    <td class="tblFormLabel" width="20%">
                        &nbsp;</td>
                    <td class="tblFormText1" width="80%" valign="top">
                    <font class="font_EventDates">Facility to create your Own Domain provided at the Webportal. </font>
                        &nbsp;</td>
                </tr>
