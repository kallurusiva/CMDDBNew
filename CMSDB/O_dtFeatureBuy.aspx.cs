...
public partial class O_dtFeatureBuy : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            //string IPAddressDisp = MyGeoLocation.GetIP4Address();
            //Response.Write(IPAddressDisp.ToString());
    ...
    protected void LoadEbooks(int vUserId, int vCatId)
    {
        ...
        string ttsms = ViewState["vAllowSMSBuy"].ToString();
    ...
    protected void RepBooks_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        if ((e.Item.ItemType == ListItemType.Item) || (e.Item.ItemType == ListItemType.AlternatingItem))
        {
            ...
            url = url.Replace("O_dtFeatureBuy.aspx", "O_dtShowDetails.aspx?qBookID=" + objlblBookID.Text.ToString());
            ...
            hfPinterest.NavigateUrl = "http://pinterest.com/pin/create/button/?url=" + url + "&media=http://183.81.165.117" + oImgEbook.ImageUrl.Replace("~", "").ToString();
            ...
            if (tmpKeyword != "")
            {
                ...
                else
                {
                    ...
                    //objLit14_1.Text = "SendTo &nbsp;&nbsp; <u>1)+60146367111 &nbsp; 2)+6584200138 &nbsp; 3)+628989111995 &nbsp; 4)+447860041399</u>";
    ...
    protected void lnkAddtoCart_Command(object sender, CommandEventArgs e)
    {
        ...
        foreach (string part in BookInfo)
        {
            ...
            // UpdatePanel1.Update(); 
            Server.Transfer("O_dtFeatureBuy.aspx");
        }
    }
