...
public partial class dt6 : System.Web.UI.Page
{
  ...
  Label lblLogoText = (Label)Master.FindControl("lblLogoText");
    ...
    protected void LoadData(int vLangType, int vButtonNo)
    {
        ...
        else
        {
            ...
            tmpUserContent = "<br> No Content has been added yet. To Create, click on the Add the content  |" + ViewState["FirstButtonURL"].ToString();
        }
