<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="eBooksBuyPPSuccess.aspx.cs" Inherits="eBooksBuyPPsuccess" %>
                                 ...
                                 <div id="dvBookDetails" class="CssdvBookDetails">
                                       ...
                                       <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                          <tr>
                                           ...
                                           <tr>
                                              <td class="bkFormLabel">Payment Made : </td>
                                              <td class="bkFormText"> 
                                                  <asp:Label ID="lblPytMade" runat="server"></asp:Label></td>
                                          </tr>

                                          <%-- <tr>
                                              <td class="bkFormLabel">Payment Fee :</td>
                                              <td class="bkFormText"> 
                                                  <asp:Label ID="lblPytFee" runat="server"></asp:Label></td>
                                          </tr>--%>

                                           <tr>
                                              <td class="bkFormLabel">Payment Status:</td>
                                              <td class="bkFormText"> 
                                                  <asp:Label ID="lblPytStatus" runat="server"></asp:Label></td>
                                          </tr>
                                               ...
                                               <td colspan="2" align="center">
                                                   ...
                                                   <div id="dvSuccess" class="dvPayPalSuccess">
                                                      ...
                                                      <span class="fontEBName">
                                                        The PayPal payment for the eBook was successfull.  
                                                        <br />
                                                          An Email has been Sent along with the book attached to your registered Email ID. 
                                                       </span>
                         ...
                         <tr>
                             <td colspan="2" align="center">
                                <div id="dvNav2WebSite" class="dvBookPurchase_ComingCss" style="margin-left: 420px;">
                                 ...
                                 <asp:linkbutton runat="server" ID="lnkToWebsite" CssClass="links_URL" >
