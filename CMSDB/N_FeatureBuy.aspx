<%@ Page Language="C#" MasterPageFile="~/N_Master.master" AutoEventWireup="true" CodeFile="N_FeatureBuy.aspx.cs" Inherits="N_FeatureBuy" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderRight" runat="Server">
    ...
    <div class="col-xs-9 content-middle">
                    ...
                    <h2 class="main-title">Feature Buy</h2>
                                ...
                                <div class="col-xs-8">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-8" >                                                            
                                            ...
                                            <p class="text-login">
                                                <asp:HyperLink ID="HyperLink3" NavigateUrl='<%# Eval("BookID","~/N_ShowDetails.aspx?qBookID={0}") %>' runat="server">
                                                <asp:Label ID="lblBName" runat="server" Text='<%# Eval("BookName")%>'></asp:Label>
                                                </asp:HyperLink>
                                            </p>
                    ...
                    <div class="pagination">
                        <nav aria-label="Page navigation">
                            <ul class="pagination">
                                ...
                                <li><asp:Repeater ID="rptPages" runat="server" OnItemDataBound="rptPages_ItemDataBound">
                                        <ItemTemplate>                                
