...
public partial class O_dtDirectBankInConfirm : System.Web.UI.Page
{
    ...
    protected void Send_TransactionInvoice_ToBuyer(String vbFullName, String vbMobile, String vbEmail, string vbTotalAmount, String vbCurrency, string vPurchaseItems, int vUserID, string vTranID)
    {
        ...
        String strSubmitLink = "http://210.5.45.8/O_dtBankInConfirmVEmail.aspx?vTID=" + Server.UrlEncode(CommonFunctions.Encrypt(InVoiceTrackId));
