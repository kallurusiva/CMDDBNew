<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SessionTimedOut.aspx.cs" Inherits="SessionTimedOut" %>
...
<body>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="80%" class="loginBkg">
                    ...
                    <tr>
                    <td>&nbsp;</td>
                    <td align="center">Your session timeout limit has reached.&nbsp; </td>
                    <td>&nbsp;</td>
                    </tr>
                    ...
                    <tr>
                    <td>&nbsp;</td>
                    <td align="center" class="font_Title1">In order to continue please login again. </td>
                    <td>&nbsp;</td>
                    </tr>
