...
public partial class TrainingFromEbook : System.Web.UI.Page
{
    int tmpStatus = 0;
    DataSet ds;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            Session["menunav"] = "1";
            Response.Redirect("http://www.partnertraining.club/TrainingFromEbook.aspx?TID=" + Session["UserID"].ToString());
        }
    }
