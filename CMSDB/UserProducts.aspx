<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaster.master" AutoEventWireup="true" CodeFile="UserProducts.aspx.cs" Inherits="UserProducts" %>
...
<tr>
<td align="center" class="subHeaderMenuFontGrad"> <asp:Literal ID="ltrProductHeader" Text="Products" runat="server"></asp:Literal> </td>
</tr>
<tr>
<td>&nbsp;</td>
</tr>
...
<td colspan="3">
 ...
 <div class="cssfaq_head">
                ...
                <asp:Literal ID="ltrProducts" Text="Products" runat="server"></asp:Literal>
                </div>
            </div>    
