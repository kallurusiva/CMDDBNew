...
public partial class N_Free : System.Web.UI.Page
{
    ...
    protected void RepBooks_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        if ((e.Item.ItemType == ListItemType.Item) || (e.Item.ItemType == ListItemType.AlternatingItem))
        {
            ...
            url = url.Replace("N_Free.aspx", "N_ShowDetails.aspx?qBookID=" + objlblBookID.Text.ToString());
