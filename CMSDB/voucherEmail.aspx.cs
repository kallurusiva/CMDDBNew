...
public partial class voucherEmail : System.Web.UI.Page
{
    string TID;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataSet ds = ndbs.voucher_getEmailDetails(TID.ToString());
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            string vCode = ds.Tables[0].Rows[0]["VCode"].ToString();
            string VName = ds.Tables[0].Rows[0]["VName"].ToString();
            string VImage = ds.Tables[0].Rows[0]["VImage"].ToString();
            string vEmailAddedInfo = ds.Tables[0].Rows[0]["vEmailAddedInfo"].ToString();
            string emailBranding = ds.Tables[0].Rows[0]["emailBranding"].ToString();

            string eMessage = "";
            string vEmailSubject = "Voucher Delivery";
            if (emailBranding.ToString() != "") { vEmailSubject = emailBranding + " - " + "Voucher Delivery"; }
