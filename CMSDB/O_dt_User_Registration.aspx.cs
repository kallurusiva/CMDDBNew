...
public partial class O_dt_User_Registration : System.Web.UI.Page
{
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (vPrepaidPin.ToString() == "")
                    {
                        ...
                        vStoreID = dstR.Tables[0].Rows[0]["vStoreID"].ToString();
                    ...
                    if (tempErCode3 > 0)
                    {
                        CommonFunctions.AlertMessageAndRedirect(tempretMessageR.ToString(), "O_dt_User_Login.aspx");
                    }
                    else
                    {
                        ...
                        Session["cLogin"] = vStoreID.ToString() + "-" + vBankdersEmail.ToString();
                        if (Session["navcheckout"].ToString() == "1")
                        {
                            CommonFunctions.AlertMessageAndRedirect(tempretMessageR.ToString(), "O_dtCart.aspx");
                        }
                    }
                }
            }
