...
public partial class vEBK : System.Web.UI.Page
{
    string glbFrom;
    string glbText;
    string glbMsgID;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataSet ds = ndbs.EBK_Purchase(glbFrom.ToString(), glbVCode.ToString(), glbFullName.ToString(), glbCName.ToString(), glbEmail.ToString(), glbText.ToString(), glbMsgID.ToString(), glbSCode.ToString());
        ...
        //if (errorCode == "0")
        //{
            var webRequest = WebRequest.Create("http://183.81.165.117/EBKEmail.aspx?TID=" + TID);
