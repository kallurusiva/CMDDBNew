...
public partial class TmpMasterGenTest : System.Web.UI.MasterPage
{
        ...
        if (!IsPostBack)
        {
            ...
            for (i = 0; i <= tbHomePgContent.Rows.Count - 1; i++)
            {
                ...
                if (tmpLogoImage.Substring(0, 8) == "LogoTemp")
                {
                    ...
                    string tmpLogoHtml2 = "<img alt='logo img' class='divGen1LogoCss' src='" + @"ImageRepository/" + HpgRow["LogoImg"].ToString() + "' />";
                    dvBannerLeftPanel.InnerHtml = tmpLogoHtml2;
                ...
                {
                    dvBannerImg.InnerHtml = "<img alt='banner image'  class='divCssBannerImg2' src='" + @"ImageRepository/" + HpgRow["BannerImg"].ToString() + "' />";
                }
            ...
            foreach (DataRow mRow in tbMenu_OwnButton_Rows)
            {
                ...
                //if (i < 10)
                //{
                sbMenu.Append("<ul class='menu'>");
                sbMenu.Append("<li class='visible-lg'>");
                if (mRow["LinkURL"].ToString().Contains("UsersOwnPage"))
                    sbMenu.Append(@"<a href=""" + TmpMenuEncodedName + @""">");
                else
                    sbMenu.Append(@"<a href=""<span>" + mRow["LinkURL"].ToString() + @"</span>"">");
