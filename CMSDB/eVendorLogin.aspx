<%@ page title="" language="C#" masterpagefile="~/UserMaster.master" autoeventwireup="true" maintainscrollpositiononpostback="true" CodeFile="eVendorLogin.aspx.cs" inherits="eVendorLogin" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                    ...
                    <td colspan="4">
                        ...
                        <div class="LogoBoxheadBlue">
                                    ...
                                    <div class="sideBoxheadText"> 
                                        <asp:Literal ID="LtrSMSAdminLogin" Text="eVendor Login" runat="server"></asp:Literal></div>
                                </div>   
                      </td> 
