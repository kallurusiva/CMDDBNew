...
public partial class N_NewReleases : System.Web.UI.Page
{
    ...
    protected void LoadEbooks(int vUserId, int vCatId)
    {
        ...
        ds = objBALebook.Ebook_NewReleaseListing_ByUserID(vUserId, "");
        dt = ds.Tables[0];
    ...
    protected void RepBooks_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        if ((e.Item.ItemType == ListItemType.Item) || (e.Item.ItemType == ListItemType.AlternatingItem))
        {
            ...
            url = url.Replace("N_NewReleases.aspx", "N_ShowDetails.aspx?qBookID=" + objlblBookID.Text.ToString());
    ...
    protected void lnkAddtoCart_Command(object sender, CommandEventArgs e)
    {
        ...
        foreach (string part in BookInfo)
        {
            ...
            // UpdatePanel1.Update(); 
            Server.Transfer("N_NewReleases.aspx");
        }
    }
