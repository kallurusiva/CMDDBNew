...
public partial class N_ValueBuyshowDetails : System.Web.UI.Page
{
    ...
    protected void RepBooks_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        if ((e.Item.ItemType == ListItemType.Item) || (e.Item.ItemType == ListItemType.AlternatingItem))
        {
            ...
            //url = url.Replace("N_ValueBuyShowDetails.aspx?", "N_ValueBuyShowDetails.aspx?qBookID=" + objlblBookID.Text.ToString() + "&");
            ...
            if (objImg3 != null)
            {
                if (objImg3.ImageUrl == "")
                {
                    ...
                    if (objDV != null)
                        objDV.Visible = false;
                    HtmlGenericControl objDV1 = (HtmlGenericControl)e.Item.FindControl("div13");
                    if (objDV1 != null)
                        objDV1.Visible = false;
                    HtmlGenericControl objDV2 = (HtmlGenericControl)e.Item.FindControl("div23");
                    if (objDV2 != null)
                        objDV2.Visible = false;
                }
            ...
            if (objImg3 != null)
            {
                if (objImg3.ImageUrl == "")
                {
                    HtmlGenericControl objDV = (HtmlGenericControl)e.Item.FindControl("divVB6");
                    if (objDV != null)
                        objDV.Visible = false;
                }
            ...
            if (objImg4 != null)
            {
                if (objImg4.ImageUrl == "")
                {
                    ...
                    if (objDV != null)
                        objDV.Visible = false;
                    HtmlGenericControl objDV1 = (HtmlGenericControl)e.Item.FindControl("div14");
                    if (objDV1 != null)
                        objDV1.Visible = false;
                    HtmlGenericControl objDV2 = (HtmlGenericControl)e.Item.FindControl("div24");
                    if (objDV2 != null)
                        objDV2.Visible = false;
                }
            ...
            if (objImg5 != null)
            {
                if (objImg5.ImageUrl == "")
                {
                    ...
                    if (objDV != null)
                        objDV.Visible = false;
                    HtmlGenericControl objDV1 = (HtmlGenericControl)e.Item.FindControl("div15");
                    if (objDV1 != null)
                        objDV1.Visible = false;
                    HtmlGenericControl objDV2 = (HtmlGenericControl)e.Item.FindControl("div25");
                    if (objDV2 != null)
                        objDV2.Visible = false;
                }
    ...
    protected void lnkAddtoCart_Command(object sender, CommandEventArgs e)
    {
        ...
        foreach (string part in BookInfo)
        {
            ...
            Server.Transfer("N_ValueBuy.aspx");
        }
    }
    ...
    {
        Session["ipCtry"] = "MY";
        Response.Redirect("N_ValueBuyShowDetails.aspx?qBookID=" + Request.QueryString["qBookID"].ToString());
    }
